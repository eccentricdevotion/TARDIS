...
|-------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------|
| ![Static Badge](https://img.shields.io/badge/WIP-f90?style=flat-square) | **Fix bugs**<br/>!<br/>- Invisible block tile entities in custom biomes, maybe try using datapack instead of code?<br/>- copper golem chest processing | -                                                              |
...
| ![Static Badge](https://img.shields.io/badge/2-0c6?style=flat-square)   | **Bedrock custom items**<br/>- Add items with upcoming Custom item API v2                                                                              | [PR](https://github.com/GeyserMC/Geyser/pull/5189)             |
...
| ![Static Badge](https://img.shields.io/badge/3-06f?style=flat-square)   | **Multiple custom chameleon presets**<br/>- _custom\_preset.txt_ -> _custom\_presets.json_<br/>- Change command implementation                         | -                                                              |
