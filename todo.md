...
10. Add Factions plugin support
11. Add a way to set permissions for TARDIS worlds if using GroupManager or another perms plugin that has a config file per world
