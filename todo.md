...
1. Add a check that ***both*** back doors have been added
2. Add option to return seed block when room is jettisoned
3. Check what happens when companions steal the TARDIS
4. Add video for books/achievements
5. Add docs for new features
6. Add separate directory for user schematics
