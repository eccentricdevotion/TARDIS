...
| -------- | ------- | ---- |
| ![Static Badge](https://img.shields.io/badge/WIP-f90?style=flat-square) | **Update to 1.21.3**<br>- Use new Player input API instead of packet listener for external flying / switch to custom armour stand for exteriors that allows flying directly and ditch the chicken!<br>- Switch to using custom armour for weeping angel module monster disguises<br>- Test, test, test | - |
| ![Static Badge](https://img.shields.io/badge/WIP-f90?style=flat-square) | Fix bugs<br>- Custom door desync, portal not working / being removed leading to monsters entering even when door is closed<br>- Debug bigger desktop change not checking for rooms<br>- Fix toggling buttons on modelled console | - |
