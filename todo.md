...
| -------- | ------- | ---- |
| ![Static Badge](https://img.shields.io/badge/WIP-f90?style=flat-square) | **Update to 1.21.3**<br>- Switch to using custom armour for weeping angel module monster disguises<br>- Test, test, test | - |
| ![Static Badge](https://img.shields.io/badge/WIP-f90?style=flat-square) | Fix bugs<br>- Custom door desync, portal not working / being removed leading to monsters entering even when door is closed<br>- Fix toggling buttons on modelled console | - |
