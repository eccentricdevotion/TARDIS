...
|-------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------|
| ![Static Badge](https://img.shields.io/badge/WIP-f90?style=flat-square) | **Fix bugs**!<br/>- Use `Bukkit.getWorld(Key key)` instead of obsolete string method<br/>+ Paper 26.1.2 updates as available                | -                                                              |
...
| ![Static Badge](https://img.shields.io/badge/2-0c6?style=flat-square)   | **Sonic Blaster**<br/>- Used to temporarily remove blocks only                                                                              | -                                                              |
...
| ![Static Badge](https://img.shields.io/badge/3-06f?style=flat-square)   | **Bedrock custom items**<br/>- Add items with Custom item API v2                                                                            | [PR](https://github.com/GeyserMC/Geyser/pull/5189)             |
