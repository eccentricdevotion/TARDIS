...
public class TARDISJailPreset extends TARDISPreset {
    ...
    public TARDISJailPreset() {
        ...
        blueprintData[0][0] = "minecraft:stone_bricks";
        blueprintData[0][1] = "minecraft:iron_bars";
        blueprintData[0][2] = "minecraft:iron_bars";
        blueprintData[0][3] = "minecraft:stone_brick_slab[half=bottom]";
        blueprintData[1][0] = "minecraft:stone_bricks";
        blueprintData[1][1] = "minecraft:iron_bars";
        blueprintData[1][2] = "minecraft:iron_bars";
        blueprintData[1][3] = "minecraft:stone_brick_slab[half=bottom]";
        blueprintData[2][0] = "minecraft:stone_bricks";
        blueprintData[2][1] = "minecraft:iron_bars";
        blueprintData[2][2] = "minecraft:iron_bars";
        blueprintData[2][3] = "minecraft:stone_brick_slab[half=bottom]";
        blueprintData[3][0] = "minecraft:stone_bricks";
        blueprintData[3][1] = "minecraft:iron_bars";
        blueprintData[3][2] = "minecraft:iron_bars";
        blueprintData[3][3] = "minecraft:stone_brick_slab[half=bottom]";
        blueprintData[4][0] = "minecraft:stone_bricks";
        blueprintData[4][1] = "minecraft:iron_bars";
        blueprintData[4][2] = "minecraft:iron_bars";
        blueprintData[4][3] = "minecraft:stone_brick_slab[half=bottom]";
        blueprintData[5][0] = "minecraft:stone_bricks";
        blueprintData[5][1] = "minecraft:iron_bars";
        blueprintData[5][2] = "minecraft:iron_bars";
        blueprintData[5][3] = "minecraft:stone_brick_slab[half=bottom]";
        blueprintData[6][0] = "minecraft:stone_bricks";
        blueprintData[6][1] = "minecraft:iron_bars";
        blueprintData[6][2] = "minecraft:iron_bars";
        blueprintData[6][3] = "minecraft:stone_brick_slab[half=bottom]";
        blueprintData[7][0] = "minecraft:stone_brick_stairs[half=bottom,facing=east,shape=straight]";
        blueprintData[7][1] = "minecraft:air";
        blueprintData[7][2] = "minecraft:air";
        blueprintData[7][3] = "minecraft:stone_brick_slab[half=bottom]";
        blueprintData[8][0] = "minecraft:stone_bricks";
        blueprintData[8][1] = "minecraft:iron_door[half=lower,hinge=right,facing=east,open=false]";
        blueprintData[8][2] = "minecraft:iron_door[half=upper,hinge=right,facing=east,open=false]";
        ...
        blueprintData[9][3] = "minecraft:wall_sign[facing=west]";
        ...
        stainedData[8][1] = "minecraft:iron_door[half=lower,hinge=right,facing=east,open=false]";
        stainedData[8][2] = "minecraft:iron_door[half=upper,hinge=right,facing=east,open=false]";
        ...
        stainedData[9][3] = "minecraft:wall_sign[facing=west]";
        ...
        glassData[8][1] = "minecraft:iron_door[half=lower,hinge=right,facing=east,open=false]";
        glassData[8][2] = "minecraft:iron_door[half=upper,hinge=right,facing=east,open=false]";
        glassData[8][3] = "minecraft:_glass";
        glassData[9][0] = "minecraft:air";
        glassData[9][1] = "minecraft:air";
        glassData[9][2] = "minecraft:air";
        glassData[9][3] = "minecraft:wall_sign[facing=west]";
