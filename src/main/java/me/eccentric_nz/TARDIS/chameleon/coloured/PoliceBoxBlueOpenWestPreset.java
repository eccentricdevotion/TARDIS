 ...
 * @author eccentric_nz
 */
public class PoliceBoxBlueOpenWestPreset extends PoliceBoxPreset {

    public PoliceBoxBlueOpenWestPreset() {
        ...
        blueprintData[8][1] = "minecraft:mushroom_stem[down=false,east=false,north=false,south=true,up=false,west=true]";
