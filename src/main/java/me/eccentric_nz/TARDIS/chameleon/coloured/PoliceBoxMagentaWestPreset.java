 ...
 * @author eccentric_nz
 */
public class PoliceBoxMagentaWestPreset extends PoliceBoxPreset {

    public PoliceBoxMagentaWestPreset() {
        ...
        blueprintData[8][1] = "minecraft:brown_mushroom_block[down=true,east=false,north=true,south=true,up=true,west=true]";
