 ...
 * @author eccentric_nz
 */
public class PoliceBoxBlueNorthPreset extends PoliceBoxPreset {

    public PoliceBoxBlueNorthPreset() {
        ...
        blueprintData[8][1] = "minecraft:brown_mushroom_block[down=true,east=true,north=true,south=true,up=false,west=false]";
