 ...
 * @author eccentric_nz
 */
public class PoliceBoxBlueOpenSouthPreset extends PoliceBoxPreset {

    public PoliceBoxBlueOpenSouthPreset() {
        ...
        blueprintData[8][1] = "minecraft:mushroom_stem[down=false,east=false,north=false,south=true,up=false,west=false]";
