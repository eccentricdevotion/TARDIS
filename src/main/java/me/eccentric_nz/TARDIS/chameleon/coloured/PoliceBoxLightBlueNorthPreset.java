 ...
 * @author eccentric_nz
 */
public class PoliceBoxLightBlueNorthPreset extends PoliceBoxPreset {

    public PoliceBoxLightBlueNorthPreset() {
        ...
        blueprintData[8][1] = "minecraft:red_mushroom_block[down=false,east=false,north=true,south=true,up=false,west=false]";
