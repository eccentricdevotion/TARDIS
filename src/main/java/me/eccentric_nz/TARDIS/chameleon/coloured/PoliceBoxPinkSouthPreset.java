 ...
 * @author eccentric_nz
 */
public class PoliceBoxPinkSouthPreset extends PoliceBoxPreset {

    public PoliceBoxPinkSouthPreset() {
        ...
        blueprintData[8][1] = "minecraft:brown_mushroom_block[down=true,east=false,north=false,south=false,up=true,west=true]";
