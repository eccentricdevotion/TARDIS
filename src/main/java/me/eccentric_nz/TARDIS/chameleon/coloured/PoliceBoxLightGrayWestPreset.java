 ...
 * @author eccentric_nz
 */
public class PoliceBoxLightGrayWestPreset extends PoliceBoxPreset {

    public PoliceBoxLightGrayWestPreset() {
...
// set blueprint data strings
        ...
        blueprintData[8][1] = "minecraft:brown_mushroom_block[down=true,east=true,north=false,south=true,up=false,west=true]";
