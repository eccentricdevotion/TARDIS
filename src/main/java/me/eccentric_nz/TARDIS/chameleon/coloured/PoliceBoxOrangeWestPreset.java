 ...
 * @author eccentric_nz
 */
public class PoliceBoxOrangeWestPreset extends PoliceBoxPreset {

    public PoliceBoxOrangeWestPreset() {
        ...
        blueprintData[8][1] = "minecraft:brown_mushroom_block[down=true,east=false,north=true,south=true,up=true,west=false]";
