 ...
 * @author eccentric_nz
 */
public class PoliceBoxBrownSouthPreset extends PoliceBoxPreset {

    public PoliceBoxBrownSouthPreset() {
        ...
        blueprintData[8][1] = "minecraft:brown_mushroom_block[down=true,east=false,north=true,south=false,up=false,west=false]";
        blueprintData[8][2] = "minecraft:brown_carpet";
