 ...
 * @author eccentric_nz
 */
public class PoliceBoxBrownEastPreset extends PoliceBoxPreset {

    public PoliceBoxBrownEastPreset() {
        ...
        blueprintData[8][1] = "minecraft:brown_mushroom_block[down=false,east=true,north=false,south=true,up=true,west=true]";
