 ...
 * @author eccentric_nz
 */
public class PoliceBoxWhiteSouthPreset extends PoliceBoxPreset {

    public PoliceBoxWhiteSouthPreset() {
        ...
        blueprintData[8][1] = "minecraft:brown_mushroom_block[down=false,east=true,north=true,south=true,up=false,west=true]";
