 ...
 * @author eccentric_nz
 */
public class PoliceBoxLightGraySouthPreset extends PoliceBoxPreset {

    public PoliceBoxLightGraySouthPreset() {
        ...
        blueprintData[8][1] = "minecraft:brown_mushroom_block[down=true,east=false,north=false,south=true,up=false,west=true]";
        blueprintData[8][2] = "minecraft:light_gray_carpet";
