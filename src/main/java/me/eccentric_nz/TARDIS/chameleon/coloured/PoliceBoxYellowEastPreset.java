 ...
 * @author eccentric_nz
 */
public class PoliceBoxYellowEastPreset extends PoliceBoxPreset {

    public PoliceBoxYellowEastPreset() {
        ...
        blueprintData[8][1] = "minecraft:brown_mushroom_block[down=false,east=false,north=true,south=true,up=true,west=false]";
