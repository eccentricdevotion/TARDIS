 ...
 * @author eccentric_nz
 */
public class PoliceBoxGreenNorthPreset extends PoliceBoxPreset {

    public PoliceBoxGreenNorthPreset() {
        ...
        blueprintData[8][1] = "minecraft:red_mushroom_block[down=false,east=true,north=true,south=false,up=true,west=true]";
