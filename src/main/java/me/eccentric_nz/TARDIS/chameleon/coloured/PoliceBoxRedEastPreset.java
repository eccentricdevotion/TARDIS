 ...
 * @author eccentric_nz
 */
public class PoliceBoxRedEastPreset extends PoliceBoxPreset {

    public PoliceBoxRedEastPreset() {
        ...
        blueprintData[8][1] = "minecraft:brown_mushroom_block[down=false,east=true,north=true,south=false,up=false,west=true]";
