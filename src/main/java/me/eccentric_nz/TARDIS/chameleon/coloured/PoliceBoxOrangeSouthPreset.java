 ...
 * @author eccentric_nz
 */
public class PoliceBoxOrangeSouthPreset extends PoliceBoxPreset {

    public PoliceBoxOrangeSouthPreset() {
        ...
        blueprintData[8][1] = "minecraft:brown_mushroom_block[down=false,east=true,north=true,south=true,up=true,west=false]";
