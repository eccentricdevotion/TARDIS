 ...
 * @author eccentric_nz
 */
public class PoliceBoxCyanNorthPreset extends PoliceBoxPreset {

    public PoliceBoxCyanNorthPreset() {
        ...
        blueprintData[8][1] = "minecraft:red_mushroom_block[down=false,east=true,north=false,south=true,up=false,west=true]";
