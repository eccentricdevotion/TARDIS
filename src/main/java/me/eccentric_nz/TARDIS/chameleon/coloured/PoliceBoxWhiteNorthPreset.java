 ...
 * @author eccentric_nz
 */
public class PoliceBoxWhiteNorthPreset extends PoliceBoxPreset {

    public PoliceBoxWhiteNorthPreset() {
        ...
        blueprintData[8][1] = "minecraft:brown_mushroom_block[down=true,east=true,north=true,south=true,up=false,west=true]";
