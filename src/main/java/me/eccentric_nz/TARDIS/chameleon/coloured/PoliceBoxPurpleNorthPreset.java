 ...
 * @author eccentric_nz
 */
public class PoliceBoxPurpleNorthPreset extends PoliceBoxPreset {

    public PoliceBoxPurpleNorthPreset() {
        ...
        blueprintData[8][1] = "minecraft:red_mushroom_block[down=false,east=true,north=false,south=true,up=true,west=true]";
