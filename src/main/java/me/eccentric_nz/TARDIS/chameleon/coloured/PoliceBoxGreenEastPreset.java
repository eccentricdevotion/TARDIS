 ...
 * @author eccentric_nz
 */
public class PoliceBoxGreenEastPreset extends PoliceBoxPreset {

    public PoliceBoxGreenEastPreset() {
        ...
        blueprintData[8][1] = "minecraft:brown_mushroom_block[down=false,east=true,north=true,south=false,up=false,west=false]";
