 ...
 * @author eccentric_nz
 */
public class PoliceBoxLimeWestPreset extends PoliceBoxPreset {

    public PoliceBoxLimeWestPreset() {
        ...
        blueprintData[8][1] = "minecraft:brown_mushroom_block[down=true,east=true,north=false,south=false,up=true,west=false]";
