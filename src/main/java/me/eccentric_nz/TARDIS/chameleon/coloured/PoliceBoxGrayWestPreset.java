 ...
 * @author eccentric_nz
 */
public class PoliceBoxGrayWestPreset extends PoliceBoxPreset {

    public PoliceBoxGrayWestPreset() {
        ...
        blueprintData[8][1] = "minecraft:brown_mushroom_block[down=true,east=true,north=false,south=true,up=false,west=false]";
