 ...
 * @author eccentric_nz
 */
public class PoliceBoxGraySouthPreset extends PoliceBoxPreset {

    public PoliceBoxGraySouthPreset() {
        ...
        blueprintData[8][1] = "minecraft:brown_mushroom_block[down=true,east=false,north=false,south=true,up=false,west=false]";
        ...
        stainedData[8][1] = "minecraft:gray_stained_glass";
        stainedData[8][2] = "minecraft:gray_stained_glass";
