 ...
 * @author eccentric_nz
 */
public class PoliceBoxYellowSouthPreset extends PoliceBoxPreset {

    public PoliceBoxYellowSouthPreset() {
        ...
        blueprintData[8][1] = "minecraft:brown_mushroom_block[down=true,east=false,north=false,south=false,up=false,west=true]";
        ...
        stainedData[8][0] = "minecraft:yellow_stained_glass";
