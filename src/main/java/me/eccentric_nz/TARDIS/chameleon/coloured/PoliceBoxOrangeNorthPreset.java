 ...
 * @author eccentric_nz
 */
public class PoliceBoxOrangeNorthPreset extends PoliceBoxPreset {

    public PoliceBoxOrangeNorthPreset() {
        ...
        blueprintData[8][1] = "minecraft:brown_mushroom_block[down=true,east=true,north=true,south=true,up=true,west=false]";
