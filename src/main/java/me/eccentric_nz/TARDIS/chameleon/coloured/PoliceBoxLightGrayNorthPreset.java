 ...
 * @author eccentric_nz
 */
public class PoliceBoxLightGrayNorthPreset extends PoliceBoxPreset {

    public PoliceBoxLightGrayNorthPreset() {
        ...
        blueprintData[8][1] = "minecraft:red_mushroom_block[down=false,east=true,north=false,south=false,up=true,west=true]";
