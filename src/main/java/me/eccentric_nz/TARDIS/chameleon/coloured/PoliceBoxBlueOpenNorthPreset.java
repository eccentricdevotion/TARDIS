 ...
 * @author eccentric_nz
 */
public class PoliceBoxBlueOpenNorthPreset extends PoliceBoxPreset {

    public PoliceBoxBlueOpenNorthPreset() {
        ...
        blueprintData[8][1] = "minecraft:mushroom_stem[down=false,east=false,north=false,south=true,up=true,west=false]";
