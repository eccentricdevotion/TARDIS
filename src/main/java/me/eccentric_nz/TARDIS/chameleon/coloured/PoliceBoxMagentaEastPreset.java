 ...
 * @author eccentric_nz
 */
public class PoliceBoxMagentaEastPreset extends PoliceBoxPreset {

    public PoliceBoxMagentaEastPreset() {
        ...
        blueprintData[8][1] = "minecraft:brown_mushroom_block[down=false,east=false,north=true,south=true,up=false,west=false]";
        ...
        stainedData[8][0] = "minecraft:magenta_stained_glass";
        stainedData[8][1] = "minecraft:magenta_stained_glass";
        stainedData[8][2] = "minecraft:magenta_stained_glass";
