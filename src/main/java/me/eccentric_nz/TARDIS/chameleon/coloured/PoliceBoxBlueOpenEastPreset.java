 ...
 * @author eccentric_nz
 */
public class PoliceBoxBlueOpenEastPreset extends PoliceBoxPreset {

    public PoliceBoxBlueOpenEastPreset() {
        ...
        blueprintData[8][1] = "minecraft:mushroom_stem[down=false,east=false,north=false,south=false,up=true,west=true]";
