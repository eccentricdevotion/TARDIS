 ...
 * @author eccentric_nz
 */
public class PoliceBoxLightGrayEastPreset extends PoliceBoxPreset {

    public PoliceBoxLightGrayEastPreset() {
        ...
        blueprintData[8][1] = "minecraft:brown_mushroom_block[down=false,east=true,north=false,south=false,up=true,west=true]";
