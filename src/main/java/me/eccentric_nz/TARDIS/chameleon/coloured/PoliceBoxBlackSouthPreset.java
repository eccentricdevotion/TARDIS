 ...
 * @author eccentric_nz
 */
public class PoliceBoxBlackSouthPreset extends PoliceBoxPreset {

    public PoliceBoxBlackSouthPreset() {
        ...
        blueprintData[8][1] = "minecraft:brown_mushroom_block[down=true,east=false,north=true,south=false,up=true,west=true]";
