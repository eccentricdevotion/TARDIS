 ...
 * @author eccentric_nz
 */
public class PoliceBoxCyanWestPreset extends PoliceBoxPreset {

    public PoliceBoxCyanWestPreset() {
        ...
        blueprintData[8][1] = "minecraft:brown_mushroom_block[down=true,east=true,north=false,south=true,up=true,west=false]";
