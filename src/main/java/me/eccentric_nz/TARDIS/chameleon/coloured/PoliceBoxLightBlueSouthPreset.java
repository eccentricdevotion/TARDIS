 ...
 * @author eccentric_nz
 */
public class PoliceBoxLightBlueSouthPreset extends PoliceBoxPreset {

    public PoliceBoxLightBlueSouthPreset() {
        ...
        blueprintData[8][1] = "minecraft:brown_mushroom_block[down=true,east=false,north=false,south=false,up=false,west=false]";
        ...
        stainedData[8][0] = "minecraft:light_blue_stained_glass";
        stainedData[8][1] = "minecraft:light_blue_stained_glass";
        stainedData[8][2] = "minecraft:light_blue_stained_glass";
