 ...
 * @author eccentric_nz
 */
public class PoliceBoxCyanSouthPreset extends PoliceBoxPreset {

    public PoliceBoxCyanSouthPreset() {
        ...
        blueprintData[8][1] = "minecraft:brown_mushroom_block[down=true,east=false,north=false,south=true,up=true,west=false]";
        ...
        stainedData[8][0] = "minecraft:cyan_stained_glass";
        stainedData[8][1] = "minecraft:cyan_stained_glass";
        stainedData[8][2] = "minecraft:cyan_stained_glass";
