 ...
 * @author eccentric_nz
 */
public class PoliceBoxGreenWestPreset extends PoliceBoxPreset {

    public PoliceBoxGreenWestPreset() {
        ...
        blueprintData[8][1] = "minecraft:brown_mushroom_block[down=true,east=true,north=true,south=false,up=false,west=true]";
