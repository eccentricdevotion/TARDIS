 ...
 * @author eccentric_nz
 */
public class PoliceBoxLimeNorthPreset extends PoliceBoxPreset {

    public PoliceBoxLimeNorthPreset() {
        ...
        blueprintData[8][1] = "minecraft:red_mushroom_block[down=false,east=false,north=true,south=true,up=true,west=false]";
