 ...
 * @author eccentric_nz
 */
public class PoliceBoxWhiteWestPreset extends PoliceBoxPreset {

    public PoliceBoxWhiteWestPreset() {
        ...
        blueprintData[8][1] = "minecraft:brown_mushroom_block[down=true,east=false,north=true,south=true,up=false,west=true]";
