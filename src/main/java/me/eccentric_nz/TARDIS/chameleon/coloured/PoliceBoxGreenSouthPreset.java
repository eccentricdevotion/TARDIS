 ...
 * @author eccentric_nz
 */
public class PoliceBoxGreenSouthPreset extends PoliceBoxPreset {

    public PoliceBoxGreenSouthPreset() {
        ...
        blueprintData[8][1] = "minecraft:brown_mushroom_block[down=true,east=false,north=true,south=false,up=false,west=true]";
        blueprintData[8][2] = "minecraft:green_carpet";
