 ...
 * @author eccentric_nz
 */
public class PoliceBoxLightBlueWestPreset extends PoliceBoxPreset {

    public PoliceBoxLightBlueWestPreset() {
        ...
        blueprintData[8][1] = "minecraft:brown_mushroom_block[down=true,east=true,north=false,south=false,up=false,west=false]";
