 ...
 * @author eccentric_nz
 */
public class PoliceBoxBrownWestPreset extends PoliceBoxPreset {

    public PoliceBoxBrownWestPreset() {
        ...
        blueprintData[8][1] = "minecraft:brown_mushroom_block[down=true,east=true,north=true,south=false,up=false,west=false]";
