 ...
 * @author eccentric_nz
 */
public class PoliceBoxPinkEastPreset extends PoliceBoxPreset {

    public PoliceBoxPinkEastPreset() {
        ...
        blueprintData[8][1] = "minecraft:brown_mushroom_block[down=false,east=true,north=false,south=false,up=false,west=false]";
        ...
        stainedData[8][0] = "minecraft:pink_stained_glass";
        stainedData[8][1] = "minecraft:pink_stained_glass";
        stainedData[8][2] = "minecraft:pink_stained_glass";
