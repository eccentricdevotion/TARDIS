 ...
 * @author eccentric_nz
 */
public class PoliceBoxGrayEastPreset extends PoliceBoxPreset {

    public PoliceBoxGrayEastPreset() {
        ...
        blueprintData[8][1] = "minecraft:brown_mushroom_block[down=false,east=true,north=false,south=false,up=false,west=true]";
