 ...
 * @author eccentric_nz
 */
public class PoliceBoxLimeEastPreset extends PoliceBoxPreset {

    public PoliceBoxLimeEastPreset() {
        ...
        blueprintData[8][1] = "minecraft:brown_mushroom_block[down=false,east=false,north=true,south=true,up=true,west=true]";
