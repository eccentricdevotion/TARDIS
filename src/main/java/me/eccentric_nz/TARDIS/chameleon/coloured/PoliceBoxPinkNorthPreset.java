 ...
 * @author eccentric_nz
 */
public class PoliceBoxPinkNorthPreset extends PoliceBoxPreset {

    public PoliceBoxPinkNorthPreset() {
        ...
        blueprintData[8][1] = "minecraft:red_mushroom_block[down=false,east=false,north=true,south=true,up=true,west=true]";
