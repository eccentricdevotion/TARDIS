 ...
 * @author eccentric_nz
 */
public class PoliceBoxYellowWestPreset extends PoliceBoxPreset {

    public PoliceBoxYellowWestPreset() {
        ...
        blueprintData[8][1] = "minecraft:brown_mushroom_block[down=true,east=true,north=false,south=false,up=false,west=true]";
