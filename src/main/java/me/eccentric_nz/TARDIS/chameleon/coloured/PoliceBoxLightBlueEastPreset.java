 ...
 * @author eccentric_nz
 */
public class PoliceBoxLightBlueEastPreset extends PoliceBoxPreset {

    public PoliceBoxLightBlueEastPreset() {
        ...
        blueprintData[8][1] = "minecraft:brown_mushroom_block[down=false,east=false,north=true,south=true,up=false,west=true]";
