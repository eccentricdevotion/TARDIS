 ...
 * @author eccentric_nz
 */
public class PoliceBoxRedNorthPreset extends PoliceBoxPreset {

    public PoliceBoxRedNorthPreset() {
        ...
        blueprintData[8][1] = "minecraft:red_mushroom_block[down=false,east=true,north=true,south=true,up=false,west=false]";
