 ...
 * @author eccentric_nz
 */
public class PoliceBoxBrownNorthPreset extends PoliceBoxPreset {

    public PoliceBoxBrownNorthPreset() {
        ...
        blueprintData[8][1] = "minecraft:red_mushroom_block[down=false,east=true,north=true,south=false,up=false,west=true]";
