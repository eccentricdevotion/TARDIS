 ...
 * @author eccentric_nz
 */
public class PoliceBoxPurpleSouthPreset extends PoliceBoxPreset {

    public PoliceBoxPurpleSouthPreset() {
        ...
        blueprintData[8][1] = "minecraft:brown_mushroom_block[down=true,east=false,north=false,south=true,up=true,west=true]";
        ...
        stainedData[8][0] = "minecraft:purple_stained_glass";
        stainedData[8][1] = "minecraft:purple_stained_glass";
