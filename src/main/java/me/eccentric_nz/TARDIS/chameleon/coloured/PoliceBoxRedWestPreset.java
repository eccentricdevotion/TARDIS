 ...
 * @author eccentric_nz
 */
public class PoliceBoxRedWestPreset extends PoliceBoxPreset {

    public PoliceBoxRedWestPreset() {
        ...
        blueprintData[8][1] = "minecraft:brown_mushroom_block[down=true,east=true,north=true,south=false,up=true,west=false]";
