 ...
 * @author eccentric_nz
 */
public class PoliceBoxRedSouthPreset extends PoliceBoxPreset {

    public PoliceBoxRedSouthPreset() {
        ...
        blueprintData[8][1] = "minecraft:brown_mushroom_block[down=true,east=false,north=true,south=false,up=true,west=false]";
