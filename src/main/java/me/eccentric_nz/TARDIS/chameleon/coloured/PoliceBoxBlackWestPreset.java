 ...
 * @author eccentric_nz
 */
public class PoliceBoxBlackWestPreset extends PoliceBoxPreset {

    public PoliceBoxBlackWestPreset() {
        ...
        blueprintData[8][1] = "minecraft:brown_mushroom_block[down=true,east=true,north=true,south=false,up=true,west=true]";
