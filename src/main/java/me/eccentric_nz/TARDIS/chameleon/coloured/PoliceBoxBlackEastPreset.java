 ...
 * @author eccentric_nz
 */
public class PoliceBoxBlackEastPreset extends PoliceBoxPreset {

    public PoliceBoxBlackEastPreset() {
        ...
        blueprintData[8][1] = "minecraft:brown_mushroom_block[down=false,east=true,north=true,south=false,up=true,west=true]";
