 ...
 * @author eccentric_nz
 */
public class PoliceBoxGrayNorthPreset extends PoliceBoxPreset {

    public PoliceBoxGrayNorthPreset() {
        ...
        blueprintData[8][1] = "minecraft:red_mushroom_block[down=false,east=true,north=false,south=false,up=false,west=true]";
