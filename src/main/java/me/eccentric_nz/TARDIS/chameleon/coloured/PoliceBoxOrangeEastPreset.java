 ...
 * @author eccentric_nz
 */
public class PoliceBoxOrangeEastPreset extends PoliceBoxPreset {

    public PoliceBoxOrangeEastPreset() {
        ...
        blueprintData[8][1] = "minecraft:brown_mushroom_block[down=false,east=false,north=true,south=false,up=false,west=true]";
