 ...
 * @author eccentric_nz
 */
public class PoliceBoxLimeSouthPreset extends PoliceBoxPreset {

    public PoliceBoxLimeSouthPreset() {
        ...
        blueprintData[8][1] = "minecraft:brown_mushroom_block[down=true,east=false,north=false,south=false,up=true,west=false]";
        ...
        stainedData[8][0] = "minecraft:lime_stained_glass";
        stainedData[8][1] = "minecraft:lime_stained_glass";
