 ...
 * @author eccentric_nz
 */
public class PoliceBoxCyanEastPreset extends PoliceBoxPreset {

    public PoliceBoxCyanEastPreset() {
        ...
        blueprintData[8][1] = "minecraft:brown_mushroom_block[down=false,east=true,north=false,south=true,up=false,west=false]";
