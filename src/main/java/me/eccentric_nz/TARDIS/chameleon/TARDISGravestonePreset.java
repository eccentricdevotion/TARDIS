 ...
 * @author eccentric_nz
 */
class TARDISGravestonePreset extends TARDISPreset {

    TARDISGravestonePreset() {
        ...
        blueprintData[2][2] = "minecraft:end_stone";
        blueprintData[2][3] = "minecraft:air";
        blueprintData[3][0] = "minecraft:end_stone";
        blueprintData[3][1] = "minecraft:end_stone";
        blueprintData[3][2] = "minecraft:end_stone";
        blueprintData[3][3] = "minecraft:end_stone";
        blueprintData[4][0] = "minecraft:air";
        blueprintData[4][1] = "minecraft:air";
        blueprintData[4][2] = "minecraft:end_stone";
        ...
        blueprintData[7][0] = "minecraft:dirt";
        blueprintData[7][1] = "minecraft:poppy";
        ...
        blueprintData[8][2] = "minecraft:wall_sign[facing=west]";
        ...
        stainedData[8][2] = "minecraft:wall_sign[facing=west]";
        ...
        glassData[8][2] = "minecraft:wall_sign[facing=west]";
