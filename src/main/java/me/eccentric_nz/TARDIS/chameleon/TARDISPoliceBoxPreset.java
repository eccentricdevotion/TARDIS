 ...
 * @author eccentric_nz
 */
public class TARDISPoliceBoxPreset {
    ...
    private final EnumMap<TARDISConstants.COMPASS, TARDISChameleonColumn> policeBox = new EnumMap<TARDISConstants.COMPASS, TARDISChameleonColumn>(TARDISConstants.COMPASS.class);
    ...
    public void makePresets() {
        ...
        for (TARDISConstants.COMPASS d : TARDISConstants.COMPASS.values()) {
            policeBox.put(d, tcp.buildTARDISChameleonColumn(d, police_id, police_data, false));
    ...
    public EnumMap<TARDISConstants.COMPASS, TARDISChameleonColumn> getPoliceBox() {
        return policeBox;
    }
