...
public class TARDISPartyPreset {
    ...
    private final String ice_id = "[[79,79,0,0],[79,79,79,0],[79,79,0,0],[79,79,79,0],[79,79,0,0],[79,79,79,0],[79,79,0,0],[71,71,79,0],[0,0,79,79],[0,0,68,0]]";
    ...
    private final EnumMap<TARDISConstants.COMPASS, TARDISChameleonColumn> partyTent = new EnumMap<TARDISConstants.COMPASS, TARDISChameleonColumn>(TARDISConstants.COMPASS.class);
    ...
    public void makePresets() {
        ...
        for (TARDISConstants.COMPASS d : TARDISConstants.COMPASS.values()) {
            partyTent.put(d, tcp.buildTARDISChameleonColumn(d, tent_id, tent_data, false));
    ...
    public EnumMap<TARDISConstants.COMPASS, TARDISChameleonColumn> getPartyTent() {
        return partyTent;
    }
