...
public class ConstructColumn {
    ...
    public ConstructColumn(TARDIS plugin, int id, String field, COMPASS d) {
        this.plugin = plugin;
        this.id = id;
        this.field = field;
        this.d = d;
    ...
    public ChameleonColumn getColumn() {
        // get the json data
        ...
        if (rs.resultSet()) {
            ...
            if (data != null) {
                ...
                return TARDISChameleonPreset.buildTARDISChameleonColumn(d, strings);
            }
        }
        return null;
    }
