...
public class TARDISJunkPreset extends TARDISPreset {
    ...
    public TARDISJunkPreset() {
        ...
        blueprintData[1][1] = "minecraft:stone_bricks";
        blueprintData[1][2] = "minecraft:orange_wool";
        blueprintData[1][3] = "minecraft:stone_bricks";
        ...
        blueprintData[2][3] = "minecraft:orange_wool";
        blueprintData[3][0] = "minecraft:light_gray_wool";
        blueprintData[3][1] = "minecraft:orange_wool";
        blueprintData[3][2] = "minecraft:orange_wool";
        blueprintData[3][3] = "minecraft:orange_wool";
        blueprintData[4][0] = "minecraft:light_gray_wool";
        blueprintData[4][1] = "minecraft:orange_wool";
        blueprintData[4][2] = "minecraft:orange_wool";
        blueprintData[4][3] = "minecraft:orange_wool";
        blueprintData[5][0] = "minecraft:stone_slab[half=bottom]";
        ...
        blueprintData[6][1] = "minecraft:stone_slab[half=top]";
        blueprintData[6][2] = "minecraft:lever[face=floor,facing=south,powered=false]";
        blueprintData[6][3] = "minecraft:light_gray_wool";
        blueprintData[7][0] = "stone_slab[half=bottom]";
        blueprintData[7][1] = "minecraft:air";
        blueprintData[7][2] = "minecraft:air";
        blueprintData[7][3] = "minecraft:cobblestone_wall";
        ...
        stainedData[1][2] = "minecraft:orange_stained_glass";
        ...
        stainedData[3][1] = "minecraft:orange_stained_glass";
        ...
        stainedData[4][2] = "minecraft:orange_stained_glass";
        ...
        blueprintWest[0][2] = "minecraft:orange_wool";
        blueprintWest[0][3] = "minecraft:orange_wool";
        blueprintWest[1][0] = "minecraft:stone_slab[half=bottom]";
        ...
        blueprintWest[2][1] = "minecraft:stone_slab[half=top]";
        blueprintWest[2][2] = "minecraft:lever[face=floor,facing=south,powered=false]";
        blueprintWest[2][3] = "minecraft:light_gray_wool";
        blueprintWest[3][0] = "minecraft:stone_slab[half=bottom]";
        blueprintWest[3][1] = "minecraft:air";
        blueprintWest[3][2] = "minecraft:air";
        blueprintWest[3][3] = "minecraft:cobblestone_wall";
        ...
        blueprintWest[5][1] = "minecraft:stone_bricks";
        blueprintWest[5][2] = "minecraft:orange_wool";
        blueprintWest[5][3] = "minecraft:stone_bricks";
        blueprintWest[6][0] = "minecraft:light_gray_wool";
        blueprintWest[6][1] = "minecraft:orange_wool";
        blueprintWest[6][2] = "minecraft:orange_wool";
        blueprintWest[6][3] = "minecraft:orange_wool";
        blueprintWest[7][0] = "minecraft:light_gray_wool";
        blueprintWest[7][1] = "minecraft:orange_wool";
        blueprintWest[7][2] = "minecraft:orange_wool";
        blueprintWest[7][3] = "minecraft:orange_wool";
        ...
        stainedWest[0][2] = "minecraft:orange_stained_glass";
        ...
        stainedWest[5][1] = "minecraft:light_gray_stained_glass";
        stainedWest[5][2] = "minecraft:orange_stained_glass";
        stainedWest[5][3] = "minecraft:light_gray_stained_glass";
        stainedWest[6][0] = "minecraft:light_gray_stained_glass";
        stainedWest[6][1] = "minecraft:orange_stained_glass";
        stainedWest[6][2] = "minecraft:orange_stained_glass";
        stainedWest[6][3] = "minecraft:orange_stained_glass";
        stainedWest[7][0] = "minecraft:light_gray_stained_glass";
        stainedWest[7][1] = "minecraft:orange_stained_glass";
        stainedWest[7][2] = "minecraft:orange_stained_glass";
        stainedWest[7][3] = "minecraft:orange_stained_glass";
        ...
        glassWest[6][1] = "minecraft:glass";
        glassWest[6][2] = "minecraft:glass";
        glassWest[6][3] = "minecraft:glass";
