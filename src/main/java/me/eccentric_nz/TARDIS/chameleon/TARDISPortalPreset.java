...
public class TARDISPortalPreset extends TARDISPreset {
    ...
    public TARDISPortalPreset() {
        ...
        blueprintData[2][3] = "minecraft:quartz_slab[half=bottom]";
        ...
        blueprintData[3][3] = "minecraft:quartz_slab[half=bottom]";
        ...
        blueprintData[6][3] = "minecraft:quartz_slab[half=bottom]";
        ...
        blueprintData[7][3] = "minecraft:quartz_slab[half=bottom]";
