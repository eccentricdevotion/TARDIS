 ...
 * @author eccentric_nz
 */
public class BoatPreset extends TARDISPreset {
    ...
    public BoatPreset() {
        ...
        blueprintData[1][0] = "minecraft:oak_stairs[half=top,facing=south]";
        ...
        blueprintData[3][0] = "minecraft:oak_stairs[half=top,facing=west]";
        blueprintData[3][1] = "minecraft:oak_fence";
        blueprintData[3][2] = "minecraft:oak_fence";
        blueprintData[3][3] = "minecraft:oak_fence";
        ...
        blueprintData[5][0] = "minecraft:oak_stairs[half=top,facing=north]";
        blueprintData[5][1] = "minecraft:air";
        blueprintData[5][2] = "minecraft:air";
        blueprintData[5][3] = "minecraft:air";
        blueprintData[6][0] = "minecraft:oak_stairs[half=top,facing=north]";
        ...
        stainedData[9][0] = "minecraft:oak_trapdoor[half=bottom,facing=west,open=true]";
        ...
        glassData[9][0] = "minecraft:oak_trapdoor[half=bottom,facing=west,open=true]";
