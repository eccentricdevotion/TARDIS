 ...
 * @author eccentric_nz
 */
public class ExtremeHillsPreset extends TARDISPreset {

    public ExtremeHillsPreset() {
        ...
        blueprintData[5][3] = "minecraft:spruce_leaves";
        blueprintData[6][0] = "minecraft:dirt";
        blueprintData[6][1] = "minecraft:spruce_log[axis=y]";
        blueprintData[6][2] = "minecraft:spruce_log[axis=y]";
        blueprintData[6][3] = "minecraft:spruce_leaves";
        ...
        blueprintData[7][3] = "minecraft:spruce_leaves";
        blueprintData[8][0] = "minecraft:air";
        blueprintData[8][1] = "minecraft:air";
        blueprintData[8][2] = "minecraft:stone";
        ...
        stainedData[3][0] = "minecraft:gray_stained_glass";
        ...
        stainedData[6][3] = "minecraft:green_stained_glass";
