 ...
 * @author eccentric_nz
 */
public class RoofedForestPreset extends TARDISPreset {

    public RoofedForestPreset() {
        // set blueprint data strings
        String[][] blueprintData = new String[10][4];
        blueprintData[0][0] = "minecraft:dark_oak_log[axis=y]";
        blueprintData[0][1] = "minecraft:dark_oak_log[axis=y]";
        blueprintData[0][2] = "minecraft:dark_oak_log[axis=y]";
        blueprintData[0][3] = "minecraft:dark_oak_leaves";
        blueprintData[1][0] = "minecraft:dark_oak_log[axis=y]";
        blueprintData[1][1] = "minecraft:dark_oak_log[axis=y]";
        blueprintData[1][2] = "minecraft:dark_oak_leaves";
        blueprintData[1][3] = "minecraft:red_mushroom_block[down=false,east=false,north=false,south=false,up=true,west=true]";
        blueprintData[2][0] = "minecraft:dark_oak_log[axis=y]";
        blueprintData[2][1] = "minecraft:mushroom_stem[down=false,east=true,north=true,south=true,up=false,west=true]";
        blueprintData[2][2] = "minecraft:mushroom_stem[down=false,east=true,north=true,south=true,up=false,west=true]";
        blueprintData[2][3] = "minecraft:red_mushroom_block[down=false,east=false,north=false,south=false,up=true,west=false]";
        blueprintData[3][0] = "minecraft:dark_oak_leaves";
        blueprintData[3][1] = "minecraft:dark_oak_leaves";
        blueprintData[3][2] = "minecraft:dark_oak_log[axis=y]";
        blueprintData[3][3] = "minecraft:red_mushroom_block[down=false,east=false,north=false,south=true,up=true,west=false]";
        blueprintData[4][0] = "minecraft:dark_oak_leaves";
        blueprintData[4][1] = "minecraft:dark_oak_leaves";
        blueprintData[4][2] = "minecraft:dark_oak_log[axis=y]";
        blueprintData[4][3] = "minecraft:air";
        blueprintData[5][0] = "minecraft:dark_oak_leaves";
        blueprintData[5][1] = "minecraft:dark_oak_leaves";
        blueprintData[5][2] = "minecraft:dark_oak_log[axis=y]";
        blueprintData[5][3] = "minecraft:dark_oak_log[axis=y]";
        blueprintData[6][0] = "minecraft:dark_oak_leaves";
        blueprintData[6][1] = "minecraft:dark_oak_leaves";
        blueprintData[6][2] = "minecraft:dark_oak_leaves";
        blueprintData[6][3] = "minecraft:dark_oak_log[axis=y]";
        blueprintData[7][0] = "minecraft:dark_oak_door[half=lower,hinge=right,facing=east,open=false]";
        blueprintData[7][1] = "minecraft:dark_oak_door[half=upper,hinge=right,facing=east,open=false]";
        blueprintData[7][2] = "minecraft:dark_oak_leaves";
        blueprintData[7][3] = "minecraft:dark_oak_log[axis=y]";
        blueprintData[8][0] = "minecraft:air";
        blueprintData[8][1] = "minecraft:air";
        blueprintData[8][2] = "minecraft:air";
        blueprintData[8][3] = "minecraft:red_mushroom_block[down=false,east=false,north=false,south=true,up=true,west=true]";
        ...
        stainedData[4][0] = "minecraft:green_stained_glass";
        ...
        stainedData[6][0] = "minecraft:green_stained_glass";
        ...
        stainedData[7][0] = "minecraft:dark_oak_door[half=lower,hinge=right,facing=east,open=false]";
        stainedData[7][1] = "minecraft:dark_oak_door[half=upper,hinge=right,facing=east,open=false]";
        ...
        glassData[7][0] = "minecraft:dark_oak_door[half=lower,hinge=right,facing=east,open=false]";
        glassData[7][1] = "minecraft:dark_oak_door[half=upper,hinge=right,facing=east,open=false]";
