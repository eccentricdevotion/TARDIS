 ...
 * @author eccentric_nz
 */
public class NetherPreset extends TARDISPreset {
    ...
    public NetherPreset() {
        ...
        blueprintData[0][1] = "minecraft:nether_brick_stairs[half=top,facing=south,shape=straight]";
        blueprintData[0][2] = "minecraft:nether_brick_stairs[half=bottom,facing=south,shape=outer_left]";
        blueprintData[0][3] = "minecraft:air";
        blueprintData[1][0] = "minecraft:nether_brick_stairs[half=bottom,facing=south,shape=straight]";
        blueprintData[1][1] = "minecraft:nether_brick_stairs[half=top,facing=south,shape=straight]";
        blueprintData[1][2] = "minecraft:nether_brick_stairs[half=bottom,facing=south,shape=straight]";
        blueprintData[1][3] = "minecraft:air";
        blueprintData[2][0] = "minecraft:nether_brick_stairs[half=bottom,facing=south,shape=outer_right]";
        blueprintData[2][1] = "minecraft:nether_brick_stairs[half=top,facing=south,shape=outer_right]";
        blueprintData[2][2] = "minecraft:nether_brick_stairs[half=bottom,facing=south,shape=outer_right]";
        blueprintData[2][3] = "minecraft:air";
        blueprintData[3][0] = "minecraft:nether_brick_stairs[half=bottom,facing=west,shape=straight]";
        blueprintData[3][1] = "minecraft:nether_brick_stairs[half=top,facing=west,shape=straight]";
        blueprintData[3][2] = "minecraft:nether_brick_stairs[half=bottom,facing=west,shape=straight]";
        blueprintData[3][3] = "minecraft:air";
        blueprintData[4][0] = "minecraft:nether_brick_stairs[half=bottom,facing=north,shape=outer_left]";
        blueprintData[4][1] = "minecraft:nether_brick_stairs[half=top,facing=north,shape=outer_left]";
        blueprintData[4][2] = "minecraft:nether_brick_stairs[half=bottom,facing=north,shape=outer_left]";
        blueprintData[4][3] = "minecraft:air";
        blueprintData[5][0] = "minecraft:nether_brick_stairs[half=bottom,facing=north,shape=straight]";
        blueprintData[5][1] = "minecraft:nether_brick_stairs[half=top,facing=north,shape=straight]";
        blueprintData[5][2] = "minecraft:nether_brick_stairs[half=bottom,facing=north,shape=straight]";
        ...
        blueprintData[8][2] = "minecraft:nether_bricks";
        ...
        stainedData[0][0] = "minecraft:red_stained_glass";
        stainedData[0][1] = "minecraft:red_stained_glass";
        stainedData[0][2] = "minecraft:red_stained_glass";
        stainedData[0][3] = "minecraft:air";
        stainedData[1][0] = "minecraft:red_stained_glass";
        stainedData[1][1] = "minecraft:red_stained_glass";
        stainedData[1][2] = "minecraft:red_stained_glass";
        stainedData[1][3] = "minecraft:air";
        stainedData[2][0] = "minecraft:red_stained_glass";
        stainedData[2][1] = "minecraft:red_stained_glass";
        stainedData[2][2] = "minecraft:red_stained_glass";
        stainedData[2][3] = "minecraft:air";
        stainedData[3][0] = "minecraft:red_stained_glass";
        stainedData[3][1] = "minecraft:red_stained_glass";
        stainedData[3][2] = "minecraft:red_stained_glass";
        stainedData[3][3] = "minecraft:air";
        stainedData[4][0] = "minecraft:red_stained_glass";
        stainedData[4][1] = "minecraft:red_stained_glass";
        stainedData[4][2] = "minecraft:red_stained_glass";
        stainedData[4][3] = "minecraft:air";
        stainedData[5][0] = "minecraft:red_stained_glass";
        stainedData[5][1] = "minecraft:red_stained_glass";
        stainedData[5][2] = "minecraft:red_stained_glass";
        stainedData[5][3] = "minecraft:air";
        stainedData[6][0] = "minecraft:red_stained_glass";
        stainedData[6][1] = "minecraft:red_stained_glass";
        stainedData[6][2] = "minecraft:red_stained_glass";
