 ...
 * @author eccentric_nz
 */
public class IcePlainsPreset extends TARDISPreset {

    public IcePlainsPreset() {
        // set blueprint data strings
        String[][] blueprintData = new String[10][4];
        blueprintData[0][0] = "minecraft:snow_block";
        blueprintData[0][1] = "minecraft:snow_block";
        blueprintData[0][2] = "minecraft:snow_block";
        blueprintData[0][3] = "minecraft:air";
        blueprintData[1][0] = "minecraft:snow_block";
        blueprintData[1][1] = "minecraft:snow_block";
        blueprintData[1][2] = "minecraft:spruce_leaves";
        blueprintData[1][3] = "minecraft:air";
        blueprintData[2][0] = "minecraft:spruce_log[axis=y]";
        blueprintData[2][1] = "minecraft:spruce_log[axis=y]";
        blueprintData[2][2] = "minecraft:spruce_log[axis=y]";
        blueprintData[2][3] = "minecraft:spruce_leaves";
        blueprintData[3][0] = "minecraft:snow_block";
        blueprintData[3][1] = "minecraft:snow_block";
        blueprintData[3][2] = "minecraft:spruce_leaves";
        blueprintData[3][3] = "minecraft:air";
        blueprintData[4][0] = "minecraft:snow_block";
        blueprintData[4][1] = "minecraft:snow_block";
        blueprintData[4][2] = "minecraft:snow_block";
        blueprintData[4][3] = "minecraft:air";
        blueprintData[5][0] = "minecraft:snow_block";
        blueprintData[5][1] = "minecraft:ice";
        blueprintData[5][2] = "minecraft:snow_block";
        blueprintData[5][3] = "minecraft:air";
        blueprintData[6][0] = "minecraft:snow_block";
        blueprintData[6][1] = "minecraft:snow_block";
        ...
        stainedData[0][0] = "minecraft:white_stained_glass";
        ...
        stainedData[2][3] = "minecraft:green_stained_glass";
        stainedData[3][0] = "minecraft:white_stained_glass";
        stainedData[3][1] = "minecraft:white_stained_glass";
        stainedData[3][2] = "minecraft:green_stained_glass";
        stainedData[3][3] = "minecraft:air";
        stainedData[4][0] = "minecraft:white_stained_glass";
        ...
        stainedData[6][0] = "minecraft:white_stained_glass";
