 ...
 * @author eccentric_nz
 */
public class TopsyTurveyPreset extends TARDISPreset {

    public TopsyTurveyPreset() {
        ...
        blueprintData[0][3] = "minecraft:blue_wool";
        blueprintData[1][0] = "minecraft:stone_slab[type=top]";
        blueprintData[1][1] = "minecraft:blue_wool";
        blueprintData[1][2] = "minecraft:blue_wool";
        blueprintData[1][3] = "minecraft:blue_wool";
        blueprintData[2][0] = "minecraft:stone_slab[type=top]";
        blueprintData[2][1] = "minecraft:blue_wool";
        blueprintData[2][2] = "minecraft:blue_wool";
        blueprintData[2][3] = "minecraft:blue_wool";
        blueprintData[3][0] = "minecraft:stone_slab[type=top]";
        blueprintData[3][1] = "minecraft:blue_wool";
        blueprintData[3][2] = "minecraft:blue_wool";
        blueprintData[3][3] = "minecraft:blue_wool";
        blueprintData[4][0] = "minecraft:stone_slab[type=top]";
        blueprintData[4][1] = "minecraft:blue_wool";
        blueprintData[4][2] = "minecraft:blue_wool";
        blueprintData[4][3] = "minecraft:blue_wool";
        blueprintData[5][0] = "minecraft:stone_slab[type=top]";
        blueprintData[5][1] = "minecraft:blue_wool";
        blueprintData[5][2] = "minecraft:blue_wool";
        blueprintData[5][3] = "minecraft:blue_wool";
        blueprintData[6][0] = "minecraft:stone_slab[type=top]";
        blueprintData[6][1] = "minecraft:blue_wool";
        blueprintData[6][2] = "minecraft:blue_wool";
        blueprintData[6][3] = "minecraft:blue_wool";
        blueprintData[7][0] = "minecraft:stone_slab[type=top]";
        blueprintData[7][1] = "minecraft:blue_wool";
        blueprintData[7][2] = "minecraft:iron_door[half=lower,hinge=right,facing=east,open=false]";
        blueprintData[7][3] = "minecraft:iron_door[half=upper,hinge=right,facing=east,open=false]";
        blueprintData[8][0] = "minecraft:redstone_lamp[lit=true]";
        blueprintData[8][1] = "minecraft:redstone_block";
        ...
        stainedData[7][1] = "minecraft:blue_stained_glass";
        stainedData[7][2] = "minecraft:iron_door[half=lower,hinge=right,facing=east,open=false]";
        stainedData[7][3] = "minecraft:iron_door[half=upper,hinge=right,facing=east,open=false]";
        stainedData[8][0] = "minecraft:redstone_lamp[lit=false]";
        stainedData[8][1] = "minecraft:red_stained_glass";
        ...
        glassData[7][2] = "minecraft:iron_door[half=lower,hinge=right,facing=east,open=false]";
        glassData[7][3] = "minecraft:iron_door[half=upper,hinge=right,facing=east,open=false]";
        glassData[8][0] = "minecraft:redstone_lamp[lit=false]";
