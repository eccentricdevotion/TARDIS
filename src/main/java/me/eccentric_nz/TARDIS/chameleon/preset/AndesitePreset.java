 ...
 * @author eccentric_nz
 */
public class AndesitePreset extends TARDISPreset {

    public AndesitePreset() {
        // set blueprint data strings
        String[][] blueprintData = new String[10][4];
        blueprintData[0][0] = "minecraft:andesite";
        blueprintData[0][1] = "minecraft:polished_andesite";
        blueprintData[0][2] = "minecraft:andesite";
        blueprintData[0][3] = "minecraft:cobblestone_slab";
        blueprintData[1][0] = "minecraft:andesite";
        blueprintData[1][1] = "minecraft:polished_andesite";
        blueprintData[1][2] = "minecraft:andesite";
        blueprintData[1][3] = "minecraft:cobblestone_slab";
        blueprintData[2][0] = "minecraft:andesite";
        blueprintData[2][1] = "minecraft:polished_andesite";
        blueprintData[2][2] = "minecraft:andesite";
        blueprintData[2][3] = "minecraft:cobblestone_slab";
        blueprintData[3][0] = "minecraft:andesite";
        blueprintData[3][1] = "minecraft:polished_andesite";
        blueprintData[3][2] = "minecraft:andesite";
        blueprintData[3][3] = "minecraft:cobblestone_slab";
        blueprintData[4][0] = "minecraft:andesite";
        blueprintData[4][1] = "minecraft:polished_andesite";
        blueprintData[4][2] = "minecraft:andesite";
        blueprintData[4][3] = "minecraft:cobblestone_slab";
        blueprintData[5][0] = "minecraft:andesite";
        blueprintData[5][1] = "minecraft:polished_andesite";
        blueprintData[5][2] = "minecraft:andesite";
        blueprintData[5][3] = "minecraft:cobblestone_slab";
        blueprintData[6][0] = "minecraft:andesite";
        blueprintData[6][1] = "minecraft:polished_andesite";
        blueprintData[6][2] = "minecraft:andesite";
        ...
        blueprintData[7][2] = "minecraft:andesite";
