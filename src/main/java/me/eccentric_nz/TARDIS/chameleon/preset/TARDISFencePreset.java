...
public class TARDISFencePreset extends TARDISPreset {
    ...
    public TARDISFencePreset() {
        ...
        blueprintData[5][0] = "minecraft:oak_trapdoor[half=bottom,facing=east,open=true]";
        ...
        stainedData[5][0] = "minecraft:oak_trapdoor[half=bottom,facing=east,open=true]";
        ...
        glassData[5][0] = "minecraft:oak_trapdoor[half=bottom,facing=east,open=true]";
