 ...
 * @author eccentric_nz
 */
public class WellPreset extends TARDISPreset {
    ...
    public WellPreset() {
        ...
        blueprintData[0][2] = "minecraft:oak_fence";
        blueprintData[0][3] = "minecraft:mossy_stone_bricks";
        blueprintData[1][0] = "minecraft:mossy_stone_bricks";
        blueprintData[1][1] = "minecraft:air";
        blueprintData[1][2] = "minecraft:air";
        blueprintData[1][3] = "minecraft:mossy_stone_bricks";
        blueprintData[2][0] = "minecraft:mossy_stone_bricks";
        blueprintData[2][1] = "minecraft:oak_fence";
        blueprintData[2][2] = "minecraft:oak_fence";
        blueprintData[2][3] = "minecraft:mossy_stone_bricks";
        blueprintData[3][0] = "minecraft:mossy_stone_bricks";
        blueprintData[3][1] = "minecraft:air";
        blueprintData[3][2] = "minecraft:air";
        blueprintData[3][3] = "minecraft:mossy_stone_bricks";
        blueprintData[4][0] = "minecraft:mossy_stone_bricks";
        blueprintData[4][1] = "minecraft:oak_fence";
        blueprintData[4][2] = "minecraft:oak_fence";
        blueprintData[4][3] = "minecraft:mossy_stone_bricks";
        blueprintData[5][0] = "minecraft:mossy_stone_bricks";
        blueprintData[5][1] = "minecraft:air";
        blueprintData[5][2] = "minecraft:air";
        blueprintData[5][3] = "minecraft:mossy_stone_bricks";
        blueprintData[6][0] = "minecraft:mossy_stone_bricks";
        blueprintData[6][1] = "minecraft:oak_fence";
        blueprintData[6][2] = "minecraft:oak_fence";
        blueprintData[6][3] = "minecraft:mossy_stone_bricks";
        blueprintData[7][0] = "minecraft:mossy_stone_bricks";
        blueprintData[7][1] = "minecraft:air";
        blueprintData[7][2] = "minecraft:air";
        blueprintData[7][3] = "minecraft:mossy_stone_bricks";
        ...
        stainedData[9][3] = "minecraft:vine[east=true]";
        ...
        glassData[9][3] = "minecraft:vine[east=true]";
