 ...
 * @author eccentric_nz
 */
public class TARDISFactoryPreset extends TARDISPreset {

    public TARDISFactoryPreset() {
        // set blueprint data strings
        String[][] blueprintData = new String[10][4];
        blueprintData[0][0] = "minecraft:light_gray_terracotta";
        blueprintData[0][1] = "minecraft:light_gray_terracotta";
        blueprintData[0][2] = "minecraft:light_gray_terracotta";
        blueprintData[0][3] = "minecraft:air";
        blueprintData[1][0] = "minecraft:light_gray_terracotta";
        blueprintData[1][1] = "minecraft:light_gray_terracotta";
        blueprintData[1][2] = "minecraft:light_gray_terracotta";
        blueprintData[1][3] = "minecraft:air";
        blueprintData[2][0] = "minecraft:light_gray_terracotta";
        blueprintData[2][1] = "minecraft:light_gray_terracotta";
        blueprintData[2][2] = "minecraft:light_gray_terracotta";
        blueprintData[2][3] = "minecraft:air";
        blueprintData[3][0] = "minecraft:light_gray_terracotta";
        blueprintData[3][1] = "minecraft:light_gray_terracotta";
        blueprintData[3][2] = "minecraft:light_gray_terracotta";
        blueprintData[3][3] = "minecraft:air";
        blueprintData[4][0] = "minecraft:light_gray_terracotta";
        blueprintData[4][1] = "minecraft:light_gray_terracotta";
        blueprintData[4][2] = "minecraft:light_gray_terracotta";
        blueprintData[4][3] = "minecraft:air";
        blueprintData[5][0] = "minecraft:light_gray_terracotta";
        blueprintData[5][1] = "minecraft:light_gray_terracotta";
        blueprintData[5][2] = "minecraft:light_gray_terracotta";
        blueprintData[5][3] = "minecraft:air";
        blueprintData[6][0] = "minecraft:light_gray_terracotta";
        blueprintData[6][1] = "minecraft:light_gray_terracotta";
        blueprintData[6][2] = "minecraft:light_gray_terracotta";
        ...
        blueprintData[7][2] = "minecraft:light_gray_terracotta";
        blueprintData[7][3] = "minecraft:air";
        blueprintData[8][0] = "minecraft:air";
        blueprintData[8][1] = "minecraft:air";
        blueprintData[8][2] = "minecraft:light_gray_terracotta";
