 ...
 * @author eccentric_nz
 */
public class JunglePreset extends TARDISPreset {

    public JunglePreset() {
        // set blueprint data strings
        String[][] blueprintData = new String[10][4];
        blueprintData[0][0] = "minecraft:mossy_cobblestone";
        blueprintData[0][1] = "minecraft:mossy_cobblestone";
        blueprintData[0][2] = "minecraft:cobblestone";
        blueprintData[0][3] = "minecraft:air";
        blueprintData[1][0] = "minecraft:mossy_cobblestone";
        blueprintData[1][1] = "minecraft:cobblestone";
        blueprintData[1][2] = "minecraft:mossy_cobblestone";
        blueprintData[1][3] = "minecraft:cobblestone_stairs[half=bottom,facing=south]";
        blueprintData[2][0] = "minecraft:cobblestone";
        blueprintData[2][1] = "minecraft:cobblestone";
        blueprintData[2][2] = "minecraft:mossy_cobblestone";
        blueprintData[2][3] = "minecraft:air";
        blueprintData[3][0] = "minecraft:cobblestone";
        blueprintData[3][1] = "minecraft:mossy_cobblestone";
        blueprintData[3][2] = "minecraft:cobblestone";
        blueprintData[3][3] = "minecraft:cobblestone_stairs[half=bottom,facing=west]";
        blueprintData[4][0] = "minecraft:mossy_cobblestone";
        blueprintData[4][1] = "minecraft:cobblestone";
        blueprintData[4][2] = "minecraft:mossy_cobblestone";
        blueprintData[4][3] = "minecraft:air";
        blueprintData[5][0] = "minecraft:mossy_cobblestone";
        blueprintData[5][1] = "minecraft:cobblestone";
        blueprintData[5][2] = "minecraft:mossy_cobblestone";
        blueprintData[5][3] = "minecraft:cobblestone_stairs[half=bottom,facing=north]";
        blueprintData[6][0] = "minecraft:cobblestone";
        blueprintData[6][1] = "minecraft:cobblestone";
        blueprintData[6][2] = "minecraft:mossy_cobblestone";
        ...
        stainedData[9][2] = "minecraft:vine[east=true]";
        ...
        glassData[9][2] = "minecraft:vine[east=true]";
