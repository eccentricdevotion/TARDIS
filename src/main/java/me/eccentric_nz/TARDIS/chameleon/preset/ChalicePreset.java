 ...
 * @author eccentric_nz
 */
public class ChalicePreset extends TARDISPreset {

    public ChalicePreset() {
        ...
        blueprintData[7][0] = "minecraft:iron_door[half=lower,hinge=right,facing=west,open=false]";
        blueprintData[7][1] = "minecraft:iron_door[half=upper,hinge=right,facing=west,open=false]";
        blueprintData[7][2] = "minecraft:quartz_stairs[half=bottom,facing=east,shape=straight]";
        blueprintData[7][3] = "minecraft:quartz_block";
        blueprintData[8][0] = "minecraft:quartz_block";
        blueprintData[8][1] = "minecraft:quartz_block";
        blueprintData[8][2] = "minecraft:quartz_block";
        blueprintData[8][3] = "minecraft:water";
        ...
        stainedData[2][0] = "minecraft:white_stained_glass";
        ...
        stainedData[7][0] = "minecraft:iron_door[half=lower,hinge=right,facing=west,open=false]";
        stainedData[7][1] = "minecraft:iron_door[half=upper,hinge=right,facing=west,open=false]";
        stainedData[7][2] = "minecraft:white_stained_glass";
        stainedData[7][3] = "minecraft:white_stained_glass";
        stainedData[8][0] = "minecraft:white_stained_glass";
        stainedData[8][1] = "minecraft:white_stained_glass";
        ...
        glassData[7][0] = "minecraft:iron_door[half=lower,hinge=right,facing=west,open=false]";
        glassData[7][1] = "minecraft:iron_door[half=upper,hinge=right,facing=west,open=false]";
