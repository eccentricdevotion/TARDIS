 ...
 * @author eccentric_nz
 */
public class TARDISApertureSciencePreset extends TARDISPreset {

    public TARDISApertureSciencePreset() {
        ...
        blueprintData[2][0] = "minecraft:orange_wool";
        ...
        blueprintData[8][2] = "minecraft:oak_trapdoor[half=top,facing=north,open=false]";
        ...
        stainedData[2][0] = "minecraft:orange_stained_glass";
        ...
        stainedData[8][2] = "minecraft:oak_trapdoor[half=top,facing=north,open=false]";
        ...
        glassData[8][2] = "minecraft:oak_trapdoor[half=top,facing=north,open=false]";
