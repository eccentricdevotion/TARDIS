 ...
 * @author eccentric_nz
 */
public class LighthousePreset extends TARDISPreset {

    public LighthousePreset() {
        // set blueprint data strings
        String[][] blueprintData = new String[10][4];
        blueprintData[0][0] = "minecraft:red_terracotta";
        blueprintData[0][1] = "minecraft:quartz_block";
        blueprintData[0][2] = "minecraft:red_terracotta";
        blueprintData[0][3] = "minecraft:glass";
        blueprintData[1][0] = "minecraft:red_terracotta";
        blueprintData[1][1] = "minecraft:quartz_block";
        blueprintData[1][2] = "minecraft:red_terracotta";
        blueprintData[1][3] = "minecraft:glass";
        blueprintData[2][0] = "minecraft:red_terracotta";
        blueprintData[2][1] = "minecraft:quartz_block";
        blueprintData[2][2] = "minecraft:red_terracotta";
        blueprintData[2][3] = "minecraft:glass";
        blueprintData[3][0] = "minecraft:red_terracotta";
        blueprintData[3][1] = "minecraft:quartz_block";
        blueprintData[3][2] = "minecraft:red_terracotta";
        blueprintData[3][3] = "minecraft:glass";
        blueprintData[4][0] = "minecraft:red_terracotta";
        blueprintData[4][1] = "minecraft:quartz_block";
        blueprintData[4][2] = "minecraft:red_terracotta";
        blueprintData[4][3] = "minecraft:glass";
        blueprintData[5][0] = "minecraft:red_terracotta";
        blueprintData[5][1] = "minecraft:quartz_block";
        blueprintData[5][2] = "minecraft:red_terracotta";
        blueprintData[5][3] = "minecraft:glass";
        blueprintData[6][0] = "minecraft:red_terracotta";
        blueprintData[6][1] = "minecraft:quartz_block";
        blueprintData[6][2] = "minecraft:red_terracotta";
        blueprintData[6][3] = "minecraft:glass";
        ...
        blueprintData[7][2] = "minecraft:red_terracotta";
        blueprintData[7][3] = "minecraft:glass";
        ...
        stainedData[0][3] = "minecraft:glass";
        ...
        stainedData[1][3] = "minecraft:glass";
        ...
        stainedData[2][3] = "minecraft:glass";
        ...
        stainedData[3][3] = "minecraft:glass";
        ...
        stainedData[4][3] = "minecraft:glass";
        ...
        stainedData[5][3] = "minecraft:glass";
        ...
        stainedData[6][3] = "minecraft:glass";
        ...
        stainedData[7][3] = "minecraft:glass";
