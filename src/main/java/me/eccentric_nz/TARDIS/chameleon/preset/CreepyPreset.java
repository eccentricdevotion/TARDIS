 ...
 * @author eccentric_nz
 */
public class CreepyPreset extends TARDISPreset {

    public CreepyPreset() {
        // set blueprint data strings
        String[][] blueprintData = new String[10][4];
        blueprintData[0][0] = "minecraft:gray_terracotta";
        blueprintData[0][1] = "minecraft:gray_terracotta";
        blueprintData[0][2] = "minecraft:gray_terracotta";
        blueprintData[0][3] = "minecraft:nether_brick_slab[type=bottom]";
        blueprintData[1][0] = "minecraft:cobweb";
        blueprintData[1][1] = "minecraft:cobweb";
        blueprintData[1][2] = "minecraft:cobweb";
        blueprintData[1][3] = "minecraft:nether_brick_slab[type=bottom]";
        blueprintData[2][0] = "minecraft:gray_terracotta";
        blueprintData[2][1] = "minecraft:gray_terracotta";
        blueprintData[2][2] = "minecraft:gray_terracotta";
        blueprintData[2][3] = "minecraft:nether_brick_slab[type=bottom]";
        blueprintData[3][0] = "minecraft:cobweb";
        blueprintData[3][1] = "minecraft:cobweb";
        blueprintData[3][2] = "minecraft:cobweb";
        blueprintData[3][3] = "minecraft:nether_brick_slab[type=bottom]";
        blueprintData[4][0] = "minecraft:gray_terracotta";
        blueprintData[4][1] = "minecraft:gray_terracotta";
        blueprintData[4][2] = "minecraft:gray_terracotta";
        blueprintData[4][3] = "minecraft:nether_brick_slab[type=bottom]";
        blueprintData[5][0] = "minecraft:cobweb";
        blueprintData[5][1] = "minecraft:cobweb";
        blueprintData[5][2] = "minecraft:cobweb";
        blueprintData[5][3] = "minecraft:nether_brick_slab[type=bottom]";
        blueprintData[6][0] = "minecraft:gray_terracotta";
        blueprintData[6][1] = "minecraft:gray_terracotta";
        blueprintData[6][2] = "minecraft:gray_terracotta";
        blueprintData[6][3] = "minecraft:nether_brick_slab[type=bottom]";
        ...
        blueprintData[7][2] = "minecraft:cobweb";
        blueprintData[7][3] = "minecraft:nether_brick_slab[type=bottom]";
        ...
        stainedData[0][0] = "minecraft:gray_stained_glass";
        stainedData[0][1] = "minecraft:gray_stained_glass";
        stainedData[0][2] = "minecraft:gray_stained_glass";
        stainedData[0][3] = "minecraft:red_stained_glass";
        stainedData[1][0] = "minecraft:white_stained_glass";
        ...
        stainedData[2][0] = "minecraft:gray_stained_glass";
        stainedData[2][1] = "minecraft:gray_stained_glass";
        stainedData[2][2] = "minecraft:gray_stained_glass";
        stainedData[2][3] = "minecraft:red_stained_glass";
        stainedData[3][0] = "minecraft:white_stained_glass";
        ...
        stainedData[4][0] = "minecraft:gray_stained_glass";
        stainedData[4][1] = "minecraft:gray_stained_glass";
        stainedData[4][2] = "minecraft:gray_stained_glass";
        stainedData[4][3] = "minecraft:red_stained_glass";
        stainedData[5][0] = "minecraft:white_stained_glass";
        ...
        stainedData[6][0] = "minecraft:gray_stained_glass";
        stainedData[6][1] = "minecraft:gray_stained_glass";
        stainedData[6][2] = "minecraft:gray_stained_glass";
