 ...
 * @author eccentric_nz
 */
public class PortalPreset extends TARDISPreset {

    public PortalPreset() {
        // set blueprint data strings
        String[][] blueprintData = new String[10][4];
        blueprintData[0][0] = "minecraft:nether_quartz_ore";
        blueprintData[0][1] = "minecraft:nether_quartz_ore";
        blueprintData[0][2] = "minecraft:nether_quartz_ore";
        blueprintData[0][3] = "minecraft:quartz_slab[type=bottom]";
        blueprintData[1][0] = "minecraft:obsidian";
        blueprintData[1][1] = "minecraft:obsidian";
        blueprintData[1][2] = "minecraft:obsidian";
        blueprintData[1][3] = "minecraft:quartz_slab[type=bottom]";
        blueprintData[2][0] = "minecraft:nether_quartz_ore";
        blueprintData[2][1] = "minecraft:nether_quartz_ore";
        blueprintData[2][2] = "minecraft:nether_quartz_ore";
        blueprintData[2][3] = "minecraft:quartz_slab[type=bottom]";
        blueprintData[3][0] = "minecraft:nether_quartz_ore";
        blueprintData[3][1] = "minecraft:nether_quartz_ore";
        blueprintData[3][2] = "minecraft:nether_quartz_ore";
        blueprintData[3][3] = "minecraft:quartz_slab[type=bottom]";
        blueprintData[4][0] = "minecraft:nether_quartz_ore";
        blueprintData[4][1] = "minecraft:nether_quartz_ore";
        blueprintData[4][2] = "minecraft:nether_quartz_ore";
        blueprintData[4][3] = "minecraft:quartz_slab[type=bottom]";
        blueprintData[5][0] = "minecraft:obsidian";
        blueprintData[5][1] = "minecraft:obsidian";
        blueprintData[5][2] = "minecraft:obsidian";
        blueprintData[5][3] = "minecraft:quartz_slab[type=bottom]";
        blueprintData[6][0] = "minecraft:nether_quartz_ore";
        blueprintData[6][1] = "minecraft:nether_quartz_ore";
        blueprintData[6][2] = "minecraft:nether_quartz_ore";
        blueprintData[6][3] = "minecraft:quartz_slab[type=bottom]";
        ...
        blueprintData[7][2] = "minecraft:nether_quartz_ore";
        blueprintData[7][3] = "minecraft:quartz_slab[type=bottom]";
        blueprintData[8][0] = "minecraft:obsidian";
        blueprintData[8][1] = "minecraft:nether_portal";
        blueprintData[8][2] = "minecraft:obsidian";
        ...
        stainedData[0][3] = "minecraft:white_stained_glass";
        ...
        stainedData[1][3] = "minecraft:white_stained_glass";
        ...
        stainedData[2][3] = "minecraft:white_stained_glass";
        ...
        stainedData[3][3] = "minecraft:white_stained_glass";
        ...
        stainedData[4][3] = "minecraft:white_stained_glass";
        ...
        stainedData[5][3] = "minecraft:white_stained_glass";
        ...
        stainedData[6][3] = "minecraft:white_stained_glass";
        ...
        stainedData[7][3] = "minecraft:white_stained_glass";
