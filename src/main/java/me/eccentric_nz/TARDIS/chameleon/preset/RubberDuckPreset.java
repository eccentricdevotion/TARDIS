 ...
 * @author eccentric_nz
 */
public class RubberDuckPreset extends TARDISPreset {

    public RubberDuckPreset() {
        ...
        blueprintData[8][1] = "minecraft:yellow_wool";
        ...
        stainedData[7][0] = "minecraft:oak_trapdoor[half=bottom,facing=north,open=false]";
        stainedData[7][1] = "minecraft:yellow_stained_glass";
        ...
        stainedData[8][1] = "minecraft:yellow_stained_glass";
        ...
        stainedData[9][2] = "minecraft:brown_stained_glass";
        ...
        glassData[7][0] = "minecraft:oak_trapdoor[half=bottom,facing=north,open=false]";
