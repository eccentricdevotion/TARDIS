 ...
 * @author eccentric_nz
 */
public class TaigaPreset extends TARDISPreset {

    public TaigaPreset() {
        // set blueprint data strings
        String[][] blueprintData = new String[10][4];
        blueprintData[0][0] = "minecraft:podzol";
        blueprintData[0][1] = "minecraft:podzol";
        blueprintData[0][2] = "minecraft:fern";
        blueprintData[0][3] = "minecraft:air";
        blueprintData[1][0] = "minecraft:podzol";
        blueprintData[1][1] = "minecraft:podzol";
        blueprintData[1][2] = "minecraft:mossy_cobblestone";
        blueprintData[1][3] = "minecraft:air";
        blueprintData[2][0] = "minecraft:podzol";
        blueprintData[2][1] = "minecraft:podzol";
        blueprintData[2][2] = "minecraft:air";
        blueprintData[2][3] = "minecraft:air";
        blueprintData[3][0] = "minecraft:podzol";
        blueprintData[3][1] = "minecraft:podzol";
        blueprintData[3][2] = "minecraft:mossy_cobblestone";
        blueprintData[3][3] = "minecraft:air";
        blueprintData[4][0] = "minecraft:podzol";
        blueprintData[4][1] = "minecraft:podzol";
        blueprintData[4][2] = "minecraft:large_fern";
        blueprintData[4][3] = "minecraft:large_fern";
        blueprintData[5][0] = "minecraft:podzol";
        blueprintData[5][1] = "minecraft:podzol";
        blueprintData[5][2] = "minecraft:mossy_cobblestone";
        blueprintData[5][3] = "minecraft:air";
        blueprintData[6][0] = "minecraft:podzol";
        blueprintData[6][1] = "minecraft:podzol";
