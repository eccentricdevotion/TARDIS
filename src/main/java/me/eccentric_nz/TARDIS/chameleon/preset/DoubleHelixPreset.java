 ...
 * @author eccentric_nz
 */
public class DoubleHelixPreset extends TARDISPreset {

    public DoubleHelixPreset() {
        ...
        blueprintData[0][2] = "minecraft:stone_brick_stairs[half=top,facing=east,shape=outer_right]";
        ...
        blueprintData[1][2] = "minecraft:stone_brick_stairs[half=top,facing=south,shape=straight]";
        blueprintData[1][3] = "minecraft:air";
        blueprintData[2][0] = "minecraft:stone_brick_stairs[half=bottom,facing=west,shape=outer_left]";
        blueprintData[2][1] = "minecraft:air";
        blueprintData[2][2] = "minecraft:stone_brick_stairs[half=top,facing=west,shape=outer_left]";
        ...
        blueprintData[3][2] = "minecraft:stone_brick_stairs[half=top,facing=west,shape=straight]";
        blueprintData[3][3] = "minecraft:air";
        blueprintData[4][0] = "minecraft:stone_brick_stairs[half=bottom,facing=west,shape=outer_right]";
        blueprintData[4][1] = "minecraft:air";
        blueprintData[4][2] = "minecraft:stone_brick_stairs[half=top,facing=west,shape=outer_right]";
        ...
        blueprintData[5][2] = "minecraft:stone_brick_stairs[half=top,facing=north,shape=straight]";
        blueprintData[5][3] = "minecraft:air";
        blueprintData[6][0] = "minecraft:stone_brick_stairs[half=bottom,facing=east,shape=outer_left]";
        blueprintData[6][1] = "minecraft:air";
        blueprintData[6][2] = "minecraft:stone_brick_stairs[half=top,facing=east,shape=outer_left]";
        ...
        stainedData[8][0] = "minecraft:oak_trapdoor[half=top,facing=west,open=false]";
        ...
        glassData[8][0] = "minecraft:oak_trapdoor[half=top,facing=west,open=false]";
