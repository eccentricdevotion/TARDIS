 ...
 * @author eccentric_nz
 */
public class TARDISTheEndPreset extends TARDISPreset {

    public TARDISTheEndPreset() {
        // set blueprint data strings
        String[][] blueprintData = new String[10][4];
        blueprintData[0][0] = "minecraft:obsidian";
        blueprintData[0][1] = "minecraft:obsidian";
        blueprintData[0][2] = "minecraft:obsidian";
        ...
        blueprintData[2][0] = "minecraft:obsidian";
        blueprintData[2][1] = "minecraft:obsidian";
        blueprintData[2][2] = "minecraft:obsidian";
        blueprintData[2][3] = "minecraft:air";
        blueprintData[3][0] = "minecraft:obsidian";
        blueprintData[3][1] = "minecraft:obsidian";
        blueprintData[3][2] = "minecraft:obsidian";
        blueprintData[3][3] = "minecraft:air";
        blueprintData[4][0] = "minecraft:obsidian";
        blueprintData[4][1] = "minecraft:obsidian";
        blueprintData[4][2] = "minecraft:obsidian";
        ...
        blueprintData[6][0] = "minecraft:obsidian";
        blueprintData[6][1] = "minecraft:obsidian";
        blueprintData[6][2] = "minecraft:obsidian";
        ...
        blueprintData[7][2] = "minecraft:obsidian";
        ...
        blueprintData[8][3] = "minecraft:bedrock";
        ...
        stainedData[8][3] = "minecraft:black_stained_glass";
