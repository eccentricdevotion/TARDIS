 ...
 * @author eccentric_nz
 */
public class DesertPreset extends TARDISPreset {
    ...
    public DesertPreset() {
        ...
        blueprintData[1][3] = "minecraft:sandstone_stairs[half=bottom,facing=south,shape=straight]";
        ...
        blueprintData[3][3] = "minecraft:sandstone_stairs[half=bottom,facing=west,shape=straight]";
        ...
        blueprintData[5][3] = "minecraft:sandstone_stairs[half=bottom,facing=north,shape=straight]";
        ...
        blueprintData[7][3] = "minecraft:sandstone_stairs[half=bottom,facing=east,shape=straight]";
        blueprintData[8][0] = "minecraft:air";
        blueprintData[8][1] = "minecraft:air";
        blueprintData[8][2] = "minecraft:sandstone";
        blueprintData[8][3] = "minecraft:sandstone";
        ...
        stainedData[0][0] = "minecraft:yellow_stained_glass";
        stainedData[0][1] = "minecraft:orange_stained_glass";
        stainedData[0][2] = "minecraft:yellow_stained_glass";
        stainedData[0][3] = "minecraft:yellow_stained_glass";
        stainedData[1][0] = "minecraft:orange_stained_glass";
        ...
        stainedData[2][0] = "minecraft:yellow_stained_glass";
        stainedData[2][1] = "minecraft:orange_stained_glass";
        stainedData[2][2] = "minecraft:yellow_stained_glass";
        stainedData[2][3] = "minecraft:yellow_stained_glass";
        stainedData[3][0] = "minecraft:orange_stained_glass";
        stainedData[3][1] = "minecraft:yellow_stained_glass";
        stainedData[3][2] = "minecraft:orange_stained_glass";
        stainedData[3][3] = "minecraft:yellow_stained_glass";
        stainedData[4][0] = "minecraft:yellow_stained_glass";
        stainedData[4][1] = "minecraft:orange_stained_glass";
        stainedData[4][2] = "minecraft:yellow_stained_glass";
        stainedData[4][3] = "minecraft:yellow_stained_glass";
        stainedData[5][0] = "minecraft:orange_stained_glass";
        stainedData[5][1] = "minecraft:yellow_stained_glass";
        stainedData[5][2] = "minecraft:orange_stained_glass";
        stainedData[5][3] = "minecraft:yellow_stained_glass";
        stainedData[6][0] = "minecraft:yellow_stained_glass";
        stainedData[6][1] = "minecraft:orange_stained_glass";
        stainedData[6][2] = "minecraft:yellow_stained_glass";
