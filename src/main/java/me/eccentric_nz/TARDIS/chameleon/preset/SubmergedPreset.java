 ...
 * @author eccentric_nz
 */
public class SubmergedPreset extends TARDISPreset {

    public SubmergedPreset() {
        // set blueprint data strings
        String[][] blueprintData = new String[10][4];
        blueprintData[0][0] = "minecraft:dirt";
        blueprintData[0][1] = "minecraft:grass_block";
        ...
        blueprintData[4][1] = "minecraft:grass_block";
        ...
        blueprintData[8][1] = "minecraft:black_wool";
        blueprintData[8][2] = "minecraft:grass_block";
        blueprintData[8][3] = "minecraft:air";
        blueprintData[9][0] = "minecraft:grass_block";
        ...
        stainedData[9][0] = "minecraft:green_stained_glass";
