 ...
 * @author eccentric_nz
 */
public class PineTreePreset extends TARDISPreset {

    public PineTreePreset() {
        ...
        blueprintData[2][0] = "minecraft:snow[layers=1]";
        blueprintData[2][1] = "minecraft:air";
        blueprintData[2][2] = "minecraft:air";
        blueprintData[2][3] = "minecraft:air";
        blueprintData[3][0] = "minecraft:oak_door[half=lower,hinge=left,facing=east,open=false]";
        blueprintData[3][1] = "minecraft:oak_door[half=upper,hinge=left,facing=east,open=false]";
        blueprintData[3][2] = "minecraft:spruce_leaves";
        blueprintData[3][3] = "minecraft:snow[layers=1]";
        blueprintData[4][0] = "minecraft:snow[layers=1]";
        ...
        blueprintData[6][0] = "minecraft:snow[layers=1]";
        ...
        blueprintData[8][0] = "minecraft:spruce_log[axis=y]";
        blueprintData[8][1] = "minecraft:spruce_log[axis=y]";
        ...
        stainedData[3][0] = "minecraft:oak_door[half=lower,hinge=left,facing=east,open=false]";
        stainedData[3][1] = "minecraft:oak_door[half=upper,hinge=left,facing=east,open=false]";
        ...
        glassData[3][0] = "minecraft:oak_door[half=lower,hinge=left,facing=east,open=false]";
        glassData[3][1] = "minecraft:oak_door[half=upper,hinge=left,facing=east,open=false]";
