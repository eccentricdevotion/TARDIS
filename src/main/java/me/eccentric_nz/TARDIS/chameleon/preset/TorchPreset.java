 ...
 * @author eccentric_nz
 */
public class TorchPreset extends TARDISPreset {
    ...
    public TorchPreset() {
        ...
        blueprintData[1][0] = "minecraft:stone_brick_stairs[facing=south,half=bottom,shape=straight,waterlogged=false]";
        blueprintData[1][1] = "minecraft:air";
        blueprintData[1][2] = "minecraft:stone_brick_stairs[facing=south,half=top,shape=straight,waterlogged=false]";
        blueprintData[1][3] = "minecraft:stone_brick_stairs[facing=north,half=bottom,shape=straight,waterlogged=false]";
        ...
        blueprintData[3][0] = "minecraft:stone_brick_stairs[facing=west,half=bottom,shape=straight,waterlogged=false]";
        blueprintData[3][1] = "minecraft:oak_trapdoor[facing=east,half=bottom,open=true,powered=false,waterlogged=false]";
        blueprintData[3][2] = "minecraft:stone_brick_stairs[facing=west,half=top,shape=straight,waterlogged=false]";
        blueprintData[3][3] = "minecraft:stone_brick_stairs[facing=east,half=bottom,shape=straight,waterlogged=false]";
        ...
        blueprintData[5][0] = "minecraft:stone_brick_stairs[facing=north,half=bottom,shape=straight,waterlogged=false]";
        blueprintData[5][1] = "minecraft:air";
        blueprintData[5][2] = "minecraft:stone_brick_stairs[facing=north,half=top,shape=straight,waterlogged=false]";
        blueprintData[5][3] = "minecraft:stone_brick_stairs[facing=south,half=bottom,shape=straight,waterlogged=false]";
        ...
        blueprintData[7][0] = "minecraft:stone_brick_stairs[facing=east,half=bottom,shape=straight,waterlogged=false]";
        blueprintData[7][1] = "minecraft:air";
        blueprintData[7][2] = "minecraft:stone_brick_stairs[facing=east,half=top,shape=straight,waterlogged=false]";
        blueprintData[7][3] = "minecraft:stone_brick_stairs[facing=west,half=bottom,shape=straight,waterlogged=false]";
        blueprintData[8][0] = "minecraft:stone_bricks";
        blueprintData[8][1] = "minecraft:stone_bricks";
        blueprintData[8][2] = "minecraft:stone_bricks";
        blueprintData[8][3] = "minecraft:netherrack";
        ...
        stainedData[3][1] = "minecraft:oak_trapdoor[facing=east,half=bottom,open=true,powered=false,waterlogged=false]";
        ...
        stainedData[8][1] = "minecraft:light_gray_stained_glass";
        ...
        glassData[3][1] = "minecraft:oak_trapdoor[facing=east,half=bottom,open=true,powered=false,waterlogged=false]";
