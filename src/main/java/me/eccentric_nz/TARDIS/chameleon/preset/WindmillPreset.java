...
public class WindmillPreset extends TARDISPreset {
    ...
    public WindmillPreset() {
        ...
        blueprintData[3][1] = "minecraft:white_wool";
        blueprintData[3][2] = "minecraft:spruce_planks";
        blueprintData[3][3] = "minecraft:white_wool";
        ...
        blueprintData[5][0] = "minecraft:orange_wool";
        blueprintData[5][1] = "minecraft:orange_wool";
        blueprintData[5][2] = "minecraft:air";
        blueprintData[5][3] = "minecraft:air";
        blueprintData[6][0] = "minecraft:orange_wool";
        blueprintData[6][1] = "minecraft:orange_wool";
        ...
        blueprintData[7][2] = "minecraft:orange_wool";
        blueprintData[7][3] = "minecraft:air";
        blueprintData[8][0] = "minecraft:orange_wool";
        blueprintData[8][1] = "minecraft:orange_wool";
        blueprintData[8][2] = "minecraft:orange_wool";
        ...
        stainedData[0][0] = "minecraft:orange_stained_glass";
        ...
        stainedData[5][1] = "minecraft:orange_stained_glass";
        stainedData[5][2] = "minecraft:air";
        stainedData[5][3] = "minecraft:air";
        stainedData[6][0] = "minecraft:orange_stained_glass";
        ...
        stainedData[7][2] = "minecraft:orange_stained_glass";
        stainedData[7][3] = "minecraft:air";
        stainedData[8][0] = "minecraft:orange_stained_glass";
        stainedData[8][1] = "minecraft:orange_stained_glass";
        stainedData[8][2] = "minecraft:orange_stained_glass";
