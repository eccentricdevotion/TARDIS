 ...
 * @author eccentric_nz
 */
public class ToiletPreset extends TARDISPreset {
    ...
    public ToiletPreset() {
        ...
        blueprintData[4][1] = "minecraft:lever[facing=south,powered=false]";
        ...
        blueprintData[8][0] = "minecraft:hopper[facing=down]";
        ...
        stainedData[4][1] = "minecraft:lever[facing=south,powered=false]";
        ...
        stainedData[8][0] = "minecraft:gray_stained_glass";
        ...
        glassData[4][1] = "minecraft:lever[facing=south,powered=false]";
