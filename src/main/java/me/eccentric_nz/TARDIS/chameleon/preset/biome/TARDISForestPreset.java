...
public class TARDISForestPreset extends TARDISPreset {
    ...
    public TARDISForestPreset() {
        ...
        blueprintData[0][2] = "minecraft:oak_leaves";
        blueprintData[0][3] = "minecraft:oak_leaves";
        blueprintData[1][0] = "minecraft:grass_block";
        blueprintData[1][1] = "minecraft:air";
        blueprintData[1][2] = "minecraft:oak_leaves";
        ...
        blueprintData[3][2] = "minecraft:birch_leaves";
        blueprintData[3][3] = "minecraft:air";
        blueprintData[4][0] = "minecraft:dirt";
        blueprintData[4][1] = "minecraft:birch_log[axis=y]";
        blueprintData[4][2] = "minecraft:birch_log[axis=y]";
        blueprintData[4][3] = "minecraft:birch_leaves";
        blueprintData[5][0] = "minecraft:grass_block";
        blueprintData[5][1] = "minecraft:air";
        blueprintData[5][2] = "minecraft:birch_leaves";
        ...
        stainedData[2][2] = "minecraft:green_stained_glass";
