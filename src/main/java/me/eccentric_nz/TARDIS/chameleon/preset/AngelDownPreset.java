 ...
 * @author eccentric_nz
 */
public class AngelDownPreset extends TARDISPreset {

    public AngelDownPreset() {
        ...
        blueprintData[1][1] = "minecraft:stone_brick_stairs[half=top,facing=south]";
        blueprintData[1][2] = "minecraft:stone_brick_stairs[half=top,facing=north]";
