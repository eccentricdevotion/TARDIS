 ...
 * @author eccentric_nz
 */
public class IcePlainsSpikesPreset extends TARDISPreset {

    public IcePlainsSpikesPreset() {
        // set blueprint data strings
        String[][] blueprintData = new String[10][4];
        blueprintData[0][0] = "minecraft:packed_ice";
        blueprintData[0][1] = "minecraft:packed_ice";
        blueprintData[0][2] = "minecraft:air";
        blueprintData[0][3] = "minecraft:air";
        blueprintData[1][0] = "minecraft:packed_ice";
        blueprintData[1][1] = "minecraft:packed_ice";
        blueprintData[1][2] = "minecraft:packed_ice";
        blueprintData[1][3] = "minecraft:air";
        blueprintData[2][0] = "minecraft:packed_ice";
        blueprintData[2][1] = "minecraft:packed_ice";
        blueprintData[2][2] = "minecraft:air";
        blueprintData[2][3] = "minecraft:air";
        blueprintData[3][0] = "minecraft:packed_ice";
        blueprintData[3][1] = "minecraft:packed_ice";
        blueprintData[3][2] = "minecraft:packed_ice";
        blueprintData[3][3] = "minecraft:air";
        blueprintData[4][0] = "minecraft:packed_ice";
        blueprintData[4][1] = "minecraft:packed_ice";
        blueprintData[4][2] = "minecraft:air";
        blueprintData[4][3] = "minecraft:air";
        blueprintData[5][0] = "minecraft:packed_ice";
        blueprintData[5][1] = "minecraft:packed_ice";
        blueprintData[5][2] = "minecraft:packed_ice";
        blueprintData[5][3] = "minecraft:air";
        blueprintData[6][0] = "minecraft:packed_ice";
        blueprintData[6][1] = "minecraft:packed_ice";
        blueprintData[6][2] = "minecraft:air";
        blueprintData[6][3] = "minecraft:air";
        blueprintData[7][0] = "minecraft:spruce_door[half=lower,hinge=right,facing=east,open=false]";
        blueprintData[7][1] = "minecraft:spruce_door[half=upper,hinge=right,facing=east,open=false]";
        blueprintData[7][2] = "minecraft:packed_ice";
        ...
        blueprintData[8][3] = "minecraft:packed_ice";
        ...
        stainedData[0][0] = "minecraft:light_blue_stained_glass";
        stainedData[0][1] = "minecraft:light_blue_stained_glass";
        stainedData[0][2] = "minecraft:air";
        stainedData[0][3] = "minecraft:air";
        stainedData[1][0] = "minecraft:light_blue_stained_glass";
        stainedData[1][1] = "minecraft:light_blue_stained_glass";
        stainedData[1][2] = "minecraft:light_blue_stained_glass";
        stainedData[1][3] = "minecraft:air";
        stainedData[2][0] = "minecraft:light_blue_stained_glass";
        stainedData[2][1] = "minecraft:light_blue_stained_glass";
        stainedData[2][2] = "minecraft:air";
        stainedData[2][3] = "minecraft:air";
        stainedData[3][0] = "minecraft:light_blue_stained_glass";
        stainedData[3][1] = "minecraft:light_blue_stained_glass";
        stainedData[3][2] = "minecraft:light_blue_stained_glass";
        stainedData[3][3] = "minecraft:air";
        stainedData[4][0] = "minecraft:light_blue_stained_glass";
        stainedData[4][1] = "minecraft:light_blue_stained_glass";
        stainedData[4][2] = "minecraft:air";
        stainedData[4][3] = "minecraft:air";
        stainedData[5][0] = "minecraft:light_blue_stained_glass";
        stainedData[5][1] = "minecraft:light_blue_stained_glass";
        stainedData[5][2] = "minecraft:light_blue_stained_glass";
        stainedData[5][3] = "minecraft:air";
        stainedData[6][0] = "minecraft:light_blue_stained_glass";
        stainedData[6][1] = "minecraft:light_blue_stained_glass";
        stainedData[6][2] = "minecraft:air";
        stainedData[6][3] = "minecraft:air";
        stainedData[7][0] = "minecraft:spruce_door[half=lower,hinge=right,facing=east,open=false]";
        stainedData[7][1] = "minecraft:spruce_door[half=upper,hinge=right,facing=east,open=false]";
        stainedData[7][2] = "minecraft:light_blue_stained_glass";
        stainedData[7][3] = "minecraft:air";
        stainedData[8][0] = "minecraft:air";
        stainedData[8][1] = "minecraft:air";
        stainedData[8][2] = "minecraft:air";
        stainedData[8][3] = "minecraft:light_blue_stained_glass";
        ...
        glassData[7][0] = "minecraft:spruce_door[half=lower,hinge=right,facing=east,open=false]";
        glassData[7][1] = "minecraft:spruce_door[half=upper,hinge=right,facing=east,open=false]";
