...
class TARDISTorchPreset extends TARDISPreset {
    ...
    TARDISTorchPreset() {
        ...
        blueprintData[1][3] = "minecraft:stone_brick_stairs[half=bottom,facing=south,shape=straight]";
        ...
        blueprintData[3][3] = "minecraft:stone_brick_stairs[half=bottom,facing=west,shape=straight]";
        blueprintData[4][0] = "minecraft:oak_trapdoor[half=bottom,facing=south,open=false]";
        ...
        blueprintData[5][3] = "minecraft:stone_brick_stairs[half=bottom,facing=north,shape=straight]";
        ...
        blueprintData[7][3] = "minecraft:stone_brick_stairs[half=bottom,facing=east,shape=straight]";
