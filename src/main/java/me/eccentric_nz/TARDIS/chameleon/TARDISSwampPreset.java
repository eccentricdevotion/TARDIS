 ...
 * @author eccentric_nz
 */
public class TARDISSwampPreset extends TARDISPreset {

    public TARDISSwampPreset() {
        // set blueprint data strings
        String[][] blueprintData = new String[10][4];
        blueprintData[0][0] = "minecraft:oak_log[axis=y]";
        blueprintData[0][1] = "minecraft:oak_log[axis=y]";
        blueprintData[0][2] = "minecraft:oak_log[axis=y]";
        blueprintData[0][3] = "minecraft:oak_stairs[facing=east,half=bottom,shape=outer_right,waterlogged=false]";
        blueprintData[1][0] = "minecraft:oak_slab[type=top,waterlogged=false]";
        blueprintData[1][1] = "minecraft:oak_planks";
        blueprintData[1][2] = "minecraft:oak_fence[east=true,north=false,south=false,waterlogged=false,west=true]";
        blueprintData[1][3] = "minecraft:oak_stairs[facing=south,half=bottom,shape=straight,waterlogged=false]";
        blueprintData[2][0] = "minecraft:oak_log[axis=y]";
        blueprintData[2][1] = "minecraft:oak_log[axis=y]";
        blueprintData[2][2] = "minecraft:oak_log[axis=y]";
        blueprintData[2][3] = "minecraft:oak_stairs[facing=west,half=bottom,shape=outer_left,waterlogged=false]";
        blueprintData[3][0] = "minecraft:oak_slab[type=top,waterlogged=false]";
        blueprintData[3][1] = "minecraft:oak_planks";
        blueprintData[3][2] = "minecraft:oak_fence[east=false,north=true,south=true,waterlogged=false,west=false]";
        blueprintData[3][3] = "minecraft:oak_stairs[facing=west,half=bottom,shape=straight,waterlogged=false]";
        blueprintData[4][0] = "minecraft:oak_log[axis=y]";
        blueprintData[4][1] = "minecraft:oak_log[axis=y]";
        blueprintData[4][2] = "minecraft:oak_log[axis=y]";
        blueprintData[4][3] = "minecraft:oak_stairs[facing=west,half=bottom,shape=outer_right,waterlogged=false]";
        blueprintData[5][0] = "minecraft:oak_slab[type=top,waterlogged=false]";
        blueprintData[5][1] = "minecraft:oak_planks";
        blueprintData[5][2] = "minecraft:oak_fence[east=true,north=false,south=false,waterlogged=false,west=true]";
        blueprintData[5][3] = "minecraft:oak_stairs[facing=north,half=bottom,shape=straight,waterlogged=false]";
        blueprintData[6][0] = "minecraft:oak_log[axis=y]";
        blueprintData[6][1] = "minecraft:oak_log[axis=y]";
        blueprintData[6][2] = "minecraft:oak_log[axis=y]";
        blueprintData[6][3] = "minecraft:oak_stairs[facing=east,half=bottom,shape=outer_left,waterlogged=false]";
        blueprintData[7][0] = "minecraft:oak_slab[type=top,waterlogged=false]";
        blueprintData[7][1] = "minecraft:oak_door[facing=west,half=lower,hinge=left,open=false,powered=false]";
        blueprintData[7][2] = "minecraft:oak_door[facing=west,half=upper,hinge=left,open=false,powered=false]";
        blueprintData[7][3] = "minecraft:oak_stairs[facing=east,half=bottom,shape=straight,waterlogged=false]";
        blueprintData[8][0] = "minecraft:oak_slab[type=top,waterlogged=false]";
        blueprintData[8][1] = "minecraft:air";
        blueprintData[8][2] = "minecraft:air";
        blueprintData[8][3] = "minecraft:oak_planks";
        ...
        stainedData[7][1] = "minecraft:oak_door[facing=west,half=lower,hinge=left,open=false,powered=false]";
        stainedData[7][2] = "minecraft:oak_door[facing=west,half=upper,hinge=left,open=false,powered=false]";
        ...
        glassData[7][1] = "minecraft:oak_door[facing=west,half=lower,hinge=left,open=false,powered=false]";
        glassData[7][2] = "minecraft:oak_door[facing=west,half=upper,hinge=left,open=false,powered=false]";
