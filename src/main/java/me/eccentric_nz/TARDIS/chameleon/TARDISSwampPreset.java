...
public class TARDISSwampPreset extends TARDISPreset {
    ...
    public TARDISSwampPreset() {
        ...
        blueprintData[1][0] = "minecraft:oak_slab[type=top]";
        blueprintData[1][1] = "minecraft:oak_planks";
        blueprintData[1][2] = "minecraft:oak_fence";
        ...
        blueprintData[3][0] = "minecraft:oak_slab[type=top]";
        blueprintData[3][1] = "minecraft:oak_planks";
        blueprintData[3][2] = "minecraft:oak_fence";
        ...
        blueprintData[5][0] = "minecraft:oak_slab[type=top]";
        blueprintData[5][1] = "minecraft:oak_planks";
        blueprintData[5][2] = "minecraft:oak_fence";
        ...
        blueprintData[7][0] = "minecraft:oak_planks";
        blueprintData[7][1] = "minecraft:oak_door[half=lower,hinge=right,facing=east,open=false]";
        blueprintData[7][2] = "minecraft:oak_door[half=upper,hinge=right,facing=east,open=false]";
        blueprintData[7][3] = "minecraft:oak_stairs[half=bottom,facing=east,shape=straight]";
        blueprintData[8][0] = "minecraft:oak_slab[type=top]";
        blueprintData[8][1] = "minecraft:air";
        blueprintData[8][2] = "minecraft:air";
        blueprintData[8][3] = "minecraft:oak_planks";
        blueprintData[9][0] = "minecraft:oak_slab[type=top]";
        blueprintData[9][1] = "minecraft:air";
        blueprintData[9][2] = "minecraft:air";
        blueprintData[9][3] = "minecraft:wall_sign[facing=east]";
        ...
        stainedData[7][0] = "minecraft:oak_planks";
        stainedData[7][1] = "minecraft:oak_door[half=lower,hinge=right,facing=east,open=false]";
        stainedData[7][2] = "minecraft:oak_door[half=upper,hinge=right,facing=east,open=false]";
        ...
        stainedData[9][3] = "minecraft:wall_sign[facing=east]";
        ...
        glassData[7][0] = "minecraft:oak_planks";
        glassData[7][1] = "minecraft:oak_door[half=upper,hinge=right,facing=east,open=false]";
        glassData[7][2] = "minecraft:oak_door[half=lower,hinge=right,facing=east,open=false]";
        ...
        glassData[9][3] = "minecraft:wall_sign[facing=east]";
