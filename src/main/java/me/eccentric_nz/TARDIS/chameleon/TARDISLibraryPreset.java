...
public class TARDISLibraryPreset extends TARDISPreset {
    ...
    public TARDISLibraryPreset() {
        ...
        blueprintData[7][3] = "minecraft:oak_slab[half=bottom]";
        ...
        blueprintData[8][3] = "minecraft:oak_slab[half=bottom]";
