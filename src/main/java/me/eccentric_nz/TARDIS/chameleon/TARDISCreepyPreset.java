...
public class TARDISCreepyPreset extends TARDISPreset {
    ...
    public TARDISCreepyPreset() {
        ...
        blueprintData[0][3] = "minecraft:nether_brick_slab[half=bottom]";
        blueprintData[1][0] = "minecraft:web";
        blueprintData[1][1] = "minecraft:web";
        blueprintData[1][2] = "minecraft:web";
        blueprintData[1][3] = "minecraft:nether_brick_slab[half=bottom]";
        ...
        blueprintData[2][3] = "minecraft:nether_brick_slab[half=bottom]";
        blueprintData[3][0] = "minecraft:web";
        blueprintData[3][1] = "minecraft:web";
        blueprintData[3][2] = "minecraft:web";
        blueprintData[3][3] = "minecraft:nether_brick_slab[half=bottom]";
        ...
        blueprintData[4][3] = "minecraft:nether_brick_slab[half=bottom]";
        blueprintData[5][0] = "minecraft:web";
        blueprintData[5][1] = "minecraft:web";
        blueprintData[5][2] = "minecraft:web";
        blueprintData[5][3] = "minecraft:nether_brick_slab[half=bottom]";
        ...
        blueprintData[6][3] = "minecraft:nether_brick_slab[half=bottom]";
        ...
        blueprintData[7][2] = "minecraft:web";
        blueprintData[7][3] = "minecraft:nether_brick_slab[half=bottom]";
