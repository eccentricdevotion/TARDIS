 ...
 * @author eccentric_nz
 */
public class TARDISGranitePreset extends TARDISPreset {
...
//    private final String glass_id = "[[20,20,20,20],[20,20,20,20],[20,20,20,20],[20,20,20,20],[20,20,20,20],[20,20,20,20],[20,20,20,20],[71,71,20,20],[0,0,20,124],[0,0,68,0]]";
    ...
    public TARDISGranitePreset() {
        // set blueprint data strings
        String[][] blueprintData = new String[10][4];
        blueprintData[0][0] = "minecraft:granite";
        blueprintData[0][1] = "minecraft:polished_granite";
        blueprintData[0][2] = "minecraft:granite";
        blueprintData[0][3] = "minecraft:cobblestone_slab";
        blueprintData[1][0] = "minecraft:granite";
        blueprintData[1][1] = "minecraft:polished_granite";
        blueprintData[1][2] = "minecraft:granite";
        blueprintData[1][3] = "minecraft:cobblestone_slab";
        blueprintData[2][0] = "minecraft:granite";
        blueprintData[2][1] = "minecraft:polished_granite";
        blueprintData[2][2] = "minecraft:granite";
        blueprintData[2][3] = "minecraft:cobblestone_slab";
        blueprintData[3][0] = "minecraft:granite";
        blueprintData[3][1] = "minecraft:polished_granite";
        blueprintData[3][2] = "minecraft:granite";
        blueprintData[3][3] = "minecraft:cobblestone_slab";
        blueprintData[4][0] = "minecraft:granite";
        blueprintData[4][1] = "minecraft:polished_granite";
        blueprintData[4][2] = "minecraft:granite";
        blueprintData[4][3] = "minecraft:cobblestone_slab";
        blueprintData[5][0] = "minecraft:granite";
        blueprintData[5][1] = "minecraft:polished_granite";
        blueprintData[5][2] = "minecraft:granite";
        blueprintData[5][3] = "minecraft:cobblestone_slab";
        blueprintData[6][0] = "minecraft:granite";
        blueprintData[6][1] = "minecraft:polished_granite";
        blueprintData[6][2] = "minecraft:granite";
        blueprintData[6][3] = "minecraft:cobblestone_slab";
        ...
        blueprintData[7][2] = "minecraft:granite";
        blueprintData[7][3] = "minecraft:cobblestone_slab";
