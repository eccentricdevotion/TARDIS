...
public class TARDISPunkedPreset extends TARDISPreset {
    ...
    public TARDISPunkedPreset() {
        ...
        blueprintData[0][0] = "minecraft:stone_slab[type=bottom]";
        blueprintData[0][1] = "minecraft:stone_slab[type=top]";
        ...
        blueprintData[2][0] = "minecraft:stone_slab[type=bottom]";
        blueprintData[2][1] = "minecraft:stone_slab[type=top]";
        ...
        blueprintData[4][0] = "minecraft:stone_slab[type=bottom]";
        blueprintData[4][1] = "minecraft:stone_slab[type=top]";
        ...
        blueprintData[6][0] = "minecraft:stone_slab[type=bottom]";
        ...
        blueprintData[8][2] = "minecraft:stone_slab[type=top]";
