...
public class TARDISPunkedPreset extends TARDISPreset {
    ...
    public TARDISPunkedPreset() {
        ...
        blueprintData[0][0] = "minecraft:stone_slab[half=bottom]";
        blueprintData[0][1] = "minecraft:stone_slab[half=top]";
        blueprintData[0][2] = "minecraft:oak_log[axis=y]";
        blueprintData[0][3] = "minecraft:oak_log[axis=y]";
        blueprintData[1][0] = "minecraft:piston[extended=true,facing=up,type=sticky]";
        blueprintData[1][1] = "minecraft:air";
        blueprintData[1][2] = "minecraft:coal_block";
        blueprintData[1][3] = "minecraft:stone_slab[half=bottom]";
        blueprintData[2][0] = "minecraft:stone_slab[half=bottom]";
        blueprintData[2][1] = "minecraft:stone_slab[half=top]";
        blueprintData[2][2] = "minecraft:oak_log[axis=y]";
        blueprintData[2][3] = "minecraft:oak_log[axis=y]";
        blueprintData[3][0] = "minecraft:piston[extended=true,facing=up,type=sticky]";
        blueprintData[3][1] = "minecraft:air";
        blueprintData[3][2] = "minecraft:coal_block";
        blueprintData[3][3] = "minecraft:stone_slab[half=bottom]";
        blueprintData[4][0] = "minecraft:stone_slab[half=bottom]";
        blueprintData[4][1] = "minecraft:stone_slab[half=top]";
        blueprintData[4][2] = "minecraft:oak_log[axis=y]";
        blueprintData[4][3] = "minecraft:oak_log[axis=y]";
        blueprintData[5][0] = "minecraft:piston[extended=true,facing=up,type=sticky]";
        blueprintData[5][1] = "minecraft:air";
        blueprintData[5][2] = "minecraft:coal_block";
        blueprintData[5][3] = "minecraft:stone_slab[half=bottom]";
        blueprintData[6][0] = "minecraft:stone_slab[half=bottom]";
        ...
        blueprintData[7][0] = "minecraft:piston[extended=true,facing=up,type=sticky]";
        blueprintData[7][1] = "minecraft:air";
        blueprintData[7][2] = "minecraft:coal_block";
        blueprintData[7][3] = "minecraft:oak_trapdoor[half=bottom,facing=east,open=false]";
        blueprintData[8][0] = "minecraft:redstone_block";
        blueprintData[8][1] = "minecraft:air";
        blueprintData[8][2] = "minecraft:stone_slab[half=top]";
        ...
        stainedData[7][3] = "minecraft:oak_trapdoor[half=bottom,facing=east,open=false]";
        ...
        glassData[7][3] = "minecraft:oak_trapdoor[half=bottom,facing=east,open=false]";
        glassData[8][0] = "minecraft:red_stained_glass";
