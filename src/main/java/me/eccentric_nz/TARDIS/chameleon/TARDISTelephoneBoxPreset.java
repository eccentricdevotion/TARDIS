 ...
 * @author eccentric_nz
 */
public class TARDISTelephoneBoxPreset extends TARDISPreset {

    public TARDISTelephoneBoxPreset() {
        // set blueprint data strings
        String[][] blueprintData = new String[10][4];
        blueprintData[0][0] = "minecraft:red_wool";
        blueprintData[0][1] = "minecraft:red_wool";
        blueprintData[0][2] = "minecraft:red_wool";
        blueprintData[0][3] = "minecraft:stone_slab";
        blueprintData[1][0] = "minecraft:red_wool";
        blueprintData[1][1] = "minecraft:glass";
        blueprintData[1][2] = "minecraft:red_wool";
        blueprintData[1][3] = "minecraft:stone_slab";
        blueprintData[2][0] = "minecraft:red_wool";
        blueprintData[2][1] = "minecraft:red_wool";
        blueprintData[2][2] = "minecraft:red_wool";
        blueprintData[2][3] = "minecraft:stone_slab";
        blueprintData[3][0] = "minecraft:red_wool";
        blueprintData[3][1] = "minecraft:glass";
        blueprintData[3][2] = "minecraft:red_wool";
        blueprintData[3][3] = "minecraft:stone_slab";
        blueprintData[4][0] = "minecraft:red_wool";
        blueprintData[4][1] = "minecraft:red_wool";
        blueprintData[4][2] = "minecraft:red_wool";
        blueprintData[4][3] = "minecraft:stone_slab";
        blueprintData[5][0] = "minecraft:red_wool";
        blueprintData[5][1] = "minecraft:glass";
        blueprintData[5][2] = "minecraft:red_wool";
        blueprintData[5][3] = "minecraft:stone_slab";
        blueprintData[6][0] = "minecraft:red_wool";
        blueprintData[6][1] = "minecraft:red_wool";
        blueprintData[6][2] = "minecraft:red_wool";
        blueprintData[6][3] = "minecraft:stone_slab";
        ...
        blueprintData[7][2] = "minecraft:red_wool";
        blueprintData[7][3] = "minecraft:stone_slab";
