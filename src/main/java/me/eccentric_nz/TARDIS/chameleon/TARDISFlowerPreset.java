 ...
 * @author eccentric_nz
 */
public class TARDISFlowerPreset extends TARDISPreset {
    ...
    public TARDISFlowerPreset() {
        ...
        blueprintData[1][3] = "minecraft:white_wool";
        ...
        blueprintData[5][3] = "minecraft:white_wool";
        ...
        blueprintData[7][0] = "minecraft:oak_door[half=lower,hinge=left,facing=west,open=false]";
        blueprintData[7][1] = "minecraft:oak_door[half=upper,hinge=left,facing=west,open=false]";
        blueprintData[7][2] = "minecraft:air";
        blueprintData[7][3] = "minecraft:white_wool";
        blueprintData[8][0] = "minecraft:green_wool";
        blueprintData[8][1] = "minecraft:green_wool";
        blueprintData[8][2] = "minecraft:green_wool";
