...
public class TARDISRenderPreset extends TARDISPreset {
    ...
    public TARDISRenderPreset() {
        ...
        blueprintData[7][0] = "minecraft:light_gray_stained_glass";
        blueprintData[7][1] = "minecraft:light_gray_stained_glass";
        ...
        blueprintData[8][2] = "minecraft:glass";
        ...
        stainedData[8][2] = "minecraft:glass";
        ...
        glassData[7][0] = "minecraft:light_gray_stained_glass";
        glassData[7][1] = "minecraft:light_gray_stained_glass";
