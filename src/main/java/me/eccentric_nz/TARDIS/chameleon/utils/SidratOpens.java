...
public class SidratOpens {
    ...
    private final NamespacedKey[] opening = new NamespacedKey[]{
            ChameleonVariant.SIDRAT_25.getKey(),
            ChameleonVariant.SIDRAT_50.getKey(),
            ChameleonVariant.SIDRAT_75.getKey(),
            ChameleonVariant.SIDRAT_OPEN.getKey()
    };
    private final NamespacedKey[] closing = new NamespacedKey[]{
            ChameleonVariant.SIDRAT_75.getKey(),
            ChameleonVariant.SIDRAT_50.getKey(),
            ChameleonVariant.SIDRAT_25.getKey(),
            ChameleonVariant.SIDRAT_CLOSED.getKey()
    };
