...
class TARDISPandoricaPreset extends TARDISPreset {
    ...
    TARDISPandoricaPreset() {
        ...
        blueprintData[0][1] = "minecraft:bedrock";
        blueprintData[0][2] = "minecraft:bedrock";
        blueprintData[0][3] = "minecraft:air";
        blueprintData[1][0] = "minecraft:bedrock";
        blueprintData[1][1] = "minecraft:bedrock";
        blueprintData[1][2] = "minecraft:bedrock";
        blueprintData[1][3] = "minecraft:air";
        blueprintData[2][0] = "minecraft:bedrock";
        blueprintData[2][1] = "minecraft:bedrock";
        blueprintData[2][2] = "minecraft:bedrock";
        blueprintData[2][3] = "minecraft:air";
        blueprintData[3][0] = "minecraft:bedrock";
        blueprintData[3][1] = "minecraft:bedrock";
        blueprintData[3][2] = "minecraft:bedrock";
        blueprintData[3][3] = "minecraft:air";
        blueprintData[4][0] = "minecraft:bedrock";
        blueprintData[4][1] = "minecraft:bedrock";
        blueprintData[4][2] = "minecraft:bedrock";
        blueprintData[4][3] = "minecraft:air";
        blueprintData[5][0] = "minecraft:bedrock";
        blueprintData[5][1] = "minecraft:bedrock";
        blueprintData[5][2] = "minecraft:bedrock";
        blueprintData[5][3] = "minecraft:air";
        blueprintData[6][0] = "minecraft:bedrock";
        blueprintData[6][1] = "minecraft:bedrock";
        blueprintData[6][2] = "minecraft:bedrock";
        blueprintData[6][3] = "minecraft:air";
        blueprintData[7][0] = "minecraft:bedrock";
        blueprintData[7][1] = "minecraft:bedrock";
        blueprintData[7][2] = "minecraft:bedrock";
        blueprintData[7][3] = "minecraft:air";
        blueprintData[8][0] = "minecraft:air";
        blueprintData[8][1] = "minecraft:air";
        blueprintData[8][2] = "minecraft:bedrock";
