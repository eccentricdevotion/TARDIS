...
public class TimeRotorHospitalRecipe {
    ...
    public void addRecipe() {
        ...
        im.setData(DataComponentTypes.CUSTOM_NAME, ComponentUtils.toWhite("Time Rotor Hospital"));
        im.setData(DataComponentTypes.ITEM_MODEL, RecipeItem.TIME_ROTOR_HOSPITAL.getModel());
        is.setItemMeta(im);
