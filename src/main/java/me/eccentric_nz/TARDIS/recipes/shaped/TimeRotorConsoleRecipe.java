...
public class TimeRotorConsoleRecipe {
    ...
    public void addRecipe() {
        ...
        is.setData(DataComponentTypes.CUSTOM_NAME, ComponentUtils.toWhite("Time Rotor Console"));
        is.setData(DataComponentTypes.ITEM_MODEL, RecipeItem.TIME_ROTOR_CONSOLE.getModel());
