    ...
    public void addDisplayItemRecipes() {
        for (TARDISDisplayItem tdi : TARDISDisplayItemRegistry.values()) {
            if (tdi.getCraftMaterial() != null) {
                ItemStack is;
                if (tdi == TARDISBlockDisplayItem.CLASSIC_DOOR || tdi == TARDISBlockDisplayItem.DINER_DOOR || tdi == TARDISBlockDisplayItem.BONE_DOOR || tdi == TARDISBlockDisplayItem.SIDRAT_DOOR) {
