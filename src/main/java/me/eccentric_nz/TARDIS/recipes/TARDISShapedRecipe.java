...
public class TARDISShapedRecipe {
    ...
    public void addShapedRecipes() {
        ...
        new ArtronCapacitorStorageRecipe(plugin).addRecipe();
        ...
        new ConsoleCustomRecipe(plugin).addRecipes();
        ...
        new SpaceSuitChestplateRecipe(plugin).addRecipe();
        new SpaceSuitLeggingsRecipe(plugin).addRecipe();
