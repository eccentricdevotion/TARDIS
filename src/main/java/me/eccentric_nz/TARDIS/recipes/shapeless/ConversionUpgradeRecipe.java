...
public class ConversionUpgradeRecipe {
    ...
    public void addRecipe() {
        ...
        is.setData(DataComponentTypes.CUSTOM_NAME, ComponentUtils.toWhite("Conversion Upgrade"));
        ...
        exact.setData(DataComponentTypes.CUSTOM_NAME, ComponentUtils.toWhite("Conversion Circuit"));
