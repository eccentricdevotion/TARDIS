...
public class DiamondUpgradeRecipe {
    ...
    public void addRecipe() {
        ...
        is.setData(DataComponentTypes.CUSTOM_NAME, ComponentUtils.toWhite("Diamond Upgrade"));
        ...
        exact.setData(DataComponentTypes.CUSTOM_NAME, ComponentUtils.toWhite("Diamond Disruptor Circuit"));
