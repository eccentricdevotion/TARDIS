...
public class KnockbackUpgradeRecipe {
    ...
    public void addRecipe() {
        ...
        is.setData(DataComponentTypes.CUSTOM_NAME, ComponentUtils.toWhite("Knockback Upgrade"));
        ...
        exact.setData(DataComponentTypes.CUSTOM_NAME, ComponentUtils.toWhite("Knockback Circuit"));
