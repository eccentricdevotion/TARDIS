...
public class KnockbackUpgradeRecipe {
    ...
    public void addRecipe() {
        ...
        im.setDisplayName(NamedTextColor.WHITE + "Knockback Upgrade");
        im.setItemModel(RecipeItem.KNOCKBACK_UPGRADE.getModel());
        is.setItemMeta(im);
        ...
        em.setDisplayName(NamedTextColor.WHITE + "Knockback Circuit");
        em.setItemModel(RecipeItem.KNOCKBACK_CIRCUIT.getModel());
