...
public class IgniteUpgradeRecipe {
    ...
    public void addRecipe() {
        ...
        im.setData(DataComponentTypes.CUSTOM_NAME, ComponentUtils.toWhite("Ignite Upgrade"));
        ...
        em.setData(DataComponentTypes.CUSTOM_NAME, ComponentUtils.toWhite("Ignite Circuit"));
