...
public class BioscannerUpgradeRecipe {
    ...
    public void addRecipe() {
        ...
        is.setData(DataComponentTypes.CUSTOM_NAME, ComponentUtils.toWhite("Bio-scanner Upgrade"));
        ...
        exact.setData(DataComponentTypes.CUSTOM_NAME, ComponentUtils.toWhite("Bio-scanner Circuit"));
