...
public class PainterUpgradeRecipe {
    ...
    public void addRecipe() {
        ...
        im.setData(DataComponentTypes.CUSTOM_NAME, ComponentUtils.toWhite("Painter Upgrade"));
        ...
        em.setData(DataComponentTypes.CUSTOM_NAME, ComponentUtils.toWhite("Painter Circuit"));
