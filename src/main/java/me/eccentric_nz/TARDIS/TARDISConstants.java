...
public class TARDISConstants {
    ...
    public enum ROOM {
        ...
        POOL, LIBRARY, KITCHEN, VAULT, ARBORETUM, BEDROOM, PASSAGE;
    }

    public enum CMDS {

        CREATE, DELETE, TIMETRAVEL, LIST, REMOVESAVE, SAVE, FIND, ADD, ADMIN, UPDATE, TRAVEL, REBUILD, CHAMELEON, SFX, PLATFORM, SETDEST, HOME, HIDE, AREA, VERSION;
    }
