...
public class TARDISConstants {
    ...
    public enum SCHEMATIC {
        ...
        ANTIGRAVITY, ARBORETUM, ARS, BAKER, BEDROOM, BIGGER, BUDGET, CROSS, CUSTOM, DELUXE, ELEVENTH, EMPTY, FARM, GRAVITY, GREENHOUSE, HARMONY, KITCHEN, LIBRARY, LONG, MUSHROOM, PASSAGE, PLANK, POOL, RAIL, REDSTONE, STABLE, STEAMPUNK, TOM, VAULT, VILLAGE, WOOD, WORKSHOP;
    }
    ...
    public enum ROOM {
        ...
        ANTIGRAVITY, ARBORETUM, BAKER, BEDROOM, CROSS, EMPTY, FARM, GRAVITY, GREENHOUSE, HARMONY, KITCHEN, LIBRARY, LONG, MUSHROOM, PASSAGE, POOL, RAIL, STABLE, VAULT, VILLAGE, WOOD, WORKSHOP;
    }
