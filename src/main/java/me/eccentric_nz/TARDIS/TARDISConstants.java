...
public class TARDISConstants {
    ...
    public enum PRESET {
        ...
        ANGEL, APPERTURE, CAKE, CANDY, CHALICE, CREEPY, DESERT, DUCK, FACTORY, FENCE, FLOWER, GAZEBO, GRAVESTONE, HELIX, JAIL, JUNGLE, LAMP, LIBRARY, LIGHTHOUSE, MINESHAFT, NETHER, NEW, OLD, PANDORICA, PARTY, PEANUT, PINE, PORTAL, PUNKED, ROBOT, SHROOM, SNOWMAN, STONE, SUBMERGED, SWAMP, TELEPHONE, THEEND, TOILET, TOPSYTURVEY, TORCH, VILLAGE, WELL, WINDMILL, YELLOW, CUSTOM
    }
