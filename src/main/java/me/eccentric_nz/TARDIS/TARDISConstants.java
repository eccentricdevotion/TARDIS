...
public class TARDISConstants {
    ...
    public static final List<Integer> PROBLEM_BLOCKS = Arrays.asList(new Integer[]{17, 53, 54, 61, 65, 67, 68, 77, 93, 99, 100, 108, 109, 114, 127, 128, 134, 135, 136, 143, 149, 150, 155, 156, 170, -86, -100, -101, -106, -107, -113, -120, -121, -122});
    // messages
    ...
    public enum SCHEMATIC {
        ...
        ANTIGRAVITY, ARBORETUM, BAKER, BEDROOM, BIGGER, BUDGET, CROSS, DELUXE, ELEVENTH, EMPTY, FARM, GRAVITY, GREENHOUSE, HARMONY, KITCHEN, LIBRARY, LONG, MUSHROOM, PASSAGE, POOL, REDSTONE, STEAMPUNK, VAULT, WOOD, WORKSHOP;
    }
