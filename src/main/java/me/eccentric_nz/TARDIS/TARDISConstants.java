...
public class TARDISConstants {
    ...
    public static final String SCHEMATIC_FIRST = "first.schematic";
    ...
    public enum SCHEMATIC {
        ...
        BUDGET, BIGGER, DELUXE, ELEVENTH, ARBORETUM, BEDROOM, KITCHEN, LIBRARY, PASSAGE, POOL, VAULT, WORKSHOP, EMPTY, GRAVITY, HARMONY, FIRST, BAKER, WOOD;
    }
    ...
    public static final List<Integer> PROBLEM_BLOCKS = Arrays.asList(new Integer[]{53, 54, 61, 65, 67, 68, 77, 93, 108, 109, 114, 128, 134, 135, 136, 143, -113, -120, -121, -122});
    // messages
    ...
    public enum ROOM {
        ...
        ARBORETUM, BEDROOM, KITCHEN, LIBRARY, PASSAGE, POOL, VAULT, WORKSHOP, EMPTY, GRAVITY, HARMONY, FIRST, BAKER, WOOD;
    }
    ...
    public static final String COMMAND_BIND = "Binding saved locations to blocks\nTo bind a saved location, the home location or set a block to hide or rebuild the TARDIS Police Box, use the " + ChatColor.GOLD + "/tardis bind [what_to_bind]" + ChatColor.RESET + " command .\nFirst place the block where you want it to be, then type the command.\nYou will be asked to click the block so that the TARDIS matrix knows of its location.\nTo bind a saved location, use the saved destination name (as it appears in the /tardis list saves command) as the second argument.\nOtherwise use either 'hide', 'rebuild' or 'home'.";
