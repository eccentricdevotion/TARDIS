...
public class TARDISConstants {
     ...
     */
    public static final Set<String> COLOURS = Set.of("console_war", "console_netherite", "console_rustic", "console_brown", "console_pink", "console_magenta",
    ...
    public static final List<EntityType> ENTITY_TYPES = List.of(
            ...
            EntityType.HAPPY_GHAST, EntityType.HOGLIN, EntityType.HORSE, EntityType.HUSK, EntityType.ILLUSIONER, EntityType.IRON_GOLEM, EntityType.LLAMA,
    ...
    /**
     * A list of materials used in modelled Armour Stand Chameleon presets
     */
    public static final List<Material> HAS_MODEL = List.of(
