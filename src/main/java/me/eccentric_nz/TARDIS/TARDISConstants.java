...
public class TARDISConstants {
    ...
    //public static final List<Material> GUI_ITEMS = Arrays.asList(Material.SAPLING, Material.YELLOW_FLOWER, Material.RED_ROSE, Material.BROWN_MUSHROOM, Material.RED_MUSHROOM, Material.TORCH, Material.APPLE, Material.ARROW, Material.GOLD_INGOT, Material.STICK, Material.BOWL, Material.STRING, Material.FEATHER, Material.SULPHUR, Material.SEEDS, Material.BREAD, Material.ANVIL, Material.FLINT, Material.PORK, Material.PAINTING, Material.GOLDEN_APPLE, Material.SIGN, Material.BUCKET, Material.MINECART, Material.SADDLE, Material.REDSTONE, Material.SNOW_BALL, Material.LEATHER, Material.BRICK, Material.CLAY_BALL, Material.SUGAR_CANE, Material.PAPER, Material.BOOK, Material.SLIME_BALL, Material.EGG, Material.COMPASS, Material.WATCH, Material.GLOWSTONE_DUST, Material.RAW_FISH, Material.BONE, Material.SUGAR, Material.CAKE, Material.BED, Material.DIODE, Material.COOKIE, Material.SHEARS, Material.MELON, Material.COOKED_BEEF, Material.RAW_CHICKEN, Material.BLAZE_ROD, Material.GHAST_TEAR, Material.NETHER_WARTS, Material.GLASS_BOTTLE, Material.SPIDER_EYE, Material.MAGMA_CREAM, Material.EYE_OF_ENDER, Material.EMERALD, Material.FLOWER_POT_ITEM, Material.CARROT_ITEM, Material.POTATO_ITEM, Material.NETHER_STAR, Material.PUMPKIN_PIE);
    // underdoor blocks
