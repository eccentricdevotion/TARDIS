...
public class TARDISConstants {
    ...
    public enum PRESET {
        ...
        NEW, OLD, FACTORY, STONE, DESERT, JUNGLE, NETHER, SWAMP, PARTY, VILLAGE, YELLOW, TELEPHONE, SUBMERGED, RAISED, FLOWER, CHALICE, WINDMILL, WELL, CAKE, GRAVESTONE, TOPSYTURVEY, SHROOM, CUSTOM
    }
