...
public class TARDISConstants {
    ...
    // chameleon blocks
    public static final List<Integer> CHAMELEON_BLOCKS_VALID = Arrays.asList(new Integer[]{1, 3, 4, 5, 7, 14, 15, 16, 17, 18, 19, 20, 21, 22, 24, 25, 35, 41, 42, 43, 45, 46, 47, 48, 49, 56, 57, 58, 73, 74, 79, 80, 82, 84, 86, 87, 88, 89, 91, 98, 99, 100, 103, 110, 112, 121, 123, 124, 129, 133, 155});
    ...
    public static final List<Integer> CHAMELEON_BLOCKS_PRECIOUS = Arrays.asList(new Integer[]{41, 42, 46, 57, 133, 152});
    // problem blocks for schematics
    public static final List<Integer> PROBLEM_BLOCKS = Arrays.asList(new Integer[]{53, 54, 61, 65, 67, 68, 77, 93, 99, 100, 108, 109, 114, 127, 128, 134, 135, 136, 143, 149, 150, 156, -100, -106, -107, -113, -120, -121, -122});
    // messages
