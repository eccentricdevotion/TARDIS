...
public class TARDISConstants {
    ...
    public static final List<Integer> PROBLEM_BLOCKS = Arrays.asList(new Integer[]{53, 54, 61, 65, 67, 68, 77, 93, 99, 100, 108, 109, 114, 127, 128, 134, 135, 136, 143, 156, -100, -113, -120, -121, -122});
    // messages
