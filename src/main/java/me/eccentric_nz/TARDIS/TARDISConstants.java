...
public class TARDISConstants {
    ...
    public static final String SCHEMATIC_RENDERER = "renderer.schematic";
    ...
    public enum SCHEMATIC {
        ...
        ANTIGRAVITY, ARBORETUM, ARS, BAKER, BEDROOM, BIGGER, BUDGET, CUSTOM, DELUXE, ELEVENTH, EMPTY, FARM, GRAVITY, GREENHOUSE, HARMONY, KITCHEN, LIBRARY, MUSHROOM, PASSAGE, PLANK, POOL, RAIL, REDSTONE, RENDERER, STABLE, STEAMPUNK, TOM, TRENZALORE, VAULT, VILLAGE, WOOD, WORKSHOP;
    }
    ...
    public enum ROOM {
        ...
        ANTIGRAVITY, ARBORETUM, BAKER, BEDROOM, EMPTY, FARM, GRAVITY, GREENHOUSE, HARMONY, KITCHEN, LIBRARY, MUSHROOM, PASSAGE, POOL, RAIL, RENDERER, STABLE, TRENZALORE, VAULT, VILLAGE, WOOD, WORKSHOP;
    }
    ...
    public enum PRESET {
        ...
        ANGEL, APPERTURE, CAKE, CANDY, CHALICE, CREEPY, DESERT, DUCK, FACTORY, FENCE, FLOWER, GAZEBO, GRAVESTONE, HELIX, JAIL, JUNGLE, LAMP, LIBRARY, LIGHTHOUSE, MINESHAFT, NETHER, NEW, OLD, PANDORICA, PARTY, PEANUT, PINE, PORTAL, PUNKED, RENDER, ROBOT, SHROOM, SNOWMAN, STONE, SUBMERGED, SWAMP, TELEPHONE, THEEND, TOILET, TOPSYTURVEY, TORCH, VILLAGE, WELL, WINDMILL, YELLOW, CUSTOM
    }
