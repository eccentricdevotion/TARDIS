...
public class LazarusChoiceListener extends TARDISMenuListener {
    ...
    public void onLazarusClick(InventoryClickEvent event) {
        ...
        switch (slot) {
            ...
            case 1 -> {
                ...
                ih = new LazarusPassiveInventory(plugin);
                player.openInventory(ih.getInventory());
            }
            // neutral
            case 3 -> {
                LazarusUtils.pagers.add(uuid);
                ih = new LazarusNeutralInventory(plugin);
                player.openInventory(ih.getInventory());
            }
            // hostile
            case 5 -> {
                LazarusUtils.pagers.add(uuid);
                ih = new LazarusHostileInventory(plugin);
                player.openInventory(ih.getInventory());
            }
            // hostile adjacent
            case 7 -> {
                LazarusUtils.pagers.add(uuid);
                ih = new LazarusAdjacentInventory(plugin);
                player.openInventory(ih.getInventory());
            }
            // doctors
            case 9 -> {
                LazarusUtils.pagers.add(uuid);
                ih = new LazarusDoctorInventory(plugin);
                player.openInventory(ih.getInventory());
            }
            // companions
            case 11 -> {
                LazarusUtils.pagers.add(uuid);
                ih = new LazarusCompanionInventory(plugin);
                player.openInventory(ih.getInventory());
            }
            // characters
            case 13 -> {
                LazarusUtils.pagers.add(uuid);
                ih = new LazarusCharacterInventory(plugin);
                player.openInventory(ih.getInventory());
            }
            // twa monsters
            case 15 -> {
                LazarusUtils.pagers.add(uuid);
                ih = new LazarusMonstersInventory(plugin);
                player.openInventory(ih.getInventory());
            }
    ...
    public void onLazarusClose(InventoryCloseEvent event) {
        ...
        InventoryHolder holder = event.getInventory().getHolder(false);
        if ((holder instanceof LazarusInventory
                || holder instanceof LazarusPassiveInventory
                ...
                || holder instanceof LazarusDoctorInventory
