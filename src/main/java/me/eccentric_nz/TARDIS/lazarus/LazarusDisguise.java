...
public class LazarusDisguise {
    ...
    public LazarusDisguise(TARDIS plugin, Player player, EntityType entityType, Object[] options) {
        this.plugin = plugin;
        this.player = player;
    ...
    public void createDisguise() {
        ...
        if (entityType.equals(EntityType.PLAYER)) {
            plugin.getSkinChanger().set(player, ArchSkins.HEROBRINE);
        } else {
