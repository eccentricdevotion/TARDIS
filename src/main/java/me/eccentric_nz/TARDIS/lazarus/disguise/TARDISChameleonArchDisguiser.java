...
public class TARDISChameleonArchDisguiser {
    ...
    public void changeSkin(String name) {
        ...
        // get a random skin
        String random = ArchSkins.DEFAULTS.get(TARDISConstants.RANDOM.nextInt(ArchSkins.DEFAULTS.size()));
        // set skin
        if (PaperLib.isPaper()) {
            SkinChangerPaper.set(player, random);
        } else {
            SkinChangerSpigot.set(player, random);
        }
    }
