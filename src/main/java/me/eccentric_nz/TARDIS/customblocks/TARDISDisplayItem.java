...
public enum TARDISDisplayItem {
    ...
    LIGHT_ELEVENTH_1(10007, Material.GRAY_WOOL, true),
    LIGHT_ELEVENTH_2(10008, Material.GRAY_WOOL, true),
    LIGHT_TWELFTH(10009, Material.GRAY_WOOL, true),
    LIGHT_THIRTEENTH(10010, Material.GRAY_WOOL, true),
    ...
    LIGHT_ELEVENTH_1_ON(10007, Material.REDSTONE_LAMP, true, true),
