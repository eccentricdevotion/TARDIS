...
public enum EnchantmentShelf {
    ...
    UNBREAKING(Enchantment.DURABILITY, "Unbreaking", 3, EnchantmentCategory.ALL_PURPOSE, new Vector(5, 3, 2), BlockFace.SOUTH),
    // armour
    AQUA_AFFINITY(Enchantment.WATER_WORKER, "Aqua Affinity", 1, EnchantmentCategory.ARMOUR, new Vector(6, 3, 2), BlockFace.SOUTH),
    BLAST_PROTECTION(Enchantment.PROTECTION_EXPLOSIONS, "Blast Protection", 4, EnchantmentCategory.ARMOUR, new Vector(7, 3, 2), BlockFace.SOUTH),
    ...
    FEATHER_FALLING(Enchantment.PROTECTION_FALL, "Feather Falling", 4, EnchantmentCategory.ARMOUR, new Vector(11, 3, 2), BlockFace.SOUTH),
    FIRE_PROTECTION(Enchantment.PROTECTION_FIRE, "Fire Protection", 4, EnchantmentCategory.ARMOUR, new Vector(12, 3, 2), BlockFace.SOUTH),
    FROST_WALKER(Enchantment.FROST_WALKER, "Frost Walker", 2, EnchantmentCategory.ARMOUR, new Vector(13, 3, 2), BlockFace.SOUTH),
    // left
    PROJECTILE_PROTECTION(Enchantment.PROTECTION_PROJECTILE, "Projectile Protection", 4, EnchantmentCategory.ARMOUR, new Vector(14, 3, 3), BlockFace.WEST),
    PROTECTION(Enchantment.PROTECTION_ENVIRONMENTAL, "Protection", 4, EnchantmentCategory.ARMOUR, new Vector(14, 3, 4), BlockFace.WEST),
    RESPIRATION(Enchantment.OXYGEN, "Respiration", 3, EnchantmentCategory.ARMOUR, new Vector(14, 3, 5), BlockFace.WEST),
    ...
    // melee weapons
    BANE_OF_ARTHROPODS(Enchantment.DAMAGE_ARTHROPODS, "Bane of Arthropods", 5, EnchantmentCategory.MELEE_WEAPONS, new Vector(14, 3, 11), BlockFace.WEST),
    EFFICIENCY(Enchantment.DIG_SPEED, "Efficiency", 5, EnchantmentCategory.MELEE_WEAPONS, new Vector(14, 3, 12), BlockFace.WEST),
    ...
    LOOTING(Enchantment.LOOT_BONUS_MOBS, "Looting", 3, EnchantmentCategory.MELEE_WEAPONS, new Vector(11, 3, 14), BlockFace.NORTH),
    SHARPNESS(Enchantment.DAMAGE_ALL, "Sharpness", 5, EnchantmentCategory.MELEE_WEAPONS, new Vector(10, 3, 14), BlockFace.NORTH),
    SMITE(Enchantment.DAMAGE_UNDEAD, "Smite", 5, EnchantmentCategory.MELEE_WEAPONS, new Vector(9, 3, 14), BlockFace.NORTH),
    ...
    FLAME(Enchantment.ARROW_FIRE, "Flame", 1, EnchantmentCategory.RANGED_WEAPONS, new Vector(5, 3, 14), BlockFace.NORTH),
    INFINITY(Enchantment.ARROW_INFINITE, "Infinity", 1, EnchantmentCategory.RANGED_WEAPONS, new Vector(4, 3, 14), BlockFace.NORTH),
    ...
    POWER(Enchantment.ARROW_DAMAGE, "Power", 5, EnchantmentCategory.RANGED_WEAPONS, new Vector(2, 3, 11), BlockFace.EAST),
    PUNCH(Enchantment.ARROW_KNOCKBACK, "Punch", 2, EnchantmentCategory.RANGED_WEAPONS, new Vector(2, 3, 10), BlockFace.EAST),
    QUICK_CHARGE(Enchantment.QUICK_CHARGE, "Quick Charge", 3, EnchantmentCategory.RANGED_WEAPONS, new Vector(2, 3, 9), BlockFace.EAST),
    // tools
    FORTUNE(Enchantment.LOOT_BONUS_BLOCKS, "Fortune", 3, EnchantmentCategory.TOOLS, new Vector(2, 3, 7), BlockFace.EAST),
    LUCK_OF_THE_SEA(Enchantment.LUCK, "Luck of the Sea", 3, EnchantmentCategory.TOOLS, new Vector(2, 3, 6), BlockFace.EAST),
