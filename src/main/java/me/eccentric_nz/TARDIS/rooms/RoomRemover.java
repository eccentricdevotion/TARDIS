...
class RoomRemover {
    ...
    RoomRemover(TARDIS plugin, String r, Location l, COMPASS d, int id) {
        this.plugin = plugin;
        this.r = r;
        this.l = l;
        this.d = d;
    ...
    public boolean remove() {
        ...
        // get JSON
        JsonObject obj = SchematicGZip.getObject(plugin, "rooms", r.toLowerCase(Locale.ROOT), plugin.getRoomsConfig().getBoolean("rooms." + r + ".user"));
        if (obj == null) {
            return false;
        }
        // get dimensions
