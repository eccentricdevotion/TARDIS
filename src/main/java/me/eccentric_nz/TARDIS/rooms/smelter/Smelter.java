    ...
    static boolean isSmeltable(Material material) {
        return switch (material) {
            case ACACIA_LOG, ACACIA_WOOD,
                    BAMBOO_BLOCK, BAMBOO_MOSAIC, BAMBOO_PLANKS,
                    BASALT, BEEF, BIRCH_LOG, BIRCH_WOOD, BLACK_TERRACOTTA, BLUE_TERRACOTTA, BROWN_TERRACOTTA,
                    CACTUS, CHERRY_LOG, CHERRY_WOOD, CHICKEN, CHORUS_FRUIT, CLAY, CLAY_BALL, COBBLED_DEEPSLATE, COBBLESTONE, COD,
                    COPPER_ORE, CYAN_TERRACOTTA, DARK_OAK_LOG, DARK_OAK_WOOD, DEEPSLATE_COPPER_ORE, DEEPSLATE_GOLD_ORE, DEEPSLATE_IRON_ORE,
                    ...
                    STRIPPED_CHERRY_WOOD, STRIPPED_DARK_OAK_LOG, STRIPPED_DARK_OAK_WOOD, STRIPPED_JUNGLE_LOG, STRIPPED_JUNGLE_WOOD, STRIPPED_MANGROVE_LOG,
                    STRIPPED_MANGROVE_WOOD, STRIPPED_OAK_LOG, STRIPPED_OAK_WOOD, STRIPPED_SPRUCE_LOG, STRIPPED_SPRUCE_WOOD,
