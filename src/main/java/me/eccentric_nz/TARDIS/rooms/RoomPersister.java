...
public class RoomPersister {
    ...
    public RoomPersister(TARDIS plugin) {
        this.plugin = plugin;
    ...
    public void saveProgress() {
        try {
            ...
            for (RoomData rd : plugin.getTrackerKeeper().getRoomTasks().values()) {
                ...
                while (rs.next()) {
                    ...
                    if (obj != null) {
                        ...
                        if (rst.fromID(id)) {
                            ...
                            RoomRunnable runnable = new RoomRunnable(plugin, rd, rst.getUuid());
