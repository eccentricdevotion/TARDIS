                ...
                if (obj.has("paintings")) {
                    ...
                    for (int i = 0; i < paintings.size(); i++) {
                        ...
                        if (which.contains(":")) {
                            ...
                            art = artRegistry.get(new NamespacedKey("minecraft", which.toLowerCase(Locale.ROOT)));
                            if (art != null) {
                                pl = TARDISPainting.calculatePosition(which.toLowerCase(Locale.ROOT), facing, new Location(world, resetx + px, resety + py, resetz + pz));
                            }
                        }
                        if (pl != null) {
                            try {
