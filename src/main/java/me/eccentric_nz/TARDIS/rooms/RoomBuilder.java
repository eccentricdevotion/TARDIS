...
public class RoomBuilder {
    ...
    public RoomBuilder(TARDIS plugin, String room, Location location, COMPASS direction, Player player) {
        this.plugin = plugin;
        this.room = room;
    ...
    public boolean build() {
        ...
        if (rs.fromUUID(player.getUniqueId().toString())) {
            ...
            // get JSON
            JsonObject obj = SchematicGZip.getObject(plugin, "rooms", room.toLowerCase(Locale.ROOT), plugin.getRoomsConfig().getBoolean("rooms." + room + ".user"));
            if (obj == null) {
                return false;
            }
