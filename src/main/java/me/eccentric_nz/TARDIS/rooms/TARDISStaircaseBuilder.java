 ...
 * @author eccentric_nz
 */
public class TARDISStaircaseBuilder {
    ...
    public TARDISStaircaseBuilder(TARDIS plugin, Location location, Player player, boolean isUp) {
        this.plugin = plugin;
    ...
    public boolean build() {
        ...
        if (rs.fromUUID(player.getUniqueId().toString())) {
            ...
            // get JSON
            JsonObject obj = TARDISSchematicGZip.getObject(plugin, "rooms", "staircase", false);
            if (obj == null) {
                return false;
            }
