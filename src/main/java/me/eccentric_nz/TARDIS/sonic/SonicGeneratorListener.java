 ...
 * @author eccentric_nz
 */
public class SonicGeneratorListener implements Listener {

    private final TARDIS plugin;

    public SonicGeneratorListener(TARDIS plugin) {
        this.plugin = plugin;
    }
            ...
            if (rss.resultSet()) {
                ...
                if (s.isActivated()) {
                    if (player.isSneaking()) {
                        ...
                        // open GUI
                        player.openInventory(new SonicGeneratorInventory(plugin, s).getInventory());
                    }
                } else {
                    openActivate(player);
                }
    ...
    private void openActivate(Player p) {
        p.openInventory(new SonicActivatorInventory(plugin).getInventory());
    }
