...
public class SonicLore {
    ...
    public static void setChargeLevel(ItemStack sonic) {
        PersistentDataContainerView pdc = sonic.getPersistentDataContainer();
    ...
    public static ItemStack addUpgrade(List<Component> lore, String dn, List<Float> floats, ItemStack result, String upgrade) {
        ...
        result.setData(DataComponentTypes.CUSTOM_NAME, Component.text(dn));
        result.setData(DataComponentTypes.CUSTOM_MODEL_DATA, CustomModelData.customModelData()
                .addFloats(floats)
                .build());
