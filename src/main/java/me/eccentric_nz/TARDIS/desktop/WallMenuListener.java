 ...
 * @author eccentric_nz
 */
public class WallMenuListener extends WallListener {
    ...
    public void onWallMenuClick(InventoryClickEvent event) {
        ...
        if (!(holder instanceof WallsInventory walls)) {
            return;
        }
    ...
    private void floor(Player p) {
        plugin.getServer().getScheduler().scheduleSyncDelayedTask(plugin, () ->
                p.openInventory(new WallsInventory(plugin, "TARDIS Floor Menu").getInventory()), 1L);
    }
}
