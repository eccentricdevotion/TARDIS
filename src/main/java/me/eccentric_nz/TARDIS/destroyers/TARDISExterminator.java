...
public class TARDISExterminator {
    ...
    public void cleanDatabase(int id) {
        ...
        List<String> tables = Arrays.asList("ars", "back", "blocks", "chameleon", "chunks", "condenser", "controls", "current", "destinations", "doors", "farming", "gravity_well", "homes", "junk", "lamps", "next", "tardis", "thevoid", "travellers", "vaults");
