 ...
 * @author eccentric_nz
 */
public class ArchRespawnListener implements Listener {

    private final TARDIS plugin;

    public ArchRespawnListener(TARDIS plugin) {
        this.plugin = plugin;
    }
    ...
    public void onArchedRespawn(PlayerRespawnEvent event) {
        ...
        plugin.getServer().getScheduler().scheduleSyncDelayedTask(plugin, () -> new ArchPersister(plugin).reArch(uuid), 5L);
