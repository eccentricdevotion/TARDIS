 ...
 * @author eccentric_nz
 */
public class ArchFakeChatListener implements Listener {

    private final TARDIS plugin;

    public ArchFakeChatListener(TARDIS plugin) {
        this.plugin = plugin;
    }
    ...
    public void onJohnSmithChat(AsyncChatEvent event) {
        ...
        String currentDisplayName = ComponentUtils.stripColour(player.displayName());
