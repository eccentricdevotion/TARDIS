...
public class HandbrakeModel {
    ...
    public void setState(ItemDisplay display, int state) {
        ...
        if (state == 0) {
            is.setData(DataComponentTypes.ITEM_MODEL, ModelledControl.HANDBRAKE_0.getKey());
        } else {
            is.setData(DataComponentTypes.ITEM_MODEL, ModelledControl.HANDBRAKE_1.getKey());
        }
        is.setItemMeta(im);
