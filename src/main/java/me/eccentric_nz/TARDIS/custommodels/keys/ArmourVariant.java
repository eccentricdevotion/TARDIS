...
public enum ArmourVariant {
    ...
    HEAVENLY_HOST(new NamespacedKey(TARDIS.plugin, "heavenly_host")),
    ...
    NIMON(new NamespacedKey(TARDIS.plugin, "nimon")),
    ...
    SATURNYNIAN(new NamespacedKey(TARDIS.plugin, "saturnynian")),
