...
public enum Whoniverse {
    ...
    PIPE_NORTH(new NamespacedKey(TARDIS.plugin, "pipe_north")),
    PIPE_VARIANT_NORTH(new NamespacedKey(TARDIS.plugin, "pipe_variant_north")),
    PIPE_EAST(new NamespacedKey(TARDIS.plugin, "pipe_east")),
    PIPE_VARIANT_EAST(new NamespacedKey(TARDIS.plugin, "pipe_variant_east")),
    PIPE_SOUTH(new NamespacedKey(TARDIS.plugin, "pipe_south")),
    PIPE_VARIANT_SOUTH(new NamespacedKey(TARDIS.plugin, "pipe_variant_south")),
    PIPE_WEST(new NamespacedKey(TARDIS.plugin, "pipe_west")),
    PIPE_VARIANT_WEST(new NamespacedKey(TARDIS.plugin, "pipe_variant_west")),
