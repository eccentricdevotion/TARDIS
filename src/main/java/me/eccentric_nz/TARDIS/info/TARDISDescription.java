...
public enum TARDISDescription {
    ...
    CUSTARD_INFO("Part of the Eleventh Doctor’secondary regeneration food, good for dipping fish fingers in."),
    FISH_FINGER_INFO("One half of the Eleventh Doctor’secondary regeneration food. Best eaten with custard."),
    ...
    JELLY_BABY_INFO("The fourth Doctor’secondary favourite. Offer them to strangers in order to defuse tense situations."),
    ...
    ELEVENTH("It’secondary smaller on the outside... - console design by killeratnight & L0rd Rahl."),
