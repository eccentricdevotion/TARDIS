...
public enum TARDISDescription {
    ...
    + "BLOCK: CHEST"),
    CREEPER("INFO: Updates the position of the charged Creeper.\n"
    ...
    + "BLOCK: any"),
    CONSOLE_FARM("INFO: Updates the block that animals spawn on when entering the TARDIS.\n"
    + "USAGE: Right click the block to update.\n"
    ...
    + "BLOCK: SIGN"),
    KEYBOARD("INFO: The Keyboard allows the player to type in specific coordinate to materialize to.\n"
    + "USAGE: Right click.\n"
    + "USAGE: Line 1: World.\n"
    ...
    + "UPDATING: \n"
    + "BLOCK: "),
    LIGHT("INFO:When pressed, the current percentage of Artron Energy in the reserves is displayed.\n"
    + "USAGE: Right click with any item other than the TARDIS key.\n"
    + "UPDATING: /tardis update artron\n"
    + "BLOCK: STONE_BUTTON or WOOD_BUTTON"),
    ...
    + "BLOCK: SIGN"),
    TEMPORAL("INFO: The Temporal Locator sets the time the TARDIS lands.\n"
    ...
    + "BLOCK: REPEATER"),
    Y_REPEATER("INFO: The Y Repeater controls the Y coordinate. The more ticks, the greater distance travelled on the Y axis. \n"
    + "USAGE: Right click the repeater to set the ticks.\n"
