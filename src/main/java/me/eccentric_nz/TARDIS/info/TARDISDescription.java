...
public enum TARDISDescription {
    ...
    SONIC_EMERALD_INFO("When you right-click the ground with a The Emerald Sonic Screwdriver Upgrade, it tells you the same information as the TARDIS Scanner, but relative to you."),
    ...
    SONIC_BRUSH_INFO("The Brush Sonic Screwdriver Upgrade can be used instead of a archeolgy brush to remove items from suspicious blocks."),
    ...
    MATERIALISATION_CIRCUIT_INFO("The Materialisation Circuit enables a TARDIS to dematerialize. It is used in crafting a Stattenhiem Circuit, and is a component of the TARDIS Advanced Console."),
    ...
    CHAMELON_CIRCUIT_INFO("The Chamelon Circuit is used in crafting the Preset Storage Disks and is a component of the TARDIS Advanced Console."),
    ...
    FOB_WATCH_INFO("The Tenth Doctor used a Chameleon Arch to change himself into the human John Smith to elude the Family of Blood. You can craft a fob watch to change your self from a Time Lord in a regular player (a Steve - albiet with a random name)."),
    ...
    FIFTEENTH("The 14/15th Doctor's TARDIS - console design from mc.thatsnotacreeper.com."),
    ...
    CURSED("A dark, cursed TARDIS - console design from mc.thatsnotacreeper.com."),
