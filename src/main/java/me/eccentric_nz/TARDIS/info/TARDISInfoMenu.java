...
public enum TARDISInfoMenu {
    ...
    TARDIS_COMEHERE("TIS|Commands|TARDIS Commands|comehere", "TARDIS", "r"),
    ...
    TARDIS_LAMPS("TIS|Commands|TARDIS Commands|lamps", "TARDIS", "a"),
    ...
    TARDIS_REBUILD("TIS|Commands|TARDIS Commands|rebuild", "TARDIS", "r"),
    TARDIS_REMOVE("TIS|Commands|TARDIS Commands|remove", "TARDIS", ""),
    ...
    TARDIS_ROOM("TIS|Commands|TARDIS Commands|room", "TARDIS", "r"),
