...
public enum TARDISInfoMenu {
    ...
    INVISIBLE_CIRCUIT_INFO("TIS|Components|Invisibility Circuit|Info", "INVISIBLE_CIRCUIT", "I"),
    INVISIBLE_CIRCUIT_RECIPE("TIS|Components|Invisibility Circuit|Recipe", "INVISIBLE_CIRCUIT", "R"),
