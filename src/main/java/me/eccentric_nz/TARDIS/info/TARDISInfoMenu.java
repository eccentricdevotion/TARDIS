...
public enum TARDISInfoMenu {
    ...
    GAMES("TIS|Rooms|Games!", "ROOMS", "!"),
    GARDEN("TIS|Rooms|Garden", "ROOMS", "de"),
    GEODE("TIS|Rooms|Geode", "ROOMS", "eo"),
    GOLEM("TIS|Rooms|(Copper) Golem", "ROOMS", "pp"),
    ...
    TARDIS_COMEHERE("TIS|Commands|TARDIS Commands|come_here", "TARDIS", "com"),
    ...
    TARDIS_NAMEKEY("TIS|Commands|TARDIS Commands|name_key", "TARDIS", "k"),
    ...
    TARDIS_REMOVESAVE("TIS|Commands|TARDIS Commands|remove_save", "TARDIS", "rem"),
    ...
    TARDIS_SETDEST("TIS|Commands|TARDIS Commands|set_destination", "TARDIS", "t"),
