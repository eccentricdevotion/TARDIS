 ...
 * @author eccentric_nz
 */
public class RoomsConfigUpdater {
    ...
    public RoomsConfigUpdater(TARDIS plugin, FileConfiguration rooms_config) {
        this.plugin = plugin;
        ...
        booleanOptions.put("rooms.ARCADE.enabled", true);
        booleanOptions.put("rooms.ARCADE.user", false);
        ...
        booleanOptions.put("rooms.NAUTILUS.enabled", true);
        ...
        integerOptions.put("rooms.ARCADE.cost", 250);
        integerOptions.put("rooms.ARCADE.offset", 0);
        ...
        stringOptions.put("rooms.ARCADE.seed", "STRUCTURE_BLOCK");
    ...
    public void checkRoomsConfig() {
        ...
        try {
            ...
            if (i > 0) {
                plugin.getMessenger().message(plugin.getConsole(), TardisModule.TARDIS, "Added " + i + " new items to rooms.yml");
            }
