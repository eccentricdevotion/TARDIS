 ...
 * @author eccentric_nz
 */
public class ArtronConfigUpdater {
    ...
    public ArtronConfigUpdater(TARDIS plugin) {
        this.plugin = plugin;
        ...
        integerOptions.put("full_charge", 10000);
        ...
        integerOptions.put("sonic_generator.knockback", 10);
    ...
    public void checkArtronConfig() {
        ...
        try {
            ...
            if (i > 0) {
                plugin.getMessenger().message(plugin.getConsole(), TardisModule.TARDIS, "Added " + i + " new items to artron.yml");
            }
