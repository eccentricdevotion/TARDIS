...
public class TARDISConfiguration {
    ...
    public TARDISConfiguration(TARDIS plugin) {
        ...
        roomBoolOptions.put("rooms.AQUARIUM.enabled", true);
        roomBoolOptions.put("rooms.AQUARIUM.user", false);
        ...
        roomIntOptions.put("rooms.AQUARIUM.cost", 450);
        roomIntOptions.put("rooms.AQUARIUM.offset", -4);
        ...
        // string
        roomStrOptions.put("rooms.AQUARIUM.seed", "TUBE_CORAL_BLOCK");
        ...
        roomStrOptions.put("rooms.GREENHOUSE.seed", "MELON");
        ...
        roomStrOptions.put("rooms.SHELL.seed", "DEAD_BRAIN_CORAL_BLOCK");
    ...
    private void checkRoomsConfig() {
        int i = 0;
        if (rooms_config.contains("rooms.AQUARUIM")) {
            rooms_config.set("rooms.AQUARUIM", null);
        }
        // boolean values
    ...
    private void checkBlocksConfig() {
        int i = 0;
        if (!blocks_config.contains("version") || blocks_config.getInt("version") < 5) {
    ...
    private void checkCondensables() {
