...
//            list.put("CRIMSON_BUTTON", 3);
//            list.put("CRIMSON_DOOR", 3);
//            list.put("CRIMSON_FENCE", 3);
//            list.put("CRIMSON_FENCE_GATE", 3);
//            list.put("CRIMSON_FUNGI", 1);
//            list.put("CRIMSON_HYPHAE", 1);
//            list.put("CRIMSON_NYLIUM", 1);
//            list.put("CRIMSON_PLANKS", 1);
//            list.put("CRIMSON_PRESSURE_PLATE", 3);
//            list.put("CRIMSON_ROOT", 1);
//            list.put("CRIMSON_SIGN", 3);
//            list.put("CRIMSON_SLAB", 3);
//            list.put("CRIMSON_STAIRS", 3);
//            list.put("CRIMSON_STEM", 1);
//            list.put("CRIMSON_TRAPDOOR", 3);
//            list.put("CRYING_OBSIDIAN", 150);
//            list.put("GILDED_BLACKSTONE", 1);
//            list.put("LODESTONE", 200);
...
//            list.put("POLISHED_BLACKSTONE", 2);
//            list.put("POLISHED_BLACKSTONE_BRICK_SLAB", 2);
//            list.put("POLISHED_BLACKSTONE_BRICK_STAIRS", 2);
//            list.put("POLISHED_BLACKSTONE_BRICK_WALL", 2);
//            list.put("POLISHED_BLACKSTONE_BRICKS", 2);
//            list.put("POLISHED_BLACKSTONE_SLAB", 2);
//            list.put("POLISHED_BLACKSTONE_STAIRS", 2);
//            list.put("POLISHED_BLACKSTONE_WALL", 2);
...
//            list.put("STRIPPED_CRIMSON_HYPHAE", 4);
//            list.put("STRIPPED_CRIMSON_STEM", 4);
//            list.put("STRIPPED_WARPED_HYPHAE", 4);
//            list.put("STRIPPED_WARPED_STEM", 4);
//            list.put("TARGET", 24);
//            list.put("TWISTING_VINES", 24);
//            list.put("WARPED_BUTTON", 3);
//            list.put("WARPED_DOOR", 3);
//            list.put("WARPED_FENCE", 3);
//            list.put("WARPED_FENCE_GATE", 3);
...
//            list.put("WARPED_PRESSURE_PLATE", 3);
//            list.put("WARPED_ROOTS", 1);
//            list.put("WARPED_SIGN", 1);
//            list.put("WARPED_SLAB", 3);
//            list.put("WARPED_STAIRS", 3);
//            list.put("WARPED_STEM", 1);
//            list.put("WARPED_TRAPDOOR", 3);
