 ...
 * @author eccentric_nz
 */
public class BlocksConfigUpdater {

    private final TARDIS plugin;
    private final FileConfiguration blocks_config;

    public BlocksConfigUpdater(TARDIS plugin, FileConfiguration blocks_config) {
        this.plugin = plugin;
