    ...
    public void onItemFrameClick(PlayerInteractEntityEvent event) {
        ...
        if (event.getRightClicked() instanceof ItemFrame) {
            ...
            if (plugin.getTrackerKeeper().getTrackPlayers().containsKey(playerNameStr) && plugin.getTrackerKeeper().getTrackPlayers().get(playerNameStr).equals("direction")) {
                ...
                player.sendMessage(plugin.getPluginName() + "The position of the TARDIS Direction Frame was updated successfully.");
                return;
            }
            ...
            if (rs.resultSet()) {
                ...
                if (frame.getItem().getType().equals(Material.TRIPWIRE_HOOK)) {
                    ...
                    if (player.isSneaking()) {
                        ...
                        player.sendMessage(plugin.getPluginName() + "SHIFT-RIGHT click the Direction Frame to set the TARDIS to " + direction);
                    }
                } else {
