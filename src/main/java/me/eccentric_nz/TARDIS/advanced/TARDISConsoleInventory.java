 ...
 * @author eccentric_nz
 */
public class TARDISConsoleInventory {

    private final ItemStack[] terminal;

    public TARDISConsoleInventory(boolean bool, boolean adapt) {
    ...
    private ItemStack[] getItemStack() {
        ...
        ing.setLore(Arrays.asList(new String[]{"Click to turn "}));
        con.setItemMeta(ing);
        // Apply preset
        ...
        me.setLore(Arrays.asList(new String[]{"Click to turn "}));
        bio.setItemMeta(me);
        // Cancel / close
