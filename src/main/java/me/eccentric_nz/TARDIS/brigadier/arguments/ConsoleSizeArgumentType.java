...
public class ConsoleSizeArgumentType implements CustomArgumentType<String, String> {

    private static final SimpleCommandExceptionType ERROR_INVALID_SIZE = new SimpleCommandExceptionType(
            MessageComponentSerializer.message().serialize(Component.text("Invalid size specified!"))
    );
    private final Set<String> SIZES = new HashSet<>();

    public ConsoleSizeArgumentType() {
