...
public class AdminCommandNode {
    ...
    public AdminCommandNode(TARDIS plugin) {
        this.plugin = plugin;
    }
        ...
        LiteralArgumentBuilder<CommandSourceStack> command = Commands.literal("tardisadmin")
                        ...
                        .then(Commands.literal("whois")
                                .then(Commands.argument("name", StringArgumentType.word())
                                        .executes(ctx -> {
                                            ...
                                            new TARDISArchCommand(plugin).whois(ctx.getSource().getSender(), name);
                                            return Command.SINGLE_SUCCESS;
                                        })))
                ...
                .then(Commands.literal("assemble")
                        .then(Commands.argument("action", StringArgumentType.word())
                                ...
                                .executes(ctx -> {
                                    new DispersedCommand(plugin).assemble(ctx.getSource().getSender(), StringArgumentType.getString(ctx, "action"));
                                    return Command.SINGLE_SUCCESS;
                                })
                        ))
                .then(Commands.literal("clean")
                        .executes(ctx -> {
                            new CleanEntitiesCommand(plugin).checkAndRemove(ctx.getSource().getSender());
                            return Command.SINGLE_SUCCESS;
                        }))
                .then(Commands.literal("condenser")
                        .executes(ctx -> {
                            new CondenserCommand(plugin).set(ctx.getSource().getSender());
                            return Command.SINGLE_SUCCESS;
                        }))
                .then(Commands.literal("convert_database")
                        .executes(ctx -> {
                            try {
                                Bukkit.getServer().getScheduler().runTaskAsynchronously(plugin, new Converter(plugin, ctx.getSource().getSender()));
                            } catch (Exception e) {
                                plugin.getMessenger().message(ctx.getSource().getSender(), "Database conversion failed! " + e.getMessage());
                            }
                            return Command.SINGLE_SUCCESS;
                        }))
                        ...
                        .then(Commands.argument("player", ArgumentTypes.player())
                                .then(Commands.argument("seed", new SeedArgumentType())
                                        ...
                                        .executes(ctx -> {
                                            ...
                                            new CreateTARDISCommand(plugin, "ORANGE_WOOL", "LIGHT_GRAY_WOOL").buildTARDIS(ctx.getSource().getSender(), target, seed);
                                            return Command.SINGLE_SUCCESS;
                                        })
                                        .then(Commands.argument("wall", new WallFloorArgumentType())
                                                .then(Commands.argument("floor", new WallFloorArgumentType())
                                                        .executes(ctx -> {
                                                            ...
                                                            new CreateTARDISCommand(plugin, wall, floor).buildTARDIS(ctx.getSource().getSender(), target, seed);
                                                            return Command.SINGLE_SUCCESS;
                                                        })
                                                )))))
                .then(Commands.literal("decharge")
                        .then(Commands.argument("name", StringArgumentType.word())
                                .executes(ctx -> {
                                    ...
                                    new DechargeCommand(plugin).removeChargerStatus(ctx.getSource().getSender(), n);
                                    return Command.SINGLE_SUCCESS;
                                })))
                .then(Commands.literal("delete")
                        .then(Commands.argument("player", ArgumentTypes.player())
                                .executes(ctx -> {
                                    ...
                                    PlayerSelectorArgumentResolver targetResolver = ctx.getArgument("player", PlayerSelectorArgumentResolver.class);
                                    Player player = targetResolver.resolve(ctx.getSource()).getFirst();
                                    new DeleteTARDISCommand(plugin).deleteTARDIS(ctx.getSource().getSender(), player, 0);
                                    return Command.SINGLE_SUCCESS;
                                })
                                .then(Commands.literal("abandoned")
                                        .executes(ctx -> {
                                            ...
                                            PlayerSelectorArgumentResolver targetResolver = ctx.getArgument("player", PlayerSelectorArgumentResolver.class);
                                            Player player = targetResolver.resolve(ctx.getSource()).getFirst();
                                            new DeleteTARDISCommand(plugin).deleteTARDIS(ctx.getSource().getSender(), player, 1);
                                            return Command.SINGLE_SUCCESS;
                                        })))
                        .then(Commands.argument("id", IntegerArgumentType.integer(1))
                            ...
                            int id = IntegerArgumentType.getInteger(ctx, "id");
                            new DeleteTARDISCommand(plugin).deleteTARDIS(ctx.getSource().getSender(), id, 1);
                            return Command.SINGLE_SUCCESS;
                        }))
                        ...
                        .then(Commands.argument("player", ArgumentTypes.player())
                                .then(Commands.argument("entity_type", new CreatureArgumentType())
                                        .executes(ctx -> {
                                            ...
                                            new DisguiseCommand(plugin).disguise(ctx.getSource().getSender(), player, type);
                                            return Command.SINGLE_SUCCESS;
                                        }))))
                .then(Commands.literal("dispersed")
                        .then(Commands.argument("action", StringArgumentType.word())
                                ...
                                .executes(ctx -> {
                                    ...
                                    new DispersedCommand(plugin).assemble(ctx.getSource().getSender(), action);
                                    return Command.SINGLE_SUCCESS;
                                })
                        ))
                .then(Commands.literal("enter")
                        .then(Commands.argument("player", ArgumentTypes.player())
                                .executes(ctx -> {
                                    ...
                                    PlayerSelectorArgumentResolver targetResolver = ctx.getArgument("player", PlayerSelectorArgumentResolver.class);
                                    Player player = targetResolver.resolve(ctx.getSource()).getFirst();
                                    new EnterCommand(plugin).enterTARDIS(ctx.getSource().getSender(), player);
                                    return Command.SINGLE_SUCCESS;
                                }))
                        .then(Commands.argument("id", IntegerArgumentType.integer(1))
                                .executes(ctx -> {
                                    ...
                                    int id = IntegerArgumentType.getInteger(ctx, "id");
                                    new EnterCommand(plugin).enterTARDIS(ctx.getSource().getSender(), id);
                                    return Command.SINGLE_SUCCESS;
                                })))
                .then(Commands.literal("find")
                        .executes(ctx -> {
                            new FindHiddenCommand().search(plugin, ctx.getSource().getSender(), 16);
                            return Command.SINGLE_SUCCESS;
                        })
                        .then(Commands.argument("radius", IntegerArgumentType.integer(1, 32))
                                .executes(ctx -> {
                                    int radius = IntegerArgumentType.getInteger(ctx, "radius");
                                    new FindHiddenCommand().search(plugin, ctx.getSource().getSender(), radius);
                                    return Command.SINGLE_SUCCESS;
                                }))
                )
                .then(Commands.literal("list")
                        ...
                        .then(Commands.literal("tardises")
                                .executes(ctx -> {
                                    new TardisPagedLister(plugin, ctx.getSource().getSender()).send(1);
                                    return Command.SINGLE_SUCCESS;
                                })
                                .then(Commands.argument("page", IntegerArgumentType.integer(1))
                                        .executes(ctx -> {
                                            int page = IntegerArgumentType.getInteger(ctx, "page");
                                            new TardisPagedLister(plugin, ctx.getSource().getSender()).send(page);
                                            return Command.SINGLE_SUCCESS;
                                        })))
                        .then(Commands.argument("what", new AdminListArgumentType())
                                .executes(ctx -> {
                                    String what = ctx.getArgument("what", String.class);
                                    new ListCommand(plugin).listStuff(ctx.getSource().getSender(), what);
                                    return Command.SINGLE_SUCCESS;
                                })))
                .then(Commands.literal("make_preset")
                        ...
                        .then(Commands.argument("name", StringArgumentType.word())
                                .executes(ctx -> {
                                    String name = StringArgumentType.getString(ctx, "name");
                                    new MakePresetCommand(plugin).scanBlocks(ctx.getSource().getSender(), name);
                                    return Command.SINGLE_SUCCESS;
                                })))
                .then(Commands.literal("maze")
                        .executes(ctx -> {
                            ...
                            Location l = player.getTargetBlock(plugin.getGeneralKeeper().getTransparent(), 16).getRelative(BlockFace.UP).getLocation();
                ...
                .then(Commands.literal("player_count")
                        .then(Commands.argument("player", ArgumentTypes.player())
                                .executes(ctx -> {
                                    PlayerSelectorArgumentResolver targetResolver = ctx.getArgument("player", PlayerSelectorArgumentResolver.class);
                                    Player player = targetResolver.resolve(ctx.getSource()).getFirst();
                                    new PlayerCountCommand(plugin).countPlayers(ctx.getSource().getSender(), player, -1);
                                    return Command.SINGLE_SUCCESS;
                                        ...
                                        .executes(ctx -> {
                                            ...
                                            new PlayerCountCommand(plugin).countPlayers(ctx.getSource().getSender(), player, count);
                                            return Command.SINGLE_SUCCESS;
                                        }))))
                .then(Commands.literal("prune")
                        .then(Commands.argument("days", IntegerArgumentType.integer(1))
                                .executes(ctx -> {
                                    ...
                                    new PruneCommand(plugin).startPruning(ctx.getSource().getSender(), days);
                                    return Command.SINGLE_SUCCESS;
                                })))
                .then(Commands.literal("prune_list")
                        .then(Commands.argument("days", IntegerArgumentType.integer(1))
                                .executes(ctx -> {
                                    int days = IntegerArgumentType.getInteger(ctx, "days");
                                    new PruneCommand(plugin).listPrunes(ctx.getSource().getSender(), days);
                                    return Command.SINGLE_SUCCESS;
                                })))
                .then(Commands.literal("purge")
                        .then(Commands.literal("junk")
                                .executes(ctx -> {
                                    new PurgeCommand(plugin).clearAll(ctx.getSource().getSender(), "junk", "00000000-aaaa-bbbb-cccc-000000000000");
                                    return Command.SINGLE_SUCCESS;
                                }))
                        .then(Commands.argument("player", ArgumentTypes.player())
                                .executes(ctx -> {
                                    PlayerSelectorArgumentResolver targetResolver = ctx.getArgument("player", PlayerSelectorArgumentResolver.class);
                                    Player player = targetResolver.resolve(ctx.getSource()).getFirst();
                                    new PurgeCommand(plugin).clearAll(ctx.getSource().getSender(), player.getName(), player.getUniqueId().toString());
                                    return Command.SINGLE_SUCCESS;
                                })))
                .then(Commands.literal("purge_portals")
                        .executes(ctx -> {
                            new PortalCommand(plugin).clearAll(ctx.getSource().getSender());
                            return Command.SINGLE_SUCCESS;
                        }))
                        ...
                        .then(Commands.argument("block_id", IntegerArgumentType.integer(1))
                                .then(Commands.argument("location", StringArgumentType.string())
                                        .executes(ctx -> {
                                            ...
                                            new RemoveProtectionCommand(plugin).remove(id, location);
                                            return Command.SINGLE_SUCCESS;
                                        }))))
                        ...
                        .then(Commands.argument("player", ArgumentTypes.player())
                                .then(Commands.argument("count", IntegerArgumentType.integer(0))
                                        .executes(ctx -> {
                                            ...
                                            Player player = targetResolver.resolve(ctx.getSource()).getFirst();
                                            int count = IntegerArgumentType.getInteger(ctx, "count");
                                            new RepairCommand(plugin).setFreeCount(ctx.getSource().getSender(), player, count);
                                            return Command.SINGLE_SUCCESS;
                                        }))))
                        ...
                        .then(Commands.argument("player", ArgumentTypes.player())
                                .then(Commands.argument("desktop", new SeedArgumentType())
                                        .executes(ctx -> {
                                            ...
                                            new SetSizeCommand(plugin).overwrite(ctx.getSource().getSender(), player, desktop);
                                            return Command.SINGLE_SUCCESS;
                                        }))))
                                ...
                                .then(Commands.argument("preset", new PresetArgumentType(0))
                                        .then(Commands.argument("direction", new CompassArgumentType())
                                                .executes(ctx -> {
                                                    ...
                                                    Location location = player.getTargetBlock(plugin.getGeneralKeeper().getTransparent(), 16).getRelative(BlockFace.UP).getLocation();
                                                    new CreateAbandonedCommand(plugin).spawn(ctx.getSource().getSender(), s, p, d, location.getWorld(), location.blockX(), location.blockY(), location.blockZ());
                                                    return Command.SINGLE_SUCCESS;
                                                })
                                                .then(Commands.argument("world", ArgumentTypes.world())
                                                        .then(Commands.argument("position", ArgumentTypes.blockPosition())
                                                                .executes(ctx -> {
                                                                    ...
                                                                    new CreateAbandonedCommand(plugin).spawn(ctx.getSource().getSender(), s, p, d, world, pos.blockX(), pos.blockY(), pos.blockZ());
                                                                    return Command.SINGLE_SUCCESS;
                                                                })))))))
                ...
                .then(Commands.literal("update_plugin")
                        .executes(ctx -> {
                            if (!ctx.getSource().getSender().isOp()) {
                                plugin.getMessenger().message(ctx.getSource().getSender(), "You must be a server operator to run this command!");
                                return Command.SINGLE_SUCCESS;
                            }
                            new UpdateTARDISPlugins(plugin).fetchFromGitHub(ctx.getSource().getSender());
                            return Command.SINGLE_SUCCESS;
                        }));
