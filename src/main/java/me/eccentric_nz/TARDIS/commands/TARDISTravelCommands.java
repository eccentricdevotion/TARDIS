            ...
            if (TARDISPermission.hasPermission(player, "tardis.exile") && plugin.getConfig().getBoolean("travel.exile")) {
                ...
                if (args.length == 1) {
                    ...
                    if (args[0].equalsIgnoreCase("home") || args[0].equalsIgnoreCase("back") || args[0].equalsIgnoreCase("cave")) {
                        String which = "";
                        TravelType travelType = TravelType.HOME;
                        ...
                        return true;
                    } else if (args[0].equalsIgnoreCase("village") && args[0].equalsIgnoreCase("structure")) {
                        return travelPlayer(player, args[0], id);
                    }
                }
                if (args[0].equalsIgnoreCase("structure") || args[0].equalsIgnoreCase("village")) {
