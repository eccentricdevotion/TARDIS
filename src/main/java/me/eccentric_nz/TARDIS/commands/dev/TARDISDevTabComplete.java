...
public class TARDISDevTabComplete extends TARDISCompleter implements TabCompleter {
    ...
    private final ImmutableList<String> ROOT_SUBS = ImmutableList.of("add_regions", "advancements", "chunky", "list", "plurals", "stats", "tree", "snapshot", "displayitem", "frame", "brushable", "box", "nms", "circuit");
