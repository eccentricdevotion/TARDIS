...
public class TARDISPrefsTabComplete implements TabCompleter {
    ...
    private final ImmutableList<String> ROOT_SUBS = ImmutableList.of("auto", "build", "beacon", "dnd", "eps", "eps_message", "floor", "hads", "isomorphic", "key", "lamp", "language", "minecart", "plain", "platform", "quotes", "renderer", "sfx", "submarine", "wall");
