...
public class TARDISAdminPageTwoInventory {
    ...
    private ItemStack[] getItemStack() {
        ...
        for (String c : config) {
            ...
            if ((value.equalsIgnoreCase("true") || value.equalsIgnoreCase("false")) && (c.startsWith("circuits") || c.startsWith("debug") || c.startsWith("desktop") || c.startsWith("junk") || c.startsWith("siege") || c.startsWith("travel"))) {
