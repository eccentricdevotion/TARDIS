...
public class TARDISMushroomCommand {
    ...
    private final List<String> stemBlockNames = Arrays.asList("", "Blue Torch", "Green Torch", "Purple Torch", "Red Torch", "Custom", "Hexagon", "Roundel", "Roundel Offset", "Cog");
    private final List<String> stemSubs = Arrays.asList("", "blue_torch", "green_torch", "purple_torch", "red_torch", "custom", "hexagon", "roundel", "roundel_offset", "cog");
