...
public class TARDISMushroomCommand {
    ...
    private final List<String> stemBlockNames = Arrays.asList("", "Blue Lamp", "Red Lamp", "Purple Lamp", "Green Lamp", "Blue Lamp On", "Red Lamp On", "Purple Lamp On", "Green Lamp On", "Heat Block", "Custom", "Hexagon", "Roundel", "Roundel Offset", "Cog", "Advanced Console", "Disk Storage", "Lamp Off", "Lantern Off", "Blue Police Box", "Seed Block Grow", "Police Box Blue Open", "Police Box Blue Open South", "Police Box Blue Open West", "Police Box Blue Open North", "Time Rotor 1", "Time Rotor 2", "Time Rotor 3", "Time Rotor 1 Off", "Time Rotor 2 Off", "Time Rotor 3 Off");
    private final List<String> stemSubs = Arrays.asList("", "blue_lamp", "red_lamp", "purple_lamp", "green_lamp", "blue_lamp_on", "red_lamp_on", "purple_lamp_on", "green_lamp_on", "heat_block", "custom", "hexagon", "roundel", "roundel_offset", "cog", "advanced_console", "disk_storage", "lamp_off", "lantern_off", "blue_box", "grow", "tardis_blue_open", "tardis_blue_open_south", "tardis_blue_open_west", "tardis_blue_open_north", "time_rotor_1", "time_rotor_2", "time_rotor_3", "time_rotor_1_off", "time_rotor_2_off", "time_rotor_3_off");
