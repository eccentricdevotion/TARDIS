...
public class Seed {
    ...
    public void give(CommandSender sender, Player player, String desktop, String wall, String floor) {
        if (player != null) {
            String type = desktop.toUpperCase(Locale.ROOT);
            try {
                wall = Material.valueOf(wall.toUpperCase(Locale.ROOT)).toString();
                floor = Material.valueOf(floor.toUpperCase(Locale.ROOT)).toString();
            ...
            if (Desktops.getBY_NAMES().containsKey(type)) {
                ...
                if (schm.isCustom()) {
                    ...
                    try {
                        ...
                        plugin.getMessenger().send(sender, TardisModule.TARDIS, "SEED_NOT_VALID");
                        return;
                    }
                }
