...
public class TARDISGiveTabComplete extends TARDISCompleter implements TabCompleter {
    ...
    private final ImmutableList<String> MUSHROOM_SUBS = ImmutableList.of("advanced_console", "ancient", "ars", "bigger", "blue_box", "blue_lamp_on", "blue_lamp", "budget", "cave", "cog", "compound", "constructor", "copper", "coral", "creative", "custom", "delta", "deluxe", "disk_storage", "division", "eleventh", "ender", "factory", "fugitive", "green_lamp_on", "green_lamp", "grow", "heat_block", "hexagon", "lab", "lamp_off", "lantern_off", "legacy_bigger", "legacy_deluxe", "legacy_eleventh", "legacy_redstone", "master", "mechanical", "medium", "original", "pandorica", "plank", "product", "purple_lamp_on", "purple_lamp", "pyramid", "red_lamp_on", "red_lamp", "redstone", "reducer", "rotor", "roundel_offset", "roundel", "siege_cube", "small", "steampunk", "tall", "the_moment", "thirteenth", "tom", "twelfth", "war", "weathered");
