...
public class TARDISCommandHelper {
	...
	public enum ROOT_COMMAND {
		...
		tardis("https://goo.gl/55uTqL"), tardistravel("https://goo.gl/5rZR1T"), tardisadmin("https://goo.gl/jWFyLX"), tardisgive("https://goo.gl/LGQgy5"), tardisroom("https://goo.gl/zh9RKK"), tardisprefs("https://goo.gl/6k3RqD"), tardisarea("https://goo.gl/AJM2i3"), tardisartron("https://goo.gl/00ueX0"), tardisbind("https://goo.gl/sedpK4"), tardisgravity("https://goo.gl/vczqjf"), tardisbook("https://goo.gl/BGPh3t"), tardistexture("https://goo.gl/FPuxoa"), tardisrecipe("https://goo.gl/WSHA6N"), tardissay("https://goo.gl/iphcoM"), tardisremote("https://goo.gl/8GpxUV"), tardisschematic("https://goo.gl/BG4TtW"), tardisnetherportal("https://goo.gl/B2M36Y"), tardisjunk("https://goo.gl/xNcBd5"), handles("https://tardis.page.link/handles"), tardisteleport("Not yet available"), tardisworld("Not yet available"), tardisgamemode("Not yet available"), tardischemistry("Not yet available"), tardissudo("Not yet available"), tardistime("Not yet available"), tardisweather("Not yet available");
