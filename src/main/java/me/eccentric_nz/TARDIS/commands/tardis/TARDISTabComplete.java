...
public class TARDISTabComplete implements TabCompleter {
    ...
    private final List<String> ROOT_SUBS = ImmutableList.of("abort", "add", "arch_time", "arsremove", "chameleon", "comehere", "desktop", "direction", "ep1", "erase", "exterminate", "find", "help", "hide", "home", "inside", "jettison", "list", "namekey", "occupy", "rebuild", "remove", "removesave", "rescue", "room", "save", "save_player", "secondary", "setdest", "tagtheood", "theme", "update", "upgrade", "version");
