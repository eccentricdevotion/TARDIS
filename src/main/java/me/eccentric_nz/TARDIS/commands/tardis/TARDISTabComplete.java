...
public class TARDISTabComplete implements TabCompleter {
    ...
    private final List<String> ROOT_SUBS = ImmutableList.of("abort", "add", "chameleon", "comehere", "direction", "exterminate", "find", "help", "hide", "home", "inside", "jettison", "list", "namekey", "occupy", "rebuild", "remove", "removesave", "rescue", "room", "save", "secondary", "setdest", "tagtheood", "update", "version");
