...
public enum GUISonicPreferences {
    ...
    WAR_DOCTOR(10000085, 8),
    TWELFTH_DOCTOR(10000012, 9),
    THIRTEENTH_DOCTOR(10000013, 10),
    FOURTEENTH_DOCTOR(10000014, 11),
    MASTER(10000032, 12),
    SARAH_JANE(10000033, 13),
    RIVER_SONG(10000031, 14),
    NINTH_DOCTOR_OPEN(12000009, 18),
    TENTH_DOCTOR_OPEN(12000010, 19),
    ELEVENTH_DOCTOR_OPEN(12000011, 20),
    FOURTEENTH_DOCTOR_OPEN(12000014, 21),
    INSTRUCTIONS(1, 22, Material.BOOK),
