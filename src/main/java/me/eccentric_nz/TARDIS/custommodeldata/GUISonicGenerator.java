...
public enum GUISonicGenerator {
    ...
    NINTH_DOCTOR_OPEN(20000009, 14, Material.BLAZE_ROD, "", ChatColor.DARK_GREEN),
    TENTH_DOCTOR_OPEN(20000010, 15, Material.BLAZE_ROD, "", ChatColor.DARK_AQUA),
    ELEVENTH_DOCTOR_OPEN(20000011, 16, Material.BLAZE_ROD, "", ChatColor.LIGHT_PURPLE),
