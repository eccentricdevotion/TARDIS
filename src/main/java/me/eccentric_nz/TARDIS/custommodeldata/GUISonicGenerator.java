...
public enum GUISonicGenerator {
    ...
    NINTH_DOCTOR(10000009, 5, Material.BLAZE_ROD, ""),
    TENTH_DOCTOR(10000010, 6, Material.BLAZE_ROD, ""),
    ELEVENTH_DOCTOR(10000011, 7, Material.BLAZE_ROD, ""),
    WAR_DOCTOR(10000085, 8, Material.BLAZE_ROD, ""),
    THIRTEENTH_DOCTOR(10000013, 9, Material.BLAZE_ROD, ""),
    MASTER(10000032, 10, Material.BLAZE_ROD, ""),
    SARAH_JANE(10000033, 11, Material.BLAZE_ROD, ""),
    RIVER_SONG(10000031, 12, Material.BLAZE_ROD, ""),
    NINTH_DOCTOR_OPEN(12000009, 14, Material.BLAZE_ROD, ""),
    TENTH_DOCTOR_OPEN(12000010, 15, Material.BLAZE_ROD, ""),
    ELEVENTH_DOCTOR_OPEN(12000011, 16, Material.BLAZE_ROD, ""),
    TWELFTH_DOCTOR(10000012, 17, Material.BLAZE_ROD, ""),
    STANDARD_SONIC(80, 27, Material.BOWL, ""),
    BIO_SCANNER_UPGRADE(9, 29, Material.BOWL, ""),
    DIAMOND_UPGRADE(50, 30, Material.BOWL, ""),
    EMERALD_UPGRADE(51, 31, Material.BOWL, ""),
    REDSTONE_UPGRADE(71, 32, Material.BOWL, ""),
    PAINTER_UPGRADE(67, 33, Material.BOWL, ""),
    IGNITE_UPGRADE(56, 34, Material.BOWL, ""),
