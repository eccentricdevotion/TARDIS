...
public enum GUISonicGenerator {
    ...
    NINTH_DOCTOR(10000009, 9, Material.BLAZE_ROD, ""),
    TENTH_DOCTOR(10000010, 10, Material.BLAZE_ROD, ""),
    ELEVENTH_DOCTOR(10000011, 11, Material.BLAZE_ROD, ""),
    FOURTEENTH_DOCTOR(10000014, 12, Material.BLAZE_ROD, ""),
    WAR_DOCTOR(10000085, 13, Material.BLAZE_ROD, ""),
    MASTER(10000032, 14, Material.BLAZE_ROD, ""),
    SARAH_JANE(10000033, 15, Material.BLAZE_ROD, ""),
    NINTH_DOCTOR_OPEN(12000009, 18, Material.BLAZE_ROD, ""),
    TENTH_DOCTOR_OPEN(12000010, 19, Material.BLAZE_ROD, ""),
    ELEVENTH_DOCTOR_OPEN(12000011, 20, Material.BLAZE_ROD, ""),
    FOURTEENTH_DOCTOR_OPEN(12000014, 21, Material.BLAZE_ROD, ""),
    AMY_POND(10000034, 22, Material.BLAZE_ROD, ""),
    RIVER_SONG(10000031, 23, Material.BLAZE_ROD, ""),
    MISSY(10000035, 24, Material.BLAZE_ROD, ""),
