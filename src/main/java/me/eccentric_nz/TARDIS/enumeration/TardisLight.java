    ...
    public static TardisLight getFromDisplayItem(TARDISDisplayItem tdi) {
        ...
        return switch (tdi) {
            ...
            case LIGHT_BULB, LIGHT_CLASSIC, LIGHT_CLASSIC_OFFSET, LIGHT_TENTH, LIGHT_ELEVENTH, LIGHT_TWELFTH,
                 LIGHT_THIRTEENTH, LIGHT_LAMP, LIGHT_LANTERN, LIGHT_VARIABLE -> TardisLight.valueOf(s.substring(6));
            ...
            case LIGHT_BULB_ON, LIGHT_CLASSIC_ON, LIGHT_CLASSIC_OFFSET_ON, LIGHT_TENTH_ON, LIGHT_ELEVENTH_ON,
                 ...
                 LIGHT_VARIABLE_PURPLE_ON, LIGHT_VARIABLE_YELLOW_ON -> TardisLight.valueOf(s.substring(6, s.length() - 3));
            default -> TENTH;
        };
    }
