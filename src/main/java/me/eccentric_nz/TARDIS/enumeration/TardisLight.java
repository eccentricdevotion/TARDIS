...
public enum TardisLight {
    ...
    ELEVENTH_1(TARDISDisplayItem.LIGHT_ELEVENTH_1, TARDISDisplayItem.LIGHT_ELEVENTH_1_ON),
    ELEVENTH_2(TARDISDisplayItem.LIGHT_ELEVENTH_2, TARDISDisplayItem.LIGHT_ELEVENTH_2_ON),
