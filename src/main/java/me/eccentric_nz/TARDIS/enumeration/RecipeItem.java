...
public enum RecipeItem {
	...
	THREE_D_GLASSES(10000039, RecipeCategory.ACCESSORIES), // unshaped recipes start here
	...
	TARDIS_SCHEMATIC_WAND(10000001, RecipeCategory.MISC), // jelly babies
	...
	LICORICE_JELLY_BABY(10000016), // sonic upgrades
	...
	KNOCKBACK_UPGRADE(10000010, RecipeCategory.SONIC_UPGRADES), // planet items
	ACID_BUCKET(1, RecipeCategory.UNCRAFTABLE),
	RUST_BUCKET(1, RecipeCategory.UNCRAFTABLE), // not fond
