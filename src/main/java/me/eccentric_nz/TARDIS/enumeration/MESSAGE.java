...
public enum MESSAGE {
    ...
    ARS_MISSIN("The ARS Circuit is missing from the console!"),
    ARS_NO_CUSTOM("You cannot use the Architectural Reconfiguration System with a CUSTOM TARDIS!"),
    ...
    BIOME_SET("The biome was set succesfully."),
    ...
    BOOK_RECEIVE("You just recieved the book of %s!"),
    ...
    CELL_TRANSFER("Energy transfered from Artron Storage Cell!"),
    ...
    CHAM_SET("Chameleon Preset set to "),
    ...
    EXILE_NO_SAVE("You exile status does not allow you to save the TARDIS to this location!"),
    EXILE_NO_TRAVEL("You exile status does not allow you to bring the TARDIS to this location!"),
    ...
    GARVITY_OWN_WORLD("You must be in your own TARDIS world to make a gravity well!"),
    GIVE_ITEM("%s just gave you %s %s"),
    GIVE_KIT("%s just gave you the TARDIS Item Kit %s"),
    GRAVITY_A_WORLD("You must be in a TARDIS world to make a gravity well!"),
    GRAVITY_CLICK("Click the wool block to %s."),
    ...
    HANDBRAKE_NEED_ENGAGE("You need to engage the handbrake!"),
    ...
    LAMP_NOT_NUMBER("The lamp item ID was not a number!"),
    ...
    LOC_SAVED("The specified location was saved succesfully."),
    LOC_SET("The specified location was set succesfully."),
    ...
    MATERIAL_NOT_VALID("That is not a valid Material! Try checking http://jd.bukkit.org/apidocs/org/bukkit/Material.html"),
    ...
    NOT_KEY("The TARDIS key is a %s. You have %s in your hand!"),
    ...
    NO_PERM_TEMPORAL("You do not have permission to create a Temporal Locator!"),
    ...
    PREV_SET("Previous location selected."),
    ...
    RASS_BLOCK("Blocking regeneration: %s"),
    RASS_COUNT("Regen count: %s"),
    RASS_REGEN("Regenerating: %s"),
    RASS_TL("Time Lord: %s"),
    ...
    RESCUE_REQUEST("%s wants to rescue you! Type: %s in chat within 60 seconds to accept the rescue."),
    ...
    ROOM_NOT_VALID("That is not a valid room type!"),
    ...
    TRAVEL_LOADED("%s location loaded succesfully."),
    ...
    UPDATE_INFO("You can update the postion of the following:"),
    ...
    Y_NOT_VALID("Y coordinate must be > 0!"),
    ZERO_DIABLED("This server does not allow Zero rooms!"),
