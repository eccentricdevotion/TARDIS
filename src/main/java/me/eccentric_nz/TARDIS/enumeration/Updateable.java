...
public enum Updateable {
    ...
    KITCHEN(false, false, Tag.COPPER_CHESTS.getValues(), TARDISUpdateableCategory.LOCATIONS, "Kitchen room food chest"),
    ...
    NAUTILUS(true, false, Tag.BUTTONS.getValues(), TARDISUpdateableCategory.OTHERS, "Nautilus room eject button"),
    ...
    SURGERY(false, false, Tag.COPPER_CHESTS.getValues(), TARDISUpdateableCategory.LOCATIONS, "Surgery room healing chest"),
    ...
    WASHING_MACHINE(true, false, Set.of(Material.QUARTZ_BLOCK), TARDISUpdateableCategory.OTHERS, "Washing Machine"),
