...
public enum PRESET {
    ...
    public boolean usesItemFrame() {
        return switch (this) {
            case POLICE_BOX_BLUE, POLICE_BOX_WHITE, POLICE_BOX_ORANGE, POLICE_BOX_MAGENTA, POLICE_BOX_LIGHT_BLUE, POLICE_BOX_YELLOW, POLICE_BOX_LIME, POLICE_BOX_PINK, POLICE_BOX_GRAY, POLICE_BOX_LIGHT_GRAY, POLICE_BOX_CYAN, POLICE_BOX_PURPLE, POLICE_BOX_BROWN, POLICE_BOX_GREEN, POLICE_BOX_RED, POLICE_BOX_BLACK, POLICE_BOX_TENNANT, WEEPING_ANGEL, ITEM -> true;
            default -> false;
        };
    }
    ...
    public boolean isBlockPreset() {
        return switch (this) {
            case ADAPTIVE, ANDESITE, ANGEL, APPERTURE, CAKE, CANDY, CHALICE, CHORUS, CREEPY, DESERT, DIORITE, DUCK, FACTORY, FENCE, FLOWER, GAZEBO, GRANITE, GRAVESTONE, HELIX, JAIL, JUNGLE, LAMP, LIBRARY, LIGHTHOUSE, MINESHAFT, NETHER, PANDORICA, PARTY, PEANUT, PINE, PORTAL, PRISMARINE, PUNKED, ROBOT, SHROOM, SNOWMAN, STONE, SUBMERGED, SWAMP, TELEPHONE, TOILET, TOPSYTURVEY, TORCH, VILLAGE, WELL, WINDMILL, YELLOW, CUSTOM -> true;
            default -> false;
        };
    }
}
