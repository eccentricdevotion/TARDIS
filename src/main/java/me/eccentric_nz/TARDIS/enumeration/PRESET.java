...
public enum PRESET {
	...
	PRESET(Material craftMaterial, String firstLine, String secondLine, boolean door, boolean portal) {
		...
		this.portal = portal;
		displayName =
				((this.firstLine.contains("_")) ? TARDISStringUtils.capitalise(this.firstLine) : TARDISStringUtils.titleCase(this.firstLine)) +
				(!this.secondLine.isEmpty() ? " " + TARDISStringUtils.titleCase(secondLine) : "");
	}
