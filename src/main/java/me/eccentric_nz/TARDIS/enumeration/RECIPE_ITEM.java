...
public enum RECIPE_ITEM {
    ...
    AUTHORISED_CONTROL_DISK(10000001),
    ...
    TIME_ROTOR_EARLY(10000002),
    TIME_ROTOR_TENTH(10000003),
    TIME_ROTOR_ELEVENTH(10000004),
    TIME_ROTOR_TWELFTH(10000005),
