...
import me.eccentric_nz.TARDIS.builders.exterior.InstantModelledPresetBuilder;
...
public class VortexPersister {
    ...
    public VortexPersister(TARDIS plugin) {
        this.plugin = plugin;
            ...
            while (rs.next()) {
                ...
                if (task < 0) {
                    ...
                    if (rs.resultSet()) {
                        ...
                        if (task == -1) {
                            ...
                            if (rsb.resultSet()) {
                                ...
                                new InstantPresetDestroyer(plugin).instaDestroyPreset(dd, false, tardis.getDemat());
                            }
                        }
                        ...
                        if (rsc.resultSet()) {
                            ...
                            if (tardis.getPreset().usesArmourStand()) {
                                new InstantModelledPresetBuilder(plugin, bd, tardis.getPreset()).buildPreset();
                            } else {
                                new InstantBlockPresetBuilder(plugin, bd, tardis.getPreset(), Material.LIGHT_GRAY_TERRACOTTA.createBlockData(), false).buildPreset();
                            }
                    ...
                    if (rsh.resultSet()) {
                        ...
                        new LoopingFlightSound(plugin, handbrake, id).run();
                        count++;
                    }
                }
            }
