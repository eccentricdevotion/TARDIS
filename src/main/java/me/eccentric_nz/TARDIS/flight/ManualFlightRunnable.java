 ...
 * @author eccentric_nz
 */
class ManualFlightRunnable implements Runnable {
    ...
    ManualFlightRunnable(TARDIS plugin, Player player, int id, boolean console) {
        this.plugin = plugin;
        this.player = player;
    ...
    public void run() {
        ...
        if (i < LOOPS) {
            ...
            loc.getWorld().playEffect(loc, Effect.DESTROY_BLOCK, 152);
