 ...
 * @author eccentric_nz
 */
public class JunkReturnRunnable implements Runnable {

    private final TARDIS plugin;
    private final long waitTime;

    public JunkReturnRunnable(TARDIS plugin) {
        this.plugin = plugin;
    ...
    public void run() {
        ...
        long lastUsed = new JunkReturnPersiter(plugin).getJunkTime();
        // get current time
        ...
        if (lastUsed + waitTime > now) {
            ...
            if (tjl.isNotHome()) {
                ...
                if (home != null) {
                    ...
                    // bring her home
                    new JunkReturn(plugin).recall(plugin.getConsole(), false);
                }
            }
        }
    }
