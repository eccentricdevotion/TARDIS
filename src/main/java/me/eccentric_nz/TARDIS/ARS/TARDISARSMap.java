...
public class TARDISARSMap {
    ...
    private ItemStack[] getItemStack() {
        ...
        up.displayName(Component.text(plugin.getLanguage().getString("BUTTON_UP")));
        ...
        down.displayName(Component.text(plugin.getLanguage().getString("BUTTON_DOWN")));
        ...
        left.displayName(Component.text(plugin.getLanguage().getString("BUTTON_LEFT")));
        ...
        right.displayName(Component.text(plugin.getLanguage().getString("BUTTON_RIGHT")));
        ...
        wool.displayName(Component.text(plugin.getLanguage().getString("BUTTON_MAP_ON")));
        ...
        der.displayName(Component.text(plugin.getLanguage().getString("BUTTON_MAP")));
        der.setItemModel(GUIMap.BUTTON_MAP.key());
        loa.setItemMeta(der);
        // close
        ItemStack close = new ItemStack(GUIMap.BUTTON_CLOSE.material(), 1);
        ItemMeta gui = close.getItemMeta();
        gui.displayName(Component.text(plugin.getLanguage().getString("BUTTON_CLOSE")));
