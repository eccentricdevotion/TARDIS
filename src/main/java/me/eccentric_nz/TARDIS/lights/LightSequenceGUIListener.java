...
public class LightSequenceGUIListener extends TARDISMenuListener {
    ...
    public LightSequenceGUIListener(TARDIS plugin) {
        super(plugin);
        this.plugin = plugin;
    }
    ...
    public void onLightMenuClick(InventoryClickEvent event) {
        ...
        if (!(event.getInventory().getHolder(false) instanceof LightSequenceInventory)) {
            return;
        }
                ...
                switch (slot) {
                    ...
                    case 42 -> {
                        ...
                        if (rst.fromUUID(uuid.toString())) {
                            player.openInventory(new LightsInventory(plugin, rst.getTardisId(), uuid).getInventory());
                        }
                    }
                    // close
