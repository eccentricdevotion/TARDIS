...
public class TARDISLightLevelsInventory {
    ...
    private ItemStack[] getItemStack() {
        ...
        iiim.lore(List.of("Set the light level", "of the interior lights"));
        ...
        inim.lore(List.of(interior_level));
        ...
        eiim.lore(List.of("Set the light level", "of the exterior lamp"));
        ...
        exim.lore(List.of(exterior_level));
        ...
        ciim.lore(List.of("Set the light level", "of the console lamp"));
        ...
        lamp.lore(List.of(console_level));
