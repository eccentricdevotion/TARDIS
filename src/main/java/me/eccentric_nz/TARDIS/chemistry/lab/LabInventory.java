...
public class LabInventory {
    ...
    private ItemStack[] getItemStack() {
        ...
        info_im.setLore(Arrays.asList("Combine elements and compounds", "to create bleach, ice bombs", "heat blocks and fertiliser.", "To see a lab table formula", "use the " + ChatColor.GREEN + ChatColor.ITALIC + "/formula" + ChatColor.DARK_PURPLE + ChatColor.ITALIC + " command.", "Place items in the bottom", "row from left to right."));
