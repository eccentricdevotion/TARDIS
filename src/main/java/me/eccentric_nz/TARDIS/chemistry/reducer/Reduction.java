...
public enum Reduction {
    ...
    Emerald(Material.EMERALD, "Beryllium:25-Aluminium:15-Oxygen:40-Silicon:20"),
    ...
    Lapis_Lazuli(Material.LAPIS_LAZULI, "Sodium:13-Sulfur:8-Aluminium:13-Oxygen:53-Silicon:13"),
