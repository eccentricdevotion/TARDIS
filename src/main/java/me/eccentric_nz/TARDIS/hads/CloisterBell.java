 ...
 */
public class CloisterBell implements Runnable {
     ...
     */
    public CloisterBell(TARDIS plugin, int loops, int id) {
        this.plugin = plugin;
        this.loops = loops;
        this.id = id;
        centre = getCentre(id);
    ...
    public CloisterBell(TARDIS plugin, int loops, int id, Player player) {
        this.plugin = plugin;
        this.loops = loops;
        this.id = id;
        centre = getCentre(id);
    ...
    CloisterBell(TARDIS plugin, int loops, int id, Location current, Player player, String reason) {
        this.plugin = plugin;
        this.loops = loops;
        this.id = id;
        centre = getCentre(id);
    ...
    public CloisterBell(TARDIS plugin, int loops, int id, Location current, Player player, boolean messageOn, String reason, boolean messageOff) {
        this.plugin = plugin;
        this.loops = loops;
        this.id = id;
        centre = getCentre(id);
