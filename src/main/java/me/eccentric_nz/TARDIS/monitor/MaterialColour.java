...
public enum MaterialColour {
    ...
    ACACIA_SHELF(new Color(216, 127, 51)),
    ...
    BAMBOO_SHELF(new Color(229, 229, 51)),
    ...
    BIRCH_SHELF(new Color(247, 233, 163)),
    ...
    BLACK_CONCRETE_SLAB(new Color(25, 25, 25)),
    BLACK_CONCRETE_STAIRS(new Color(25, 25, 25)),
    ...
    BLACK_WOOL_SLAB(new Color(25, 25, 25)),
    BLACK_WOOL_STAIRS(new Color(25, 25, 25)),
    ...
    BLUE_CONCRETE_SLAB(new Color(51, 76, 178)),
    BLUE_CONCRETE_STAIRS(new Color(51, 76, 178)),
    ...
    BLUE_WOOL_SLAB(new Color(51, 76, 178)),
    BLUE_WOOL_STAIRS(new Color(51, 76, 178)),
    ...
    BROWN_CONCRETE_SLAB(new Color(102, 76, 51)),
    BROWN_CONCRETE_STAIRS(new Color(102, 76, 51)),
    ...
    BROWN_WOOL_SLAB(new Color(102, 76, 51)),
    BROWN_WOOL_STAIRS(new Color(102, 76, 51)),
    ...
    BUSH(new Color(0, 124, 0)),
    CACTUS(new Color(0, 124, 0)),
    CACTUS_FLOWER(new Color(242, 127, 165)),
    CAKE(new Color(0, 0, 0)),
    CALCITE(new Color(209, 177, 161)),
    CALIBRATED_SCULK_SENSOR(new Color(76, 127, 153)),
    ...
    CHERRY_BUTTON(new Color(209, 177, 161)),
    CHERRY_DOOR(new Color(209, 177, 161)),
    CHERRY_FENCE(new Color(209, 177, 161)),
    CHERRY_FENCE_GATE(new Color(209, 177, 161)),
    CHERRY_HANGING_SIGN(new Color(160, 77, 78)),
    CHERRY_LEAVES(new Color(242, 127, 165)),
    CHERRY_LOG(new Color(209, 177, 161)),
    CHERRY_PLANKS(new Color(209, 177, 161)),
    CHERRY_PRESSURE_PLATE(new Color(209, 177, 161)),
    CHERRY_SAPLING(new Color(242, 127, 165)),
    CHERRY_SHELF(new Color(209, 177, 161)),
    CHERRY_SIGN(new Color(209, 177, 161)),
    CHERRY_SLAB(new Color(209, 177, 161)),
    CHERRY_STAIRS(new Color(209, 177, 161)),
    CHERRY_TRAPDOOR(new Color(209, 177, 161)),
    CHERRY_WALL_HANGING_SIGN(new Color(160, 77, 78)),
    CHERRY_WALL_SIGN(new Color(209, 177, 161)),
    CHERRY_WOOD(new Color(57, 41, 35)),
    CHEST(new Color(143, 119, 72)),
    CHIPPED_ANVIL(new Color(167, 167, 167)),
    CHISELED_BOOKSHELF(new Color(143, 119, 72)),
    CHISELED_CINNABAR(new Color(153, 51, 51)),
    CHISELED_COPPER(new Color(216, 127, 51)),
    ...
    CHISELED_RESIN_BRICKS(new Color(159, 82, 36)),
    CHISELED_SANDSTONE(new Color(247, 233, 163)),
    CHISELED_STONE_BRICKS(new Color(112, 112, 112)),
    CHISELED_SULFUR(new Color(229, 229, 51)),
    CHISELED_TUFF(new Color(57, 41, 35)),
    CHISELED_TUFF_BRICKS(new Color(57, 41, 35)),
    CHORUS_FLOWER(new Color(127, 63, 178)),
    CHORUS_PLANT(new Color(127, 63, 178)),
    CINNABAR(new Color(153, 51, 51)),
    CINNABAR_BRICKS(new Color(153, 51, 51)),
    CINNABAR_BRICK_SLAB(new Color(153, 51, 51)),
    CINNABAR_BRICK_STAIRS(new Color(153, 51, 51)),
    CINNABAR_BRICK_WALL(new Color(153, 51, 51)),
    CINNABAR_SLAB(new Color(153, 51, 51)),
    CINNABAR_STAIRS(new Color(153, 51, 51)),
    CINNABAR_WALL(new Color(153, 51, 51)),
    CLAY(new Color(164, 168, 184)),
    CLOSED_EYEBLOSSOM(new Color(167, 167, 167)),
    ...
    COPPER_BARS(new Color(216, 127, 51)),
    COPPER_BLOCK(new Color(216, 127, 51)),
    COPPER_BULB(new Color(216, 127, 51)),
    COPPER_CHAIN(new Color(216, 127, 51)),
    COPPER_CHEST(new Color(216, 127, 51)),
    COPPER_DOOR(new Color(216, 127, 51)),
    COPPER_GOLEM_STATUE(new Color(216, 127, 51)),
    COPPER_GRATE(new Color(216, 127, 51)),
    COPPER_LANTERN(new Color(216, 127, 51)),
    COPPER_ORE(new Color(112, 112, 112)),
    COPPER_TORCH(new Color(216, 127, 51)),
    COPPER_TRAPDOOR(new Color(216, 127, 51)),
    COPPER_WALL_TORCH(new Color(216, 127, 51)),
    ...
    CRAFTER(new Color(112, 112, 112)),
    CRAFTING_TABLE(new Color(143, 119, 72)),
    CREAKING_HEART(new Color(216, 127, 51)),
    ...
    CRIMSON_SHELF(new Color(148, 63, 97)),
    ...
    CYAN_CONCRETE_SLAB(new Color(76, 127, 153)),
    CYAN_CONCRETE_STAIRS(new Color(76, 127, 153)),
    ...
    CYAN_WOOL_SLAB(new Color(76, 127, 153)),
    CYAN_WOOL_STAIRS(new Color(76, 127, 153)),
    ...
    DARK_OAK_SHELF(new Color(102, 76, 51)),
    ...
    DECORATED_POT(new Color(142, 60, 46)),
    ...
    DRAGON_WALL_HEAD(new Color(25, 25, 250)),
    DRIED_GHAST(new Color(76, 76, 76)),
    ...
    EXPOSED_CHISELED_COPPER(new Color(135, 107, 98)),
    EXPOSED_COPPER(new Color(135, 107, 98)),
    EXPOSED_COPPER_BARS(new Color(135, 107, 98)),
    EXPOSED_COPPER_BULB(new Color(135, 107, 98)),
    EXPOSED_COPPER_CHAIN(new Color(135, 107, 98)),
    EXPOSED_COPPER_CHEST(new Color(135, 107, 98)),
    EXPOSED_COPPER_DOOR(new Color(135, 107, 98)),
    EXPOSED_COPPER_GOLEM_STATUE(new Color(135, 107, 98)),
    EXPOSED_COPPER_GRATE(new Color(135, 107, 98)),
    EXPOSED_COPPER_LANTERN(new Color(135, 107, 98)),
    EXPOSED_COPPER_TRAPDOOR(new Color(135, 107, 98)),
    ...
    FLOWER_POT(new Color(135, 107, 98)),
    ...
    GOLDEN_DANDELION(new Color(250, 238, 77)),
    ...
    GRAY_CONCRETE_SLAB(new Color(76, 76, 76)),
    GRAY_CONCRETE_STAIRS(new Color(76, 76, 76)),
    ...
    GRAY_WOOL_SLAB(new Color(76, 76, 76)),
    GRAY_WOOL_STAIRS(new Color(76, 76, 76)),
    ...
    GREEN_CONCRETE_SLAB(new Color(102, 127, 51)),
    GREEN_CONCRETE_STAIRS(new Color(102, 127, 51)),
    ...
    GREEN_WOOL_SLAB(new Color(102, 127, 51)),
    GREEN_WOOL_STAIRS(new Color(102, 127, 51)),
    GRINDSTONE(new Color(167, 167, 167)),
    HANGING_ROOTS(new Color(151, 109, 77)),
    HAY_BLOCK(new Color(229, 229, 51)),
    HEAVY_CORE(new Color(167, 167, 167)),
    ...
    JUNGLE_SHELF(new Color(151, 109, 77)),
    ...
    LEAF_LITTER(new Color(102, 76, 51)),
    ...
    LIGHT_BLUE_CONCRETE_SLAB(new Color(102, 153, 216)),
    LIGHT_BLUE_CONCRETE_STAIRS(new Color(102, 153, 216)),
    ...
    LIGHT_BLUE_WOOL_SLAB(new Color(102, 153, 216)),
    LIGHT_BLUE_WOOL_STAIRS(new Color(102, 153, 216)),
    ...
    LIGHT_GRAY_CONCRETE_SLAB(new Color(153, 153, 153)),
    LIGHT_GRAY_CONCRETE_STAIRS(new Color(153, 153, 153)),
    ...
    LIGHT_GRAY_WOOL_SLAB(new Color(153, 153, 153)),
    LIGHT_GRAY_WOOL_STAIRS(new Color(153, 153, 153)),
    ...
    LIME_CONCRETE_SLAB(new Color(127, 204, 25)),
    LIME_CONCRETE_STAIRS(new Color(127, 204, 25)),
    ...
    LIME_WOOL_SLAB(new Color(127, 204, 25)),
    LIME_WOOL_STAIRS(new Color(127, 204, 25)),
    ...
    MAGENTA_CONCRETE_SLAB(new Color(178, 76, 216)),
    MAGENTA_CONCRETE_STAIRS(new Color(178, 76, 216)),
    ...
    MAGENTA_WOOL_SLAB(new Color(178, 76, 216)),
    MAGENTA_WOOL_STAIRS(new Color(178, 76, 216)),
    ...
    MANGROVE_SHELF(new Color(153, 51, 51)),
    ...
    OAK_SHELF(new Color(143, 119, 72)),
    ...
    OPEN_EYEBLOSSOM(new Color(216, 127, 51)),
    ...
    ORANGE_CONCRETE_SLAB(new Color(216, 127, 51)),
    ORANGE_CONCRETE_STAIRS(new Color(216, 127, 51)),
    ORANGE_GLAZED_TERRACOTTA(new Color(216, 127, 51)),
    ORANGE_POPLAR_LEAVES(new Color(216, 127, 51)),
    ...
    ORANGE_WOOL_SLAB(new Color(216, 127, 51)),
    ORANGE_WOOL_STAIRS(new Color(216, 127, 51)),
    OXEYE_DAISY(new Color(0, 124, 0)),
    OXIDIZED_CHISELED_COPPER(new Color(22, 126, 134)),
    OXIDIZED_COPPER(new Color(22, 126, 134)),
    OXIDIZED_COPPER_BARS(new Color(22, 126, 13)),
    OXIDIZED_COPPER_BULB(new Color(22, 126, 134)),
    OXIDIZED_COPPER_CHAIN(new Color(22, 126, 13)),
    OXIDIZED_COPPER_CHEST(new Color(22, 126, 134)),
    OXIDIZED_COPPER_DOOR(new Color(22, 126, 134)),
    OXIDIZED_COPPER_GOLEM_STATUE(new Color(22, 126, 134)),
    OXIDIZED_COPPER_GRATE(new Color(22, 126, 134)),
    OXIDIZED_COPPER_LANTERN(new Color(22, 126, 134)),
    OXIDIZED_COPPER_TRAPDOOR(new Color(22, 126, 134)),
    ...
    OXIDIZED_LIGHTNING_ROD(new Color(22, 126, 134)),
    PACKED_ICE(new Color(160, 160, 255)),
    PACKED_MUD(new Color(151, 109, 77)),
    PALE_HANGING_MOSS(new Color(153, 153, 153)),
    PALE_MOSS_BLOCK(new Color(108, 116, 108)),
    PALE_MOSS_CARPET(new Color(108, 116, 108)),
    PALE_OAK_BUTTON(new Color(252, 246, 246)),
    PALE_OAK_DOOR(new Color(252, 246, 246)),
    PALE_OAK_FENCE(new Color(252, 246, 246)),
    PALE_OAK_FENCE_GATE(new Color(252, 246, 246)),
    PALE_OAK_HANGING_SIGN(new Color(255, 252, 245)),
    PALE_OAK_LEAVES(new Color(125, 119, 111)),
    PALE_OAK_LOG(new Color(92, 84, 84)),
    PALE_OAK_PLANKS(new Color(252, 246, 246)),
    PALE_OAK_PRESSURE_PLATE(new Color(255, 252, 245)),
    PALE_OAK_SAPLING(new Color(125, 119, 111)),
    PALE_OAK_SHELF(new Color(252, 246, 246)),
    PALE_OAK_SIGN(new Color(252, 246, 246)),
    PALE_OAK_SLAB(new Color(252, 246, 2465)),
    PALE_OAK_STAIRS(new Color(252, 246, 246)),
    PALE_OAK_TRAPDOOR(new Color(252, 246, 246)),
    PALE_OAK_WALL_HANGING_SIGN(new Color(252, 246, 246)),
    PALE_OAK_WALL_SIGN(new Color(252, 246, 246)),
    PALE_OAK_WOOD(new Color(112, 112, 112)),
    ...
    PINK_CONCRETE_SLAB(new Color(242, 127, 165)),
    PINK_CONCRETE_STAIRS(new Color(242, 127, 165)),
    PINK_GLAZED_TERRACOTTA(new Color(242, 127, 165)),
    PINK_PETALS(new Color(0, 124, 0)),
    ...
    PINK_WOOL_SLAB(new Color(242, 127, 165)),
    PINK_WOOL_STAIRS(new Color(242, 127, 165)),
    PISTON(new Color(112, 112, 112)),
    PISTON_HEAD(new Color(112, 112, 112)),
    PITCHER_CROP(new Color(0, 124, 0)),
    PITCHER_PLANT(new Color(0, 124, 0)),
    ...
    POLISHED_CINNABAR(new Color(153, 51, 51)),
    POLISHED_CINNABAR_SLAB(new Color(153, 51, 51)),
    POLISHED_CINNABAR_STAIRS(new Color(153, 51, 51)),
    POLISHED_CINNABAR_WALL(new Color(153, 51, 51)),
    ...
    POLISHED_SULFUR(new Color(229, 229, 51)),
    POLISHED_SULFUR_SLAB(new Color(229, 229, 51)),
    POLISHED_SULFUR_STAIRS(new Color(229, 229, 51)),
    POLISHED_SULFUR_WALL(new Color(229, 229, 51)),
    POLISHED_TUFF(new Color(57, 41, 35)),
    POLISHED_TUFF_SLAB(new Color(57, 41, 35)),
    POLISHED_TUFF_STAIRS(new Color(57, 41, 35)),
    POLISHED_TUFF_WALL(new Color(57, 41, 35)),
    POPLAR_BUTTON(new Color(153, 153, 153)),
    POPLAR_DOOR(new Color(153, 153, 153)),
    POPLAR_FENCE(new Color(153, 153, 153)),
    POPLAR_FENCE_GATE(new Color(153, 153, 153)),
    POPLAR_HANGING_SIGN(new Color(153, 153, 153)),
    POPLAR_LOG(new Color(153, 153, 153)),
    POPLAR_PLANKS(new Color(153, 153, 153)),
    POPLAR_PRESSURE_PLATE(new Color(153, 153, 153)),
    POPLAR_SAPLING(new Color(167, 167, 167)),
    POPLAR_SHELF(new Color(153, 153, 153)),
    POPLAR_SIGN(new Color(153, 153, 153)),
    POPLAR_SLAB(new Color(153, 153, 153)),
    POPLAR_STAIRS(new Color(153, 153, 153)),
    POPLAR_TRAPDOOR(new Color(153, 153, 153)),
    POPLAR_WALL_HANGING_SIGN(new Color(153, 153, 153)),
    POPLAR_WALL_SIGN(new Color(153, 153, 153)),
    POPLAR_WOOD(new Color(129, 86, 49)),
    POPPY(new Color(0, 124, 0)),
    POTATOES(new Color(0, 124, 0)),
    POTENT_SULFUR(new Color(250, 238, 77)),
    ...
    POTTED_CHERRY_SAPLING(new Color(0, 124, 0)),
    POTTED_CLOSED_EYEBLOSSOM(new Color(0, 124, 0)),
    ...
    POTTED_GOLDEN_DANDELION(new Color(0, 124, 0)),
    ...
    POTTED_OPEN_EYEBLOSSOM(new Color(0, 0, 0)),
    POTTED_ORANGE_TULIP(new Color(0, 124, 0)),
    POTTED_OXEYE_DAISY(new Color(0, 124, 0)),
    POTTED_PALE_OAK_SAPLING(new Color(0, 0, 0)),
    POTTED_PINK_TULIP(new Color(0, 124, 0)),
    POTTED_POPLAR_SAPLING(new Color(0, 124, 0)),
    ...
    POTTED_TORCHFLOWER(new Color(0, 124, 0)),
    POTTED_WARPED_FUNGUS(new Color(76, 127, 15)),
    POTTED_WARPED_ROOTS(new Color(76, 127, 15)),
    ...
    PURPLE_CONCRETE_SLAB(new Color(127, 63, 178)),
    PURPLE_CONCRETE_STAIRS(new Color(127, 63, 178)),
    ...
    PURPLE_WOOL_SLAB(new Color(127, 63, 178)),
    PURPLE_WOOL_STAIRS(new Color(127, 63, 178)),
    ...
    RED_CONCRETE_SLAB(new Color(153, 51, 51)),
    RED_CONCRETE_STAIRS(new Color(153, 51, 51)),
    ...
    RED_POPLAR_LEAVES(new Color(153, 51, 51)),
    ...
    RED_WOOL_SLAB(new Color(153, 51, 51)),
    RED_WOOL_STAIRS(new Color(153, 51, 51)),
    REINFORCED_DEEPSLATE(new Color(100, 100, 100)),
    REPEATER(Color.lightGray),
    REPEATING_COMMAND_BLOCK(new Color(127, 63, 178)),
    RESIN_BLOCK(new Color(159, 82, 36)),
    RESIN_BRICKS(new Color(159, 82, 36)),
    RESIN_BRICK_SLAB(new Color(159, 82, 36)),
    RESIN_BRICK_STAIRS(new Color(159, 82, 36)),
    RESIN_BRICK_WALL(new Color(159, 82, 36)),
    RESIN_CLUMP(new Color(159, 82, 36)),
    ...
    SHELF_MUSHROOM(new Color(186, 133, 36)),
    SHORT_DRY_GRASS(new Color(229, 229, 51)),
    ...
    SNIFFER_EGG(new Color(153, 51, 51)),
    ...
    SPRUCE_SHELF(new Color(129, 86, 49)),
    ...
    STRAW_BED(new Color(229, 229, 51)),
    ...
    STRIPPED_CHERRY_LOG(new Color(209, 177, 161)),
    STRIPPED_CHERRY_WOOD(new Color(160, 77, 78)),
    ...
    STRIPPED_PALE_OAK_LOG(new Color(255, 252, 245)),
    STRIPPED_PALE_OAK_WOOD(new Color(255, 252, 245)),
    STRIPPED_POPLAR_LOG(new Color(153, 153, 153)),
    STRIPPED_POPLAR_WOOD(new Color(153, 153, 153)),
    ...
    SULFUR(new Color(229, 229, 51)),
    SULFUR_BRICKS(new Color(229, 229, 51)),
    SULFUR_BRICK_SLAB(new Color(229, 229, 51)),
    SULFUR_BRICK_STAIRS(new Color(229, 229, 51)),
    SULFUR_BRICK_WALL(new Color(229, 229, 51)),
    SULFUR_SLAB(new Color(229, 229, 51)),
    SULFUR_SPIKE(new Color(229, 229, 51)),
    SULFUR_STAIRS(new Color(229, 229, 51)),
    SULFUR_WALL(new Color(229, 229, 51)),
    SUNFLOWER(new Color(0, 124, 0)),
    SUSPICIOUS_GRAVEL(new Color(112, 112, 112)),
    SUSPICIOUS_SAND(new Color(247, 233, 163)),
    SWEET_BERRY_BUSH(new Color(0, 124, 0)),
    TALL_DRY_GRASS(new Color(229, 229, 51)),
    TALL_GRASS(new Color(0, 124, 0)),
    TALL_SEAGRASS(new Color(64, 64, 255)),
    TARGET(new Color(255, 252, 245)),
    TERRACOTTA(new Color(216, 127, 51)),
    TEST_BLOCK(new Color(153, 153, 153)),
    TEST_INSTANCE_BLOCK(new Color(0, 0, 0)),
    TINTED_GLASS(new Color(76, 76, 76)),
    TNT(new Color(255, 0, 0)),
    TORCH(new Color(229, 229, 51)),
    TORCHFLOWER(new Color(0, 124, 0)),
    TORCHFLOWER_CROP(new Color(0, 124, 0)),
    TRAPPED_CHEST(new Color(143, 119, 72)),
    TRIAL_SPAWNER(new Color(112, 112, 112)),
    ...
    TUFF_BRICKS(new Color(57, 41, 35)),
    TUFF_BRICK_SLAB(new Color(57, 41, 35)),
    TUFF_BRICK_STAIRS(new Color(57, 41, 35)),
    TUFF_BRICK_WALL(new Color(57, 41, 35)),
    TUFF_SLAB(new Color(57, 41, 35)),
    TUFF_STAIRS(new Color(57, 41, 35)),
    TUFF_WALL(new Color(57, 41, 35)),
    TURTLE_EGG(new Color(247, 233, 163)),
    TWISTING_VINES(new Color(76, 127, 153)),
    TWISTING_VINES_PLANT(new Color(76, 127, 153)),
    VAULT(new Color(112, 112, 112)),
    ...
    WARPED_SHELF(new Color(58, 142, 140)),
    ...
    WAXED_CHISELED_COPPER(new Color(216, 127, 51)),
    WAXED_COPPER_BARS(new Color(216, 127, 51)),
    WAXED_COPPER_BLOCK(new Color(216, 127, 51)),
    WAXED_COPPER_BULB(new Color(216, 127, 51)),
    WAXED_COPPER_CHAIN(new Color(216, 127, 51)),
    WAXED_COPPER_CHEST(new Color(216, 127, 51)),
    WAXED_COPPER_DOOR(new Color(216, 127, 51)),
    WAXED_COPPER_GOLEM_STATUE(new Color(216, 127, 51)),
    WAXED_COPPER_GRATE(new Color(216, 127, 51)),
    WAXED_COPPER_LANTERN(new Color(216, 127, 51)),
    WAXED_COPPER_TRAPDOOR(new Color(216, 127, 51)),
    ...
    WAXED_EXPOSED_CHISELED_COPPER(new Color(135, 107, 98)),
    WAXED_EXPOSED_COPPER(new Color(135, 107, 98)),
    WAXED_EXPOSED_COPPER_BARS(new Color(135, 107, 98)),
    WAXED_EXPOSED_COPPER_BULB(new Color(135, 107, 98)),
    WAXED_EXPOSED_COPPER_CHAIN(new Color(135, 107, 98)),
    WAXED_EXPOSED_COPPER_CHEST(new Color(135, 107, 98)),
    WAXED_EXPOSED_COPPER_DOOR(new Color(135, 107, 98)),
    WAXED_EXPOSED_COPPER_GOLEM_STATUE(new Color(135, 107, 98)),
    WAXED_EXPOSED_COPPER_GRATE(new Color(135, 107, 98)),
    WAXED_EXPOSED_COPPER_LANTERN(new Color(135, 107, 98)),
    WAXED_EXPOSED_COPPER_TRAPDOOR(new Color(135, 107, 98)),
    ...
    WAXED_EXPOSED_LIGHTNING_ROD(new Color(135, 107, 98)),
    WAXED_LIGHTNING_ROD(new Color(216, 127, 51)),
    WAXED_OXIDIZED_CHISELED_COPPER(new Color(22, 126, 134)),
    WAXED_OXIDIZED_COPPER(new Color(22, 126, 134)),
    WAXED_OXIDIZED_COPPER_BARS(new Color(22, 126, 134)),
    WAXED_OXIDIZED_COPPER_BULB(new Color(22, 126, 134)),
    WAXED_OXIDIZED_COPPER_CHAIN(new Color(22, 126, 134)),
    WAXED_OXIDIZED_COPPER_CHEST(new Color(22, 126, 134)),
    WAXED_OXIDIZED_COPPER_DOOR(new Color(22, 126, 134)),
    WAXED_OXIDIZED_COPPER_GOLEM_STATUE(new Color(22, 126, 134)),
    WAXED_OXIDIZED_COPPER_GRATE(new Color(22, 126, 134)),
    WAXED_OXIDIZED_COPPER_LANTERN(new Color(22, 126, 134)),
    WAXED_OXIDIZED_COPPER_TRAPDOOR(new Color(22, 126, 134)),
    ...
    WAXED_OXIDIZED_LIGHTNING_ROD(new Color(22, 126, 134)),
    WAXED_WEATHERED_CHISELED_COPPER(new Color(58, 142, 140)),
    WAXED_WEATHERED_COPPER(new Color(58, 142, 140)),
    WAXED_WEATHERED_COPPER_BARS(new Color(58, 142, 140)),
    WAXED_WEATHERED_COPPER_BULB(new Color(58, 142, 140)),
    WAXED_WEATHERED_COPPER_CHAIN(new Color(58, 142, 140)),
    WAXED_WEATHERED_COPPER_CHEST(new Color(58, 142, 140)),
    WAXED_WEATHERED_COPPER_DOOR(new Color(58, 142, 140)),
    WAXED_WEATHERED_COPPER_GOLEM_STATUE(new Color(58, 142, 140)),
    WAXED_WEATHERED_COPPER_GRATE(new Color(58, 142, 140)),
    WAXED_WEATHERED_COPPER_LANTERN(new Color(58, 142, 140)),
    WAXED_WEATHERED_COPPER_TRAPDOOR(new Color(58, 142, 140)),
    ...
    WAXED_WEATHERED_LIGHTNING_ROD(new Color(58, 142, 140)),
    WEATHERED_CHISELED_COPPER(new Color(58, 142, 140)),
    WEATHERED_COPPER(new Color(58, 142, 140)),
    WEATHERED_COPPER_BARS(new Color(58, 142, 140)),
    WEATHERED_COPPER_BULB(new Color(58, 142, 140)),
    WEATHERED_COPPER_CHAIN(new Color(58, 142, 140)),
    WEATHERED_COPPER_CHEST(new Color(58, 142, 140)),
    WEATHERED_COPPER_DOOR(new Color(58, 142, 140)),
    WEATHERED_COPPER_GOLEM_STATUE(new Color(58, 142, 140)),
    WEATHERED_COPPER_GRATE(new Color(58, 142, 140)),
    WEATHERED_COPPER_LANTERN(new Color(58, 142, 140)),
    WEATHERED_COPPER_TRAPDOOR(new Color(58, 142, 140)),
    ...
    WEATHERED_LIGHTNING_ROD(new Color(58, 142, 140)),
    ...
    WHITE_CONCRETE_SLAB(new Color(255, 255, 255)),
    WHITE_CONCRETE_STAIRS(new Color(255, 255, 255)),
    ...
    WHITE_WOOL_SLAB(new Color(255, 255, 255)),
    WHITE_WOOL_STAIRS(new Color(255, 255, 255)),
    WILDFLOWERS(new Color(0, 124, 0)),
    ...
    YELLOW_CONCRETE_SLAB(new Color(229, 229, 51)),
    YELLOW_CONCRETE_STAIRS(new Color(229, 229, 51)),
    YELLOW_GLAZED_TERRACOTTA(new Color(229, 229, 51)),
    YELLOW_POPLAR_LEAVES(new Color(229, 229, 51)),
    ...
    YELLOW_WOOL_SLAB(new Color(229, 229, 51)),
    YELLOW_WOOL_STAIRS(new Color(229, 229, 51)),
