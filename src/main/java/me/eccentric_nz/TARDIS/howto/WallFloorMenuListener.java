 ...
 * @author eccentric_nz
 */
public class WallFloorMenuListener extends TARDISMenuListener {
    ...
    public WallFloorMenuListener(TARDIS plugin) {
        super(plugin);
        this.plugin = plugin;
    ...
    public void onWallFloorMenuOpen(InventoryOpenEvent event) {
        if (event.getInventory().getHolder(false) instanceof HowtoWallsInventory) {
