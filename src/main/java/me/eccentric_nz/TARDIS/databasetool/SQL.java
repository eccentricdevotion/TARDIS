...
public class SQL {
    ...
    public static final List<String> CREATES = Arrays.asList(
            ...
            "CREATE TABLE IF NOT EXISTS %sfarming (farm_id int(11) NOT NULL AUTO_INCREMENT, tardis_id int(11) DEFAULT '0', aquarium varchar(512) DEFAULT '', birdcage varchar(512) DEFAULT '', farm varchar(512) DEFAULT '', hutch varchar(512) DEFAULT '', igloo varchar(512) DEFAULT '', stable varchar(512) DEFAULT '', stall varchar(512) DEFAULT '', village varchar(512) DEFAULT '', PRIMARY KEY (farm_id)) DEFAULT CHARSET=utf8 COLLATE utf8_general_ci;",
    ...
    public static final List<String> INSERTS = Arrays.asList(
            ...
            "INSERT INTO `%sfarming` (`farm_id`, `tardis_id`, `aquarium`, `birdcage`, `farm`, `hutch`, `igloo`, `stable`, `stall`, `village`) VALUES",
