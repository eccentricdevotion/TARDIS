...
public class SQL {
    ...
    public static final List<String> CREATES = Arrays.asList(
            ...
            "CREATE TABLE IF NOT EXISTS %sdispersed (d_id int(11) NOT NULL AUTO_INCREMENT, uuid varchar(48) DEFAULT '', world varchar(64) DEFAULT '', x int(7) DEFAULT '0', y int(3) DEFAULT '0', z int(7) DEFAULT '0', PRIMARY KEY (d_id)) DEFAULT CHARSET=utf8 COLLATE utf8_general_ci;",
            ...
            "CREATE TABLE IF NOT EXISTS %sjunk (id int(11) NOT NULL AUTO_INCREMENT, uuid varchar(48) DEFAULT '', tardis_id int(11) DEFAULT '0', location varchar(512) DEFAULT '', wall varchar(64) DEFAULT 'ORANGE_WOOL', floor varchar(64) DEFAULT 'LIGHT_GREY_WOOL', preset varchar(32) DEFAULT '', PRIMARY KEY (id)) DEFAULT CHARSET=utf8 COLLATE utf8_general_ci;",
    ...
    public static final List<String> INSERTS = Arrays.asList(
            ...
            "INSERT INTO `%sdispersed` (`d_id`, `uuid`, `world`, `x`, `y`, `z`) VALUES",
            ...
            "INSERT INTO `%sjunk` (`id`, `uuid`, `tardis_id`, `location`, `wall`, `floor`, `preset`) VALUES",
