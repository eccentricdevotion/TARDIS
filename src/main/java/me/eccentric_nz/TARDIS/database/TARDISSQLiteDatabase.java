...
public class TARDISSQLiteDatabase {
    ...
    public void createTables() {
        ...
        try {
            ...
            String queryParticlePrefs = "CREATE TABLE IF NOT EXISTS " + prefix + "particle_prefs (pp_id INTEGER PRIMARY KEY NOT NULL, uuid TEXT DEFAULT '', effect TEXT DEFAULT 'ASH', shape TEXT DEFAULT 'RANDOM', speed REAL DEFAULT 0.0, particles_on INTEGER DEFAULT 0)";
