...
public class SQL {
    ...
    public static final List<String> CREATES = Arrays.asList(
            ...
            "CREATE TABLE IF NOT EXISTS %sparticle_prefs (pp_id int(11) NOT NULL AUTO_INCREMENT, uuid varchar(48) DEFAULT '', `effect` varchar(32) DEFAULT 'ASH', `shape` varchar(32) DEFAULT 'RANDOM', `speed` float DEFAULT '0.0', particles_on int(1) DEFAULT '0', PRIMARY KEY (pp_id)) DEFAULT CHARSET=utf8 COLLATE utf8_general_ci;",
    ...
    static final List<String> INSERTS = Arrays.asList(
            ...
            "INSERT INTO `%sparticle_prefs` (`pp_id`, `uuid`, `effect`, `shape`, `speed`, `particles_on`) VALUES ",
