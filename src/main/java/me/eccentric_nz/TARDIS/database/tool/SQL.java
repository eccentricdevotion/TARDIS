...
public class SQL {
    ...
    public static final List<String> CREATES = List.of(
            ...
            "CREATE TABLE IF NOT EXISTS %sstorage (storage_id int(11) NOT NULL AUTO_INCREMENT, tardis_id int(11) DEFAULT '0', uuid varchar(48) DEFAULT '', owner varchar(32) DEFAULT '', saves_one text NULL, saves_two text NULL, areas text NULL, presets_one text NULL, presets_two text NULL, biomes_one text NULL, biomes_two text NULL, players text NULL, circuits text NULL, console text DEFAULT 'rO0ABXcEAAAAEnBwcHBwcHBwcHBwcHBwcHBwcA==', versions varchar(24) DEFAULT '0,0,0,0,0,0,0,0,0', PRIMARY KEY (storage_id)) DEFAULT CHARSET=utf8 COLLATE utf8_general_ci;",
