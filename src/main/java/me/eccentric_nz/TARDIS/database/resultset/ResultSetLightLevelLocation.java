 ...
 * @author eccentric_nz
 */
public class ResultSetLightLevelLocation {
     ...
     * @param id     the TARDIS id to look for switch controls
     */
    public ResultSetLightLevelLocation(TARDIS plugin, int id, int which) {
        this.plugin = plugin;
        this.id = id;
        this.which = which;
    ...
    public boolean resultSet() {
        ...
        ResultSet rs = null;
        String query = "SELECT location FROM " + prefix + "controls WHERE `type` = ? AND tardis_id = ?";
        try {
