            ...
            if (rs.isBeforeFirst()) {
                ...
                sonic = new Sonic(
                        ...
                        switch (rs.getString("model")) {
                            ...
                            default -> SonicScrewdriverRecipe.sonicModelLookup.getOrDefault(plugin.getConfig().getString("sonic.default_model").toLowerCase(Locale.ROOT), SonicVariant.ELEVENTH.getFloats());
                        },
                        rs.getBoolean("bio"),
