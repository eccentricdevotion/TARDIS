 ...
 * @author eccentric_nz
 */
public class ResultSetInnerDoorBlock {
     ...
     */
    public ResultSetInnerDoorBlock(TARDIS plugin, int id) {
        this.plugin = plugin;
        this.id = id;
    ...
    public boolean resultSet() {
        ...
        ResultSet rs = null;
        String query = "SELECT * FROM " + prefix + "doors WHERE door_type = 1 AND tardis_id = ?";
        try {
