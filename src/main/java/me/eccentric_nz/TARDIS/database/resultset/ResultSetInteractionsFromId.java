 ...
 * @author eccentric_nz
 */
public class ResultSetInteractionsFromId {
     ...
     */
    public ResultSetInteractionsFromId(TARDIS plugin, int id) {
        this.plugin = plugin;
        this.id = id;
    ...
    public boolean resultSet() {
        ...
        ResultSet rs = null;
        String query = "SELECT * FROM " + prefix + "interactions WHERE tardis_id = ?";
        try {
