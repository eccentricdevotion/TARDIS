...
public class FloodgateGeneticManipulatorForm {
    ...
    private void handleResponse(SimpleFormResponse response) {
        ...
        LazarusRunnable runnable = new LazarusRunnable(plugin, block);
        ...
        switch (label) {
            ...
            default -> {
                ...
                switch (dt) {
                    case AXOLOTL -> {
                        if (plugin.isDisguisesOnServer()) {
                            new LazarusLibsDisguises(player, label, Axolotl.Variant.LUCY, false, false).createDisguise();
                        } else {
                    ...
                    case FROG -> {
                        if (plugin.isDisguisesOnServer()) {
                            new LazarusLibsDisguises(player, label, Frog.Variant.TEMPERATE, false, false).createDisguise();
                        } else {
                    ...
                    case CAT -> {
                        if (plugin.isDisguisesOnServer()) {
                            new LazarusLibsDisguises(player, label, Cat.Type.JELLIE, false, false).createDisguise();
                        } else {
                    ...
                    case PANDA -> {
                        if (plugin.isDisguisesOnServer()) {
                            new LazarusLibsDisguises(player, label, GENE.NORMAL, false, false).createDisguise();
                        } else {
                    ...
                    case DONKEY, MULE, PIG, OCELOT -> {
                        if (plugin.isDisguisesOnServer()) {
                            new LazarusLibsDisguises(player, label, null, false, false).createDisguise();
                        } else {
                    ...
                    case SHEEP, WOLF -> {
                        if (plugin.isDisguisesOnServer()) {
                            new LazarusLibsDisguises(player, label, DyeColor.LIME, false, false).createDisguise();
                        } else {
                    ...
                    case HORSE -> {
                        if (plugin.isDisguisesOnServer()) {
                            new LazarusLibsDisguises(player, label, Horse.Color.DARK_BROWN, false, false).createDisguise();
                        } else {
                    ...
                    case LLAMA -> {
                        if (plugin.isDisguisesOnServer()) {
                            new LazarusLibsDisguises(player, label, Llama.Color.BROWN, true, false).createDisguise();
                        } else {
                    ...
                    case PARROT -> {
                        if (plugin.isDisguisesOnServer()) {
                            new LazarusLibsDisguises(player, label, Parrot.Variant.GREEN, false, false).createDisguise();
                        } else {
                    ...
                    case RABBIT -> {
                        if (plugin.isDisguisesOnServer()) {
                            new LazarusLibsDisguises(player, label, Rabbit.Type.SALT_AND_PEPPER, false, false).createDisguise();
                        } else {
                    ...
                    case VILLAGER, ZOMBIE_VILLAGER -> {
                        if (plugin.isDisguisesOnServer()) {
                            new LazarusLibsDisguises(player, label, Villager.Profession.FARMER, false, false).createDisguise();
                        } else {
                    ...
                    case SLIME, MAGMA_CUBE, PUFFERFISH -> {
                        if (plugin.isDisguisesOnServer()) {
                            new LazarusLibsDisguises(player, label, 1, false, false).createDisguise();
                        } else {
                    ...
                    case SNOW_GOLEM -> {
                        if (plugin.isDisguisesOnServer()) {
                            new LazarusLibsDisguises(player, label, true, false, false).createDisguise();
                        } else {
                    ...
                    case TROPICAL_FISH -> {
                        if (plugin.isDisguisesOnServer()) {
                            new LazarusLibsDisguises(player, label, TropicalFish.Pattern.values()[0], false, false).createDisguise();
                        } else {
                    ...
                    case MOOSHROOM -> {
                        if (plugin.isDisguisesOnServer()) {
                            new LazarusLibsDisguises(player, label, MushroomCow.Variant.RED, false, false).createDisguise();
                        } else {
                    ...
                    case FOX -> {
                        if (plugin.isDisguisesOnServer()) {
                            new LazarusLibsDisguises(player, label, Fox.Type.RED, false, false).createDisguise();
                        } else {
