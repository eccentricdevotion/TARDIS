...
public class TARDISRebuildPreset {
    ...
    public TARDISRebuildPreset(TARDIS plugin, Location location, TARDISConstants.PRESET preset, int tid, TARDISConstants.COMPASS d, String p, boolean mal, boolean sub) {
        this.plugin = plugin;
        this.d = d;
