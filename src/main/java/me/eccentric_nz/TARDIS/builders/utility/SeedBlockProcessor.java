 ...
 * @author eccentric_nz
 */
public class SeedBlockProcessor {

    private final TARDIS plugin;

    public SeedBlockProcessor(TARDIS plugin) {
        this.plugin = plugin;
    }
        ...
        if (TARDISPermission.hasPermission(player, "tardis.create")) {
            ...
            if (!rs.fromUUID(uuid)) {
                ...
                if (chunkworld != null) {
                    ...
                    InteriorBuildRunnable builder = new InteriorBuildRunnable(plugin, schm, chunkworld, lastInsertId, player, wall_type, floor_type, slot);
