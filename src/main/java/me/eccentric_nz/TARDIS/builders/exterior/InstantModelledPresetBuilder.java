...
public class InstantModelledPresetBuilder {

    private final TARDIS plugin;
    private final BuildData bd;
    private final ChameleonPreset preset;

    public InstantModelledPresetBuilder(TARDIS plugin, BuildData bd, ChameleonPreset preset) {
        this.plugin = plugin;
        this.bd = bd;
        this.preset = preset;
    }
    ...
    public void buildPreset() {
        ...
        BuilderUtility.setPoliceBoxHelmet(plugin, preset, bd, stand);
        // set a light block
