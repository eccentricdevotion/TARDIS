...
public class ShellBuilder {
    ...
    private final List<InstantBlockPresetBuilder.ProblemBlock> do_at_end = new ArrayList<>();
                ...
                switch (mat) {
                    ...
                    case TORCH, GLOWSTONE, REDSTONE_LAMP -> { // lamps, glowstone and torches
                        if (mat.equals(Material.TORCH)) {
                            do_at_end.add(new InstantBlockPresetBuilder.ProblemBlock(new Location(world, xx, (y + yy), zz), colData[yy]));
                        } else {
