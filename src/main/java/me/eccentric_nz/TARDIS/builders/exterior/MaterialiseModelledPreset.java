...
public class MaterialiseModelledPreset implements Runnable {
    ...
    public MaterialiseModelledPreset(TARDIS plugin, BuildData bd, ChameleonPreset preset) {
        this.plugin = plugin;
        this.bd = bd;
        ...
        if (i < loops) {
            if (i % 2 == 0) { // stained
                model = switch (dye) {
                    ...
                    default -> new NamespacedKey(plugin, BuilderUtility.getCustomModelPath(dye.toString()) + "_stained");
                };
                ...
                model = switch (dye) {
                    ...
                    default -> new NamespacedKey(plugin, BuilderUtility.getCustomModelPath(dye.toString()) + "_glass");
                };
                light.setBlockData(TARDISConstants.AIR);
            } else { // preset
                model = switch (dye) {
                    ...
                    default -> new NamespacedKey(plugin, BuilderUtility.getCustomModelPath(dye.toString()) + "_closed");
                };
                // set a light block
            ...
            if (i == 1) {
                ...
                BuilderUtility.saveDoorLocation(bd, slab);
            ...
            if (loops > 3) {
                ...
                BuilderUtility.updateChameleonDemat(update, bd.getTardisID());
            }
        }
    }
