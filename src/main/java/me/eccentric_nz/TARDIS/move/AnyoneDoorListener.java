 ...
 * @author eccentric_nz
 */
public class AnyoneDoorListener extends DoorListener implements Listener {

    public AnyoneDoorListener(TARDIS plugin) {
        super(plugin);
    }
                                ...
                                switch (doortype) {
                                    case 1, 4 -> {
                                        ...
                                        if (hb && exitLoc != null) {
                                            ...
                                            // make a safe location outside the blue police box
