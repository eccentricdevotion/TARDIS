...
public class TardisDiskWriterCommand {
    ...
    private boolean saveDiskToStorage(Player player, ItemStack is) {
        ...
        if (rs.resultSet()) {
            try {
                ItemStack[] saves1 = TardisInventorySerializer.itemStacksFromString(rs.getSavesOne());
                ...
                if (slot != -1) {
                    ...
                    ItemStack[] saves2 = TardisInventorySerializer.itemStacksFromString(rs.getSavesTwo());
