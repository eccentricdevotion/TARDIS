...
public class TARDISFeatures {
    ...
    static {
        ...
        GRASS = new TARDISGrassData(new SimpleStateProvider(Blocks.GRASS_BLOCK.defaultBlockState()), BlockPredicate.matchesBlocks(Blocks.TERRACOTTA, Blocks.RED_SAND), UniformInt.of(2, 8), 2);
        VASTIAL = new TARDISGrassData(new SimpleStateProvider(Blocks.CONCRETE_POWDER.white().defaultBlockState()), BlockPredicate.matchesBlocks(Blocks.STONE, Blocks.GRASS_BLOCK), UniformInt.of(2, 8), 2);
