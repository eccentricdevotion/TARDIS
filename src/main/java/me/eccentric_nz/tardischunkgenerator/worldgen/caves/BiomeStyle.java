...
public enum BiomeStyle {
    ...
    public static BiomeProfile getProfile(BiomeStyle style) {
        return switch (style) {
            ...
            case DRIPSTONE -> new BiomeProfile(Material.DRIPSTONE_BLOCK, Material.DIORITE, Material.ANDESITE, Material.IRON_ORE, Material.POINTED_DRIPSTONE, Material.POINTED_DRIPSTONE, Material.GLOWSTONE, TARDISTree.DARK_OAK);
            ...
            case PALE -> new BiomeProfile(Material.DIORITE, Material.PALE_MOSS_BLOCK, Material.ANDESITE, Material.PALE_MOSS_BLOCK, Material.CLOSED_EYEBLOSSOM, Material.OPEN_EYEBLOSSOM, Material.PEARLESCENT_FROGLIGHT, TARDISTree.PALE);
            ...
            case SNOWY -> new BiomeProfile(Material.STONE, Material.SNOW_BLOCK, Material.DIORITE, Material.BLACKSTONE, Material.EMERALD_ORE, Material.ICE, Material.PEARLESCENT_FROGLIGHT, TARDISTree.FROZEN);
            case STONY -> new BiomeProfile(Material.GRANITE, Material.COARSE_DIRT, Material.DIORITE, Material.PALE_MOSS_BLOCK, Material.EMERALD_ORE, Material.SHORT_DRY_GRASS, Material.OCHRE_FROGLIGHT, TARDISTree.FOREST);
            ...
            case SWAMP -> new BiomeProfile(Material.MUD, Material.MUD, Material.CLAY, Material.ROOTED_DIRT, Material.MOSS_CARPET, Material.HANGING_ROOTS, Material.VERDANT_FROGLIGHT, TARDISTree.SWAMP);
