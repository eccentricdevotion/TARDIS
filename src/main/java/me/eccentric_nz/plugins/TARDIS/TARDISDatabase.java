...
public class TARDISDatabase {
    ...
    public void createTables() {
        try {
            ...
            if (!rsChameleon.next()) {
                ...
                TARDIS.plugin.console.sendMessage(TARDIS.plugin.MY_PLUGIN_NAME + " Adding new chameleon circuit!");
            }
            ...
            if (!rsQuotes.next()) {
                ...
                TARDIS.plugin.console.sendMessage(TARDIS.plugin.MY_PLUGIN_NAME + " Adding new quotes to player prefs!");
            }
            ...
            if (!rsDoorDirection.next()) {
                ...
                TARDIS.plugin.console.sendMessage(TARDIS.plugin.MY_PLUGIN_NAME + " Adding door directions to doors table!");
            }
            ...
            if (!rsUpChunks.next()) {
                ...
                while (rsAllChunks.next()) {
                    ...
                    TARDIS.plugin.console.sendMessage(TARDIS.plugin.MY_PLUGIN_NAME + " Adding tardis_ids to chunks table.");
                }
            }
            ...
            if (!rsSize.next()) {
                ...
                TARDIS.plugin.console.sendMessage(TARDIS.plugin.MY_PLUGIN_NAME + " Adding new TARDIS size to DB!");
            ...
            if (!rsData.next()) {
                ...
                TARDIS.plugin.console.sendMessage(TARDIS.plugin.MY_PLUGIN_NAME + " Adding block ID and data to blocks table!");
            }
            // update tardis if there is no size column
            ...
            if (!rsSign.next()) {
                ...
                statement.executeUpdate(queryAlter6);
                TARDIS.plugin.console.sendMessage(TARDIS.plugin.MY_PLUGIN_NAME + " Adding new TARDIS save_sign to DB!");
            }

            statement.close();
        } catch (SQLException e) {
            TARDIS.plugin.console.sendMessage(TARDIS.plugin.MY_PLUGIN_NAME + " Create table error: " + e);
        }
    }
    ...
    public ResultSet getTardis(String name, String cols) {
        ...
        try {
            ...
            TARDIS.plugin.console.sendMessage(TARDIS.plugin.MY_PLUGIN_NAME + " Timelords insert error: " + e);
        }
        return tardis;
    }
