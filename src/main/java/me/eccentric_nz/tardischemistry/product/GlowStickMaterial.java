    ...
    static boolean isCorrectMaterial(Material material) {
        return switch (material) {
            case WHITE_STAINED_GLASS_PANE, ORANGE_STAINED_GLASS_PANE, MAGENTA_STAINED_GLASS_PANE,
                 ...
                 PINK_STAINED_GLASS_PANE, LIGHT_GRAY_STAINED_GLASS_PANE, BLUE_STAINED_GLASS_PANE,
                 PURPLE_STAINED_GLASS_PANE, GREEN_STAINED_GLASS_PANE, BROWN_STAINED_GLASS_PANE,
                 CYAN_STAINED_GLASS_PANE, RED_STAINED_GLASS_PANE -> true;
            default -> false;
        };
    }
}
