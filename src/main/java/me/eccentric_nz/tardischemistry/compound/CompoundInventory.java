...
public class CompoundInventory {
    ...
    private ItemStack[] getItemStack() {
        ...
        info_im.setLore(Arrays.asList("Combine elements to create", "chemical compounds.", "To see a compound formula", "use the " + NamedTextColor.GREEN + TextDecoration.ITALIC + "/tardischemistry formula" + NamedTextColor.DARK_PURPLE + TextDecoration.ITALIC + " command.", "Place items in the bottom", "row from left to right."));
