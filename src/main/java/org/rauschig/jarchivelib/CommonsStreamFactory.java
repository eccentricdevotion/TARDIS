...
final class CommonsStreamFactory {
    ...
    /**
     * Uses the {@link CompressorStreamFactory} and the name of the given compressor to create a new {@link
     * CompressorOutputStream} for the given destination {@link File}.
     *
