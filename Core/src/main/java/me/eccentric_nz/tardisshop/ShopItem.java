...
public enum ShopItem {
    ...
    ARTRON_CAPACITOR_DAMAGED("Damaged Artron Capacitor", Material.BUCKET, 10000004),
    ...
    BONE_SEED("Bone Seed", Material.WAXED_OXIDIZED_CUT_COPPER, 1, ShopItemRecipe.SEED),
    ...
    CURSED_SEED("Cursed Seed", Material.BLACK_CONCRETE, 1, ShopItemRecipe.SEED),
    ...
    TARDIS_SPACE_HELMET("TARDIS Space Helmet", Material.GLASS, 5),
    TARDIS_STATTENHEIM_CIRCUIT("TARDIS Stattenheim Circuit", Material.GLOWSTONE_DUST, 10001963),
    TARDIS_TELEPATHIC_CIRCUIT("TARDIS Telepathic Circuit", Material.GLOWSTONE_DUST, 10001962),
    TARDIS_TELEVISION("TARDIS Television", Material.BROWN_STAINED_GLASS, 1),
    ...
    BLUEPRINT_CONSOLE_BONE("Blueprint Bone", Material.MUSIC_DISC_MELLOHI, 10000001, ShopItemRecipe.BLUEPRINT),
    ...
    BLUEPRINT_CONSOLE_CURSED("Blueprint Cursed", Material.MUSIC_DISC_MELLOHI, 10000001, ShopItemRecipe.BLUEPRINT),
    ...
    BLUEPRINT_CONSOLE_FIFTEENTH("Blueprint Fifteenth", Material.MUSIC_DISC_MELLOHI, 10000001, ShopItemRecipe.BLUEPRINT),
    BLUEPRINT_CONSOLE_FUGITIVE("Blueprint Fugutive", Material.MUSIC_DISC_MELLOHI, 10000001, ShopItemRecipe.BLUEPRINT),
    BLUEPRINT_CONSOLE_HOSPITAL("Blueprint Hospital", Material.MUSIC_DISC_MELLOHI, 10000001, ShopItemRecipe.BLUEPRINT),
    ...
    BLUEPRINT_ROOM_ALLAY("Blueprint Allay", Material.MUSIC_DISC_MELLOHI, 10000001, ShopItemRecipe.BLUEPRINT),
    ...
    BLUEPRINT_ROOM_EYE("Blueprint Eye", Material.MUSIC_DISC_MELLOHI, 10000001, ShopItemRecipe.BLUEPRINT),
    ...
    BLUEPRINT_ROOM_IISTUBIL("Blueprint Iistubil", Material.MUSIC_DISC_MELLOHI, 10000001, ShopItemRecipe.BLUEPRINT),
    ...
    BLUEPRINT_ROOM_LAVA("Blueprint Lava", Material.MUSIC_DISC_MELLOHI, 10000001, ShopItemRecipe.BLUEPRINT),
    ...
    BLUEPRINT_ROOM_PEN("Blueprint Pen", Material.MUSIC_DISC_MELLOHI, 10000001, ShopItemRecipe.BLUEPRINT),
    ...
    BLUEPRINT_SONIC_BRUSH("Blueprint Brush", Material.MUSIC_DISC_MELLOHI, 10000001, ShopItemRecipe.BLUEPRINT),
    BLUEPRINT_SONIC_CONVERSION("Blueprint Conversion", Material.MUSIC_DISC_MELLOHI, 10000001, ShopItemRecipe.BLUEPRINT),
