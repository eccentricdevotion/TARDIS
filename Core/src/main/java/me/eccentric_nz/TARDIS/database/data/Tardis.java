...
public class Tardis {
    ...
    /**
     * Returns the number of powered furnaces in this TARDIS.
     *
     * @return the number of powered furnaces
     */
