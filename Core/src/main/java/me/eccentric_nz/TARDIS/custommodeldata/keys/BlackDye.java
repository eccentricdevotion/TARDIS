...
public enum BlackDye {
    ...
    EARLY_0(new NamespacedKey(TARDIS.plugin, "item/time_rotor/early/early_0")),
    EARLY_1(new NamespacedKey(TARDIS.plugin, "item/time_rotor/early/early_1")),
    EARLY_2(new NamespacedKey(TARDIS.plugin, "item/time_rotor/early/early_2")),
    EARLY_3(new NamespacedKey(TARDIS.plugin, "item/time_rotor/early/early_3")),
    EARLY_4(new NamespacedKey(TARDIS.plugin, "item/time_rotor/early/early_4")),
    EARLY_5(new NamespacedKey(TARDIS.plugin, "item/time_rotor/early/early_5")),
    EARLY_6(new NamespacedKey(TARDIS.plugin, "item/time_rotor/early/early_6")),
    EARLY_7(new NamespacedKey(TARDIS.plugin, "item/time_rotor/early/early_7")),
