...
public enum TARDISDisplayItem {
    ...
    DOOR(TardisDoorVariant.TARDIS_DOOR_0.getKey(), Material.IRON_DOOR, Material.IRON_DOOR),
    DOOR_OPEN(TardisDoorVariant.TARDIS_DOOR_4.getKey(), Material.IRON_DOOR),
    DOOR_BOTH_OPEN(TardisDoorVariant.TARDIS_DOOR_BOTH_OPEN.getKey(), Material.IRON_DOOR),
    BONE_DOOR(BoneDoorVariant.BONE_DOOR.getKey(), Material.IRON_DOOR, Material.BIRCH_DOOR),
    BONE_DOOR_OPEN(BoneDoorVariant.BONE_DOOR_OPEN_4.getKey(), Material.BIRCH_DOOR),
    CLASSIC_DOOR(ClassicDoorVariant.CLASSIC_DOOR.getKey(), Material.IRON_DOOR, Material.CHERRY_DOOR),
    CLASSIC_DOOR_OPEN(ClassicDoorVariant.CLASSIC_DOOR_OPEN_5.getKey(), Material.CHERRY_DOOR),
