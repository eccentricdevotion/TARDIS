...
public class TARDISCache {
    ...
    public static Current currentFromID(int key) {
...
//            BY_ID.asMap().remove(tardis.getTardisId());
//        }
////        BY_UUID.invalidate(key);
//        BY_UUID.asMap().remove(key);
//    }
//
