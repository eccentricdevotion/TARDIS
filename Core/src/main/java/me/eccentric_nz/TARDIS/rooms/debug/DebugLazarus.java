...
public class DebugLazarus {
    ...
    public static final List<GuiPreview> ICONS = List.of(
            ...
            new GuiPreview(Material.IRON_INGOT, CybermanVariant.CYBERMAN_FEATURES.getKey(), "cyberman_features"),
            new GuiPreview(Material.IRON_INGOT, CybermanVariant.CYBER_WEAPON.getKey(), "cyber_weapon"),
            new GuiPreview(Material.KELP, SeaDevilVariant.SEA_DEVIL_EARS.getKey(), "sea_devil_ears"),
            ...
            new GuiPreview(Material.MANGROVE_PROPAGULE, DalekSecVariant.DALEK_SEC_TENTACLES.getKey(), "dalek_sec_tentacles"),
            new GuiPreview(Material.NETHER_WART, Features.BANNAKAFFALATTA_SPIKES.getKey(), "bannakaffalatta_spikes"),
            new GuiPreview(Material.NETHERITE_SCRAP, MireVariant.MIRE_HELMET.getKey(), "mire_helmet"),
            ...
            new GuiPreview(Material.PAINTING, ZygonVariant.ZYGON_CREST.getKey(), "zygon_crest"),
            new GuiPreview(Material.POTATO, SontaranVariant.SONTARAN_EARS.getKey(), "sontaran_ears"),
            new GuiPreview(Material.POTATO, SontaranVariant.STRAX_EARS.getKey(), "strax_ears"),
            new GuiPreview(Material.PUFFERFISH, HathVariant.HATH_FEATURES.getKey(), "hath_features"),
            new GuiPreview(Material.ROTTEN_FLESH, OodVariant.OOD_FEATURES.getKey(), "ood_features"),
            new GuiPreview(Material.SNOWBALL, IceWarriorVariant.ICE_WARRIOR_CREST.getKey(), "ice_warrior_crest"),
            new GuiPreview(Material.SUGAR, EmptyChildVariant.EMPTY_CHILD_MASK_FEATURE.getKey(), "empty_child_mask"),
            ...
            new GuiPreview(Material.WHEAT, ScarecrowVariant.SCARECROW_EARS.getKey(), "scarecrow_ears"),
            new GuiPreview(Material.YELLOW_DYE, JudoonVariant.JUDOON_SNOUT.getKey(), "judoon_snout")
    );
}
