 ...
 * @author eccentric_nz
 */
public class TARDISPunkedPreset extends TARDISPreset {

    public TARDISPunkedPreset() {
        // set blueprint data strings
        String[][] blueprintData = new String[10][4];
        blueprintData[0][0] = "minecraft:stone_slab[type=bottom,waterlogged=false]";
        blueprintData[0][1] = "minecraft:stone_slab[type=top,waterlogged=false]";
        blueprintData[0][2] = "minecraft:oak_log[axis=y]";
        blueprintData[0][3] = "minecraft:oak_log[axis=y]";
        blueprintData[1][0] = "minecraft:sticky_piston[extended=true,facing=up]";
        blueprintData[1][1] = "minecraft:piston_head[facing=up,short=false,type=sticky]";
        blueprintData[1][2] = "minecraft:coal_block";
        blueprintData[1][3] = "minecraft:stone_slab[type=bottom,waterlogged=false]";
        blueprintData[2][0] = "minecraft:stone_slab[type=bottom,waterlogged=false]";
        blueprintData[2][1] = "minecraft:stone_slab[type=top,waterlogged=false]";
        blueprintData[2][2] = "minecraft:oak_log[axis=y]";
        blueprintData[2][3] = "minecraft:oak_log[axis=y]";
        blueprintData[3][0] = "minecraft:sticky_piston[extended=true,facing=up]";
        blueprintData[3][1] = "minecraft:piston_head[facing=up,short=false,type=sticky]";
        blueprintData[3][2] = "minecraft:coal_block";
        blueprintData[3][3] = "minecraft:stone_slab[type=bottom,waterlogged=false]";
        blueprintData[4][0] = "minecraft:stone_slab[type=bottom,waterlogged=false]";
        blueprintData[4][1] = "minecraft:stone_slab[type=top,waterlogged=false]";
        blueprintData[4][2] = "minecraft:oak_log[axis=y]";
        blueprintData[4][3] = "minecraft:oak_log[axis=y]";
        blueprintData[5][0] = "minecraft:sticky_piston[extended=true,facing=up]";
        blueprintData[5][1] = "minecraft:piston_head[facing=up,short=false,type=sticky]";
        blueprintData[5][2] = "minecraft:coal_block";
        blueprintData[5][3] = "minecraft:stone_slab[type=bottom,waterlogged=false]";
        blueprintData[6][0] = "minecraft:stone_slab[type=bottom,waterlogged=false]";
        blueprintData[6][1] = "minecraft:stone_slab[type=top,waterlogged=false]";
        blueprintData[6][2] = "minecraft:oak_log[axis=y]";
        blueprintData[6][3] = "minecraft:oak_log[axis=y]";
        blueprintData[7][0] = "minecraft:sticky_piston[extended=true,facing=up]";
        blueprintData[7][1] = "minecraft:piston_head[facing=up,short=false,type=sticky]";
        blueprintData[7][2] = "minecraft:coal_block";
        blueprintData[7][3] = "minecraft:oak_trapdoor[facing=east,half=bottom,open=false,powered=false,waterlogged=false]";
        blueprintData[8][0] = "minecraft:redstone_block";
        blueprintData[8][1] = "minecraft:air";
        blueprintData[8][2] = "minecraft:stone_slab[type=top,waterlogged=false]";
        ...
        stainedData[7][3] = "minecraft:oak_trapdoor[facing=east,half=bottom,open=false,powered=false,waterlogged=false]";
        stainedData[8][0] = "minecraft:red_stained_glass";
        stainedData[8][1] = "minecraft:air";
        stainedData[8][2] = "minecraft:light_gray_stained_glass";
        stainedData[8][3] = "minecraft:torch";
        ...
        glassData[7][3] = "minecraft:oak_trapdoor[facing=east,half=bottom,open=false,powered=false,waterlogged=false]";
        glassData[8][0] = "minecraft:glass";
        glassData[8][1] = "minecraft:air";
        glassData[8][2] = "minecraft:glass";
        glassData[8][3] = "minecraft:torch";
