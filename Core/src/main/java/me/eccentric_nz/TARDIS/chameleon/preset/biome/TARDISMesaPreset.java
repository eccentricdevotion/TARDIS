 ...
 * @author eccentric_nz
 */
public class TARDISMesaPreset extends TARDISPreset {

    public TARDISMesaPreset() {
        // set blueprint data strings
        String[][] blueprintData = new String[10][4];
        blueprintData[0][0] = "minecraft:terracotta";
        blueprintData[0][1] = "minecraft:yellow_terracotta";
        blueprintData[0][2] = "minecraft:red_terracotta";
        blueprintData[0][3] = "minecraft:air";
        blueprintData[1][0] = "minecraft:terracotta";
        blueprintData[1][1] = "minecraft:yellow_terracotta";
        blueprintData[1][2] = "minecraft:red_terracotta";
        blueprintData[1][3] = "minecraft:dead_bush";
        blueprintData[2][0] = "minecraft:terracotta";
        blueprintData[2][1] = "minecraft:yellow_terracotta";
        blueprintData[2][2] = "minecraft:red_terracotta";
        blueprintData[2][3] = "minecraft:orange_terracotta";
        blueprintData[3][0] = "minecraft:terracotta";
        blueprintData[3][1] = "minecraft:yellow_terracotta";
        blueprintData[3][2] = "minecraft:red_terracotta";
        blueprintData[3][3] = "minecraft:orange_terracotta";
        blueprintData[4][0] = "minecraft:terracotta";
        blueprintData[4][1] = "minecraft:yellow_terracotta";
        blueprintData[4][2] = "minecraft:red_terracotta";
        blueprintData[4][3] = "minecraft:orange_terracotta";
        blueprintData[5][0] = "minecraft:terracotta";
        blueprintData[5][1] = "minecraft:yellow_terracotta";
        blueprintData[5][2] = "minecraft:red_terracotta";
        blueprintData[5][3] = "minecraft:orange_terracotta";
        blueprintData[6][0] = "minecraft:terracotta";
        blueprintData[6][1] = "minecraft:yellow_terracotta";
        blueprintData[6][2] = "minecraft:red_terracotta";
        blueprintData[6][3] = "minecraft:dead_bush";
        ...
        blueprintData[8][2] = "minecraft:red_terracotta";
        blueprintData[8][3] = "minecraft:orange_terracotta";
        ...
        stainedData[4][1] = "minecraft:yellow_stained_glass";
        ...
        stainedData[5][1] = "minecraft:yellow_stained_glass";
        stainedData[5][2] = "minecraft:red_stained_glass";
        stainedData[5][3] = "minecraft:orange_stained_glass";
        stainedData[6][0] = "minecraft:brown_stained_glass";
        stainedData[6][1] = "minecraft:yellow_stained_glass";
        stainedData[6][2] = "minecraft:red_stained_glass";
        stainedData[6][3] = "minecraft:yellow_stained_glass";
        ...
        stainedData[8][3] = "minecraft:orange_stained_glass";
