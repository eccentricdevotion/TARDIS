 ...
 * @author eccentric_nz
 */
public class TARDISYellowSubmarinePreset extends TARDISPreset {

    public TARDISYellowSubmarinePreset() {
        // set blueprint data strings
        String[][] blueprintData = new String[10][4];
        blueprintData[0][0] = "minecraft:yellow_wool";
        blueprintData[0][1] = "minecraft:yellow_wool";
        blueprintData[0][2] = "minecraft:yellow_wool";
        blueprintData[0][3] = "minecraft:air";
        blueprintData[1][0] = "minecraft:yellow_wool";
        blueprintData[1][1] = "minecraft:glass";
        blueprintData[1][2] = "minecraft:yellow_wool";
        blueprintData[1][3] = "minecraft:air";
        blueprintData[2][0] = "minecraft:yellow_wool";
        blueprintData[2][1] = "minecraft:yellow_wool";
        blueprintData[2][2] = "minecraft:yellow_wool";
        blueprintData[2][3] = "minecraft:air";
        blueprintData[3][0] = "minecraft:yellow_wool";
        blueprintData[3][1] = "minecraft:glass";
        blueprintData[3][2] = "minecraft:yellow_wool";
        blueprintData[3][3] = "minecraft:air";
        blueprintData[4][0] = "minecraft:yellow_wool";
        blueprintData[4][1] = "minecraft:yellow_wool";
        blueprintData[4][2] = "minecraft:yellow_wool";
        blueprintData[4][3] = "minecraft:air";
        blueprintData[5][0] = "minecraft:yellow_wool";
        blueprintData[5][1] = "minecraft:glass";
        blueprintData[5][2] = "minecraft:yellow_wool";
        blueprintData[5][3] = "minecraft:air";
        blueprintData[6][0] = "minecraft:yellow_wool";
        blueprintData[6][1] = "minecraft:yellow_wool";
        blueprintData[6][2] = "minecraft:yellow_wool";
        ...
        blueprintData[8][2] = "minecraft:yellow_wool";
        ...
        stainedData[1][0] = "minecraft:yellow_stained_glass";
        stainedData[1][1] = "minecraft:glass";
        stainedData[1][2] = "minecraft:yellow_stained_glass";
        ...
        stainedData[3][0] = "minecraft:yellow_stained_glass";
        stainedData[3][1] = "minecraft:glass";
        stainedData[3][2] = "minecraft:yellow_stained_glass";
        ...
        stainedData[5][0] = "minecraft:yellow_stained_glass";
        stainedData[5][1] = "minecraft:glass";
        stainedData[5][2] = "minecraft:yellow_stained_glass";
