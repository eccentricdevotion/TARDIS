...
//    CONNECTED_TEXTURES_OFF(new NamespacedKey(TARDIS.plugin, "switch_connected_textures_off"), List.of(100f)),
//    CONNECTED_TEXTURES_ON(new NamespacedKey(TARDIS.plugin, "switch_connected_textures_on"), List.of(100f)),
...
//    EASY_DIFF_OFF(new NamespacedKey(TARDIS.plugin, "switch_easy_diff_off"), List.of(100f)),
//    EASY_DIFF_ON(new NamespacedKey(TARDIS.plugin, "switch_easy_diff_on"), List.of(100f)),
...
//    FONT_OFF(new NamespacedKey(TARDIS.plugin, "switch_font_off"), List.of(100f)),
//    FONT_ON(new NamespacedKey(TARDIS.plugin, "switch_font_on"), List.of(100f)),
...
//    LANTERNS_OFF(new NamespacedKey(TARDIS.plugin, "switch_lanterns_off"), List.of(100f)),
//    LANTERNS_ON(new NamespacedKey(TARDIS.plugin, "switch_lanterns_on"), List.of(100f)),
...
//    POLICE_BOX_TEXTURES_OFF(new NamespacedKey(TARDIS.plugin, "switch_police_box_textures_off"), List.of(100f)),
//    POLICE_BOX_TEXTURES_ON(new NamespacedKey(TARDIS.plugin, "switch_police_box_textures_on"), List.of(100f)),
...
//    RESOURCE_PACK_SWITCHING_OFF(new NamespacedKey(TARDIS.plugin, "switch_resource_pack_switching_off"), List.of(100f)),
//    RESOURCE_PACK_SWITCHING_ON(new NamespacedKey(TARDIS.plugin, "switch_resource_pack_switching_on"), List.of(100f)),
