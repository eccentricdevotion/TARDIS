...
public record GUIControlCentre() {
    ...
    public static GUIData BUTTON_TEMP = new GUIData(Button.TEMPORAL.getKey(), 49, Material.BOWL);
    // 4th column
    public static GUIData BUTTON_ARTRON = new GUIData(Button.ARTRON.getKey(), 6, Material.BOWL);
    public static GUIData BUTTON_SCANNER = new GUIData(Button.SCANNER.getKey(), 15, Material.BOWL);
    public static GUIData BUTTON_INFO = new GUIData(Button.INFO.getKey(), 24, Material.BOWL);
    public static GUIData BUTTON_TRANSMAT = new GUIData(Button.TRANSMAT.getKey(), 33, Material.BOWL);
    // 5th column
    public static GUIData BUTTON_ZERO = new GUIData(Button.ZERO.getKey(), 8, Material.BOWL);
    public static GUIData BUTTON_PREFS = new GUIData(Button.PREFERENCES.getKey(), 17, Material.BOWL);
    public static GUIData COMPANIONS_MENU = new GUIData(GuiVariant.COMPANIONS_MENU.getKey(), 26, Material.BOWL);
    public static GUIData BUTTON_SYSTEM_UPGRADES = new GUIData(Button.SYSTEM_UPGRADES.getKey(), 35, Material.BOWL);
