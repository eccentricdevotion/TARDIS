...
public enum OodVariant {
    ...
    OOD_HEAD_BLUE(new NamespacedKey(TARDIS.plugin, "ood_head_blue")),
    OOD_ARM_BLUE(new NamespacedKey(TARDIS.plugin, "ood_arm_blue")),
    OOD_BALL_ARM_BLUE(new NamespacedKey(TARDIS.plugin, "ood_ball_arm_blue")),
    OOD_HEAD_BROWN(new NamespacedKey(TARDIS.plugin, "ood_head_brown")),
    OOD_ARM_BROWN(new NamespacedKey(TARDIS.plugin, "ood_arm_brown")),
    OOD_BALL_ARM_BROWN(new NamespacedKey(TARDIS.plugin, "ood_ball_arm_brown")),
    OOD_DISGUISE(new NamespacedKey(TARDIS.plugin, "ood_disguise")),
    OOD_MONSTER_HEAD(new NamespacedKey(TARDIS.plugin, "ood_monster_head")),
    OOD_REDEYE_HEAD(new NamespacedKey(TARDIS.plugin, "ood_redeye_head")),
    OOD_REDEYE_HEAD_BLUE(new NamespacedKey(TARDIS.plugin, "ood_redeye_head_blue")),
    OOD_REDEYE_HEAD_BROWN(new NamespacedKey(TARDIS.plugin, "ood_redeye_head_brown")),
    OOD_BLACK_0(new NamespacedKey(TARDIS.plugin, "ood_black_0")),
    OOD_BLACK_1(new NamespacedKey(TARDIS.plugin, "ood_black_1")),
