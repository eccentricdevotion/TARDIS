...
public enum ArmourVariant {
    ...
    CYBER_LORD(new NamespacedKey(TARDIS.plugin, "cyberman_2")),
    CYBERMAN_RISE(new NamespacedKey(TARDIS.plugin, "cyberman_1")),
    BLACK_CYBERMAN(new NamespacedKey(TARDIS.plugin, "cyberman_3")),
    CYBERMAN_EARTHSHOCK(new NamespacedKey(TARDIS.plugin, "cyberman_4")),
    CYBERMAN_INVASION(new NamespacedKey(TARDIS.plugin, "cyberman_5")),
    CYBERMAN_MOONBASE(new NamespacedKey(TARDIS.plugin, "cyberman_6")),
    CYBERMAN_TENTH_PLANET(new NamespacedKey(TARDIS.plugin, "cyberman_7")),
