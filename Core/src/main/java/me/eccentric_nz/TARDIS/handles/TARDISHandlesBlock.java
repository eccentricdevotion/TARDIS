...
public enum TARDISHandlesBlock {
    ...
    ELSE_IF(TARDISHandlesCategory.CONTROL, "ELSE IF", List.of("Check another condition"), 14),
    ...
    // number
    ZERO(TARDISHandlesCategory.NUMBER, "0", List.of("The number zero"), 26),
    ONE(TARDISHandlesCategory.NUMBER, "1", List.of("The number one"), 27),
    TWO(TARDISHandlesCategory.NUMBER, "2", List.of("The number two"), 28),
    THREE(TARDISHandlesCategory.NUMBER, "3", List.of("The number three"), 29),
    FOUR(TARDISHandlesCategory.NUMBER, "4", List.of("The number four"), 30),
    FIVE(TARDISHandlesCategory.NUMBER, "5", List.of("The number five"), 31),
    SIX(TARDISHandlesCategory.NUMBER, "6", List.of("The number six"), 32),
    SEVEN(TARDISHandlesCategory.NUMBER, "7", List.of("The number seven"), 33),
    EIGHT(TARDISHandlesCategory.NUMBER, "8", List.of("The number eight"), 34),
    NINE(TARDISHandlesCategory.NUMBER, "9", List.of("The number nine"), 35),
