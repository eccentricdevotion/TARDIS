...
public class TARDISChatPaginator {
    ...
    public static int GUARANTEED_NO_WRAP_CHAT_PAGE_WIDTH = TARDIS.plugin.getConfig().getInt("preferences.chat_width"); // Will never wrap, even with the largest characters
