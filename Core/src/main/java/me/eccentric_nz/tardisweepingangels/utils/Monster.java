...
public enum Monster {
    ...
    JUDOON("Judoon", EntityType.HUSK, "judoon", JudoonVariant.JUDOON_STATIC.getKey(), Material.YELLOW_DYE, JudoonVariant.JUDOON_MONSTER_HEAD.getKey(), CharacterSkins.JUDOON),
    ...
    OOD("Ood", EntityType.HUSK, "ood", OodVariant.OOD_BLACK_STATIC.getKey(), Material.ROTTEN_FLESH, OodVariant.OOD_MONSTER_HEAD.getKey(), CharacterSkins.OOD),
